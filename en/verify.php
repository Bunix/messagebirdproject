...
<html lang="en">
    ...
    <meta name="csrf-token" content="1x5oQk-o6khVzmQLE36BMJi19vyggGcGeQAuRQG1lGxa1J4fhwOpoWIxXBzhqSv-pqQSq6GMrI2P390iv1gNqw==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en/verify">
            ...
            <div class="col-md-6">
                ...
                <div class="page-section-btn-container">
                    <form id="index-signup" class="start" novalidate="true" action="../dashboard.messagebird/app/en/sign-up.php" method="GET">
                        ...
                        <div class="hero-sub-cta sp" style="margin-top: 15px;">Looking for a custom plan? <a href="contact-sales.php" class="page-section-link" style="margin-left: 5px;">Contact sales ⇢</a></div>
                    </form>
                </div>
            </div>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.php#pdf">Pricing</a>, <a href="sms.php#pdf">SMS</a>, <a href="voice.php#pdf">Voice</a>, <a href="lookup.php#pdf">Lookup</a>, <a href="numbers.php#pdf">Numbers</a>, <a href="numbers.php#pdf">Short Code</a> and <a href="/en/chat#pdf">Chat</a>.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <a href="sms\pricing.php" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;verify&quot;});">Check out SMS pricing ⇢</a>
                ...
                <div class="statistics clearfix">
                    ...
                    <div class="statistic">
                        ...
                        <div class="sp description">Supporting 50+ countries</div>
                                    ...
                                    <a class="page-section-link new" href="numbers.php" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;verify&quot;});">Learn more about local numbers ⇢</a>
