...
<html lang="en">
    ...
    <meta name="csrf-token" content="kbPlH0W9EO9rmrrOlKJBm3Rsh68c1qlOmWKRPtkRjYgceRNCjRZTBlxlgtlmdetVSn1j-B3aYsVvvWJZZ_wUTw==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en/sms">
...
ga('send', 'pageview');
            ...
            var _user_id = "";
            var _session_id = "7dffa6a21bed0dcb1006584ade7347de";
                ...
                <div class="col-md-6">
                    ...
                    <div class="page-section-btn-container">
                        ...
                        <form id="index-signup" class="start" novalidate="true" action="../dashboard.messagebird/app/en/sign-up.php" method="GET">
                            ...
                            <div class="hero-sub-cta sp" style="margin-top: 15px;">Looking for a custom plan? <a href="contact-sales.php" class="page-section-link">Contact sales ⇢</a></div>
                        </form>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="device-screen">
                ...
                <div class="device-ui">
                    <div class="device-ui-status-bar">
                        10:37                        <i class="fa fa-signal" aria-hidden="true" style="right: 20px;"></i>
                ...
                <div class="col-md-8">
                    <div class="row flex">
                        ...
                        <div class="pane">
                            ...
                            <a href="numbers.php" class="page-section-link">Explore Numbers ⇢</a>
                        </div>
                        <div class="pane">
                            ...
                            <a href="verify.php" class="page-section-link">Explore Verify ⇢</a>
                        </div>
                        <div class="pane">
           ...
           <header class="col-md-12 text-center">
            	...
            	<div class="pane">
	                ...
	                <p class="benefits-copy sp">Access the next generation of SMS, with rich media and file-sharing capabilities.</p>
	                	                	...
	                	                	<a href="/en/rcs" class="page-section-link">Explore RCS ⇢</a>
	                	            </div>
            	...
            	<div class="pane">
	                ...
	                <p class="benefits-copy sp">Gather detailed information on any number for a cleaner database and lower messaging costs.</p>
	                	                	...
	                	                	<a href="lookup.php" class="page-section-link">Explore Lookup ⇢</a>
	                	            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <a href="sms\pricing.php" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;sms&quot;});">Check out SMS pricing ⇢</a>
