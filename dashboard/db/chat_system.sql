...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2017 at 04:21 PM
...
(1, 4, 3, 'hi', '2017-09-12 10:34:40'),
(2, 4, 3, 'how are you', '2017-09-12 10:34:55'),
(3, 1, 3, 'im fine', '2017-09-12 10:35:01');
...
(1, 'admin@admin.com', '21232f297a57a5a743894a0e4a801fc3', 'Admin', 'upload/bunix_1505204229.jpg', 1),
(4, 'bunix@bunix.com', '57e7f74656ffcc8e8feb8455d5e618c5', 'bunix', '', 2);
...
--
ALTER TABLE `chat_member`
  MODIFY `chat_memberid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
