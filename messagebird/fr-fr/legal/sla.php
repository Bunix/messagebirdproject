...
<html lang="fr-fr">
    <head>
        ...
        <title>Accord de Prestation de Services MessageBird - MessageBird</title>
    ...
    <meta name="csrf-token" content="A4gBEBgwWuav6Y-NY5bLikikUUXejVmFmdkIPUvCJyKOQvdN0JsZD5gWt5qRQWFEdrW1Et-Bkg5vBvta9S--5Q==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
        	...
        	<link rel="alternate" hreflang="fr-fr" href="..\sla.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Accord de Prestation de Services MessageBird">
        <meta property="og:description" content="SLA">
        <meta property="og:url" content="https://www.messagebird.com/fr-fr/sla">
        ...
        <meta name="twitter:title" content="Accord de Prestation de Services MessageBird">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <header>
                    <h1 class="legal-title mb-page-title">Accord de Prestation de Services MessageBird</h1>
                    <a class="legal-download" href="http://cdn.messagebird.com/download/pdf/MB-SLA.pdf">Download as PDF</a>
                </header>
                <p>
                    Cet Accord de Prestation de Services (“Service Level Agreement” ou “SLA”) MessageBird régit l'utilisation des Services MessageBird en application des <a href="..\conditions.htm" target="_blank">Conditions Générales d'Utilisation</a> (“CGU”) entre MessageBird B.V. (“MessageBird” ou “nous”) et les utilisateurs des Services MessageBird (“vous” ou “Client”). Ce SLA s'applique séparément à chaque compte utilisant les Services MessageBird. Sauf disposition contraire stipulée dans le présent document, ce SLA est assujetti aux conditions reprises dans les CGU et les termes clés auront le sens qui leur est attribué dans les CGU. MessageBird se réserve le droit de modifier les termes et conditions de ce SLA conformément aux CGU.                </p>
                    <ol class="legal-terms">
                        <li>
                            <h4>Engagement en matière de services</h4>
                            <p>
                                MessageBird mettra en œuvre tous les moyens raisonnables à sa disposition afin d'assurer la disponibilité 99,95 % du temps des Services MessageBird. Dans l'éventualité où le Client rencontre une situation où MessageBird ne répond pas aux 99,95% de disponibilité de Services au cours d'un mois civil ("Pourcentage de Disponibilité Mensuelle"), vous serez éligible à recevoir un Crédit Service comme décrit ci-dessous.                            </p>
                        </li>
                        <li>
                            <h4>Définitions</h4>
                            <ol>
                                <p>Les termes clés suivants ont le sens énoncé ci-dessous:</p>
                                <li><strong>“MessageBird Services”</strong> constitue la combinaison de tous les produits et services pris séparément (comme définis dans l'article 2.2) offerts par MessageBird au Client.</li>
                                <li><strong>“MessageBird Single Service”</strong> signifie:                                    <ul>
                                        <li>MessageBird API (Application Programming Interface)</li>
                                        <li>MessageBird Dashboard</li>
                                        <li>Service MessageBird Mail à SMS</li>
                                        <li>Plateforme SMPP MessageBird ("Short Message Peer-to-Peer")</li>
                                    </ul>
                                </li>
                                <li><strong>“Unavailable Time”</strong> &quot;Temps d'Indisponibilité"; signifie que l'un ou plusieurs des Services MessageBird ne sont pas disponibles à l'utilisation selon les résultats d'un tiers et selon les services de vérification contractés par MessageBird à sa seule discrétion (le "Service de Vérification"). Les compte-rendus de disponibilité du Service de Vérification sont actuellement disponibles sur <a href="http://status.messagebird.com" target="_blank">status.messagebird.com</a>; à la condition que les problèmes ou interruptions de service associés à toute Exclusion (défini ci-dessous) ne soient pas considérés comme Temps d'Indisponibilité. Le Temps d'Indisponibilité est calculé par Service Unique comme défini dans l'article 2.2 et non comme un total combiné ou une moyenne.</li>
                                <li>Le <strong>“Monthly Uptime Percentage"</strong> "Pourcentage de Disponibilité Mensuelle" est calculé en soustrayant de 100% le pourcentage de périodes continues de 5 minutes durant le Mois de Service durant lequel un Service Unique MessageBird se trouvait en situation de "Unavailable Time" tel qu'identifié par le Service de Vérification. </li>
                                <li>Le <strong>“Service Credit"</strong> "Crédit Service" constitue un crédit que MessageBird, à sa seule discrétiion et après confirmation de la nature et de l'exactitude du Temps d'Indisponibilité, peut créditer au compte d'un Client éligible, calculé comme établi ci-dessous:                                     <ul>
                                        <li>Pour un mois civil donné où le Pourcentage de Disponibilité Mensuelle d'un MessageBird Single Service ne répond pas au Pourcentage de Disponibilité Mensuelle, MessageBird créditera le compte du Client d'un pourcentage de la facturation du Service ne répondant pas au Pourcentage de Disponibilité Mensuelle pour ce mois, tel que défini dans ce tableau:                                            <table>
                                                <thead>
                                                 <tr>
                                                    <th>POURCENTAGE DE DISPONIBILITÉ MENSUELLE</th>
                                                    <th>CRÉDIT SERVICE</th>
                                                 </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
                                        ...
                                        <li>Le Crédit Service sera ajouté à la solde du Client sur MessageBird uniquement pour une utilisation future de MessageBird Single Service. Aucun remboursement ni valeur en espèces ne sera fourni. Les Crédits Service ne peuvent pas être transférés ni appliqués à un autre compte ni à un autre MessageBird Single Service.</li>
                                    </ul>
                                </li>
                            </ol>
                            </li>
                            <li>
                                <h4>Demande de crédit et procédures de paiement</h4>
                                <p>Pour déposer une demande pour un Crédit Service, le Client doit soumettre un ticket via le formulaire disponible <a href="..\contact.htm">ici</a> dans les 30 jours suivant le mois durant lequel le Temps d'Indisponibilité est survenu. Le ticket doit contenir (i) "SLA Claim" en tant qu'objet du ticket; (ii) les dates et les heures du Temps d'Indisponibilité pour lequel vous sollicitez un crédit; et (iii) toute information utile qui prouve l'interruption alléguée. Le non-respect de ces exigences entraîne la perte de tout droit du Client à recevoir un Crédit Service. Les Crédits Service seront appliqués dans les 60 jours suivant la demande de Crédit Service.</p>
                            </li>
                            <li>
                                <h4>Exclusions</h4>
                                <p>Nonobstant toutes dispositions contraires, aucun Temps d'Indisponibilité sera considéré comme ayant eu lieu en rapport avec toute indisponibilité, suspension ou cessation des Services MessageBird, ou tout autre problème de rendement des Services MessageBird, qui:</p>
                                <ol type="i">
                                    <li>causé par des facteurs échappant au contrôle raisonnable de MessageBird, y compris, et sans limitations, à tout événement de force majeure, de problèmes liés au réseau porteur, ou à l'accès internet ou tout problème au-delà de la ligne de démarcation de MessageBird ou de ses sous-traitants d'hébergement directs (par exemple au-delà du point dans le réseau où MessageBird maintient l'accès et le contrôle sur les Services MessageBird);</li>
                                    <li>résulte de toute action ou inaction du Client ou de tout tiers (autre qu'un sous-traitant d'hébergement direct de MessageBird); </li>
                                    <li>résulte d'Applications, équipement, logiciel ou autre technologie et/ou d'équipement, logiciel ou autre technologie de tiers (autre que l'équipement de tiers sous contrôle direct de MessageBird); ou</li>
                                    <li>provienne de la suspension et cessation de la part de MessageBird du droit du Client d'utiliser les Services MessageBird conformément aux CGU, (v) de maintenance programmée; ou (vi) de problèmes liés à une fonction ou produit en alpha, beta ou de toute fonction ou produit MessageBird non généralement disponible (collectivement, les "Exclusions").</li>
                                </ol>
                            </li>
                            <li>
                                <h4>Unique recours</h4>
                                <p>
                                    Des Crédits Service constituent votre unique et exclusif recours pour toute indisponibilité ou non-rendement des Services MessageBird ou autre défaillance de notre part à offrir les Services MessageBird.                                </p>
                            </li>
                    </ol>
            </div>
        </div>
