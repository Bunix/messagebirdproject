...
<html lang="fr-fr">
    <head>
        ...
        <title>Contact : comment pouvons-nous vous aider ? - MessageBird</title>
        <meta name="description" content="Nous sommes là pour vous ! Contactez-nous par le formulaire de contact, téléphone ou e-mail. Nous sommes basés sur Londres, Amsterdam, Hambourg et les USA.">
    ...
    <meta name="csrf-token" content="zkpd6fVxxd5dRkpWSnomOurJHtNukCxThjEiLJqFNqNDgKu0PdqGN2q5ckG4rYz01Nj6hG-c59hw7tFLJGivZA==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
        	...
        	<link rel="alternate" hreflang="fr-fr" href="contact.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Contact : comment pouvons-nous vous aider ?">
        <meta property="og:description" content="Nous sommes là pour vous ! Contactez-nous par le formulaire de contact, téléphone ou e-mail. Nous sommes basés sur Londres, Amsterdam, Hambourg et les USA.">
        <meta property="og:url" content="https://www.messagebird.com/fr-fr/contact">
        ...
        <meta name="twitter:title" content="Contact : comment pouvons-nous vous aider ?">
        <meta name="twitter:description" content="Nous sommes là pour vous ! Contactez-nous par le formulaire de contact, téléphone ou e-mail. Nous sommes basés sur Londres, Amsterdam, Hambourg et les USA.">
        

        <script type="text/javascript">window.page = 'contact';</script>
...
<div class="contact-support new">
    <section class="page-section hero">
        <div class="container">
            ...
            <form class="form-group" id="contact" method="post" action="/fr-fr/contact">
            <div class="col-md-5">
                    <input type="hidden" name="_csrf" value="zkpd6fVxxd5dRkpWSnomOurJHtNukCxThjEiLJqFNqNDgKu0PdqGN2q5ckG4rYz01Nj6hG-c59hw7tFLJGivZA==">                    <div class="">
                  ...
                  <div class="">
                      <label for="ContactForm[subject]">Sujet du message</label>
                      <input type="text" value="" name="ContactForm[subject]" class="form-control form-group" placeholder="Question à propos des SMS" required="">
                  </div>
        ...
        <div class="col-md-12 text-center">
            Une question concernant nos offres ? <a class="talk-to" href="contact-sales.htm">Contacter un collaborateur</a>
        </div>
    </div>
</div>
</section>
