...
<html lang="fr-fr">
    ...
    <meta name="csrf-token" content="Q_H0WDk4t-kbZc1FXlJkX2QQXJizlrgWJIEUYRZ3plfOOwIF8ZP0ACya9VKshc6RWgG4z7Kac53SXucGqJo_kA==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
        	...
        	<link rel="alternate" hreflang="fr-fr" href="chat-api.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/fr-fr/chat-api">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p class="code-example-content lp">Intégrez notre Chat API à vos logiciels GRC, sites internet ou applications. Lisez notre documentation à destination des développeurs et commencez à communiquer autrement.</p>
									...
									<a class="page-section-link" href="/fr-fr/developers" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;chat&quot;});">Consultez la documentation développeur ⇢</a>
...
<div id="try" class="page-footer-background js-page-footer">
    <section class="page-section page-footer pricing-chat-api alt-color" style="padding-top: 30px;">
        <div class="container">
            ...
            <a href="https://dashboard.messagebird.com/app/fr-fr/sign-up?redirect=chat-api/get-started">
            <div class="pricing-tier  free">
                ...
                <ul class="pricing-tier-features">
                    ...
                    <li><i class="fa fa-check" aria-hidden="true"></i><b>10 Gio</b> Stockage</li>
                                    ...
                                    <span href="https://dashboard.messagebird.com/app/fr-fr/sign-up?redirect=chat-api/get-started" class="btn btn-cta">Essayer</span>
            ...
            <div class="pricing-tier ">
                ...
                <ul class="pricing-tier-features">
                    ...
                    <li><i class="fa fa-check" aria-hidden="true"></i><b>500 Gio</b> Stockage</li>
                                    ...
                                    <span href="https://dashboard.messagebird.com/app/fr-fr/sign-up?redirect=chat-api/get-started" class="btn btn-cta">Choisir</span>
                            </div>
        </a>
            <a href="https://dashboard.messagebird.com/app/fr-fr/sign-up?redirect=chat-api/get-started">
            ...
            <div class="col-md-6 col-md-push-3">
                <div>
                    <h3 class="page-section-small-heading">Contacter un collaborateur</h3>
                        ...
                        <form class="form-group contact-form" id="contact" method="post" action="/fr-fr/chat-api#contact-form">
                            <input type="hidden" name="_csrf" value="Q_H0WDk4t-kbZc1FXlJkX2QQXJizlrgWJIEUYRZ3plfOOwIF8ZP0ACya9VKshc6RWgG4z7Kac53SXucGqJo_kA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
