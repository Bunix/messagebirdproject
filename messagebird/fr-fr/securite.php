...
<html lang="fr-fr">
    <head>
        ...
        <title>Sécurité : sécurisez vos données - MessageBird</title>
        <meta name="description" content="Nous délivrons vos messages de façon fiable en tenant compte des réglementations et législations locales. En savoir plus.">
    ...
    <meta name="csrf-token" content="fKvrQL5qXuChsMon45bX-zakjKGt7AMNf04B_8OnVp3xYR0ddsEdCZZP8jARQX01CLVo9qzgyIaJkfKYfUrPWg==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
                         ...
                         <link rel="canonical" href="securite.htm">
        	...
        	<link rel="alternate" hreflang="fr-fr" href="securite.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Sécurité : sécurisez vos données">
        <meta property="og:description" content="Nous délivrons vos messages de façon fiable en tenant compte des réglementations et législations locales. En savoir plus.">
        <meta property="og:url" content="https://www.messagebird.com/fr-fr/securite">
        ...
        <meta name="twitter:title" content="Sécurité : sécurisez vos données">
        <meta name="twitter:description" content="Nous délivrons vos messages de façon fiable en tenant compte des réglementations et législations locales. En savoir plus.">
...
<div class="security new">
	<section class="page-section hero text-center">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h4 class="page-section-tag">Sécurité</h4>
					<h3 class="page-section-heading">Sécurisez vos données</h3>
					<p class="lp hero-copy">Divers hôpitaux, banques, et même gouvernements font appel à nos services car nous ne plaisantons pas en matière de sécurité et de vie privée. Une attention portée aux réglementations locales, la vérification des antécédents de nos employés, un accès restreint aux informations et le chiffrement des données sont parmi les gages de votre sécurité et de notre fiabilité.</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
	...
	<section class="page-section policies">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<h3 class="page-section-tag">Autorités</h3>
					<h2 class="page-section-heading">Protégé par les lois et réglementations</h2>
				</div>
				<div class="col-md-8 col-md-push-1">
					<div class="row">
						<div class="col-md-6">
							<img width="20" class="inline-block" src="https://cdn-gc.messagebird.com/assets/images/pages/security/icon_acm.svg">
							<h4 class="inline-block">ACM</h4>
							<p>Nous sommes inscrits auprès de la Dutch Authority for Consumers and Markets (ACM) et sommes donc tenus de faire preuve d’une totale transparence envers nos clients.</p>
						</div><div class="col-md-6">
							<img width="20" class="inline-block" src="https://cdn-gc.messagebird.com/assets/images/pages/security/icon_gsma.svg">
							<h4 class="inline-block">GSMA</h4>
							<p>Nous sommes membres associés de la Groupe Speciale Mobile Association (GSMA), qui représente les intérêts des opérateurs mobiles à travers le monde.</p>
						</div><div class="col-md-6">
							<img width="30" class="inline-block" src="https://cdn-gc.messagebird.com/assets/images/pages/security/icon_data.svg">
							<h4 class="inline-block">Protection des données</h4>
							<p>Toutes les données concernant des personnes identifiables et vivantes sont protégées, comme requis par le Dutch Data Protection Act (Wbp).</p>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="page-section employees text-center">
		<div class="container">
			<div class="row">
				<h4 class="page-section-tag">Garanties de sécurité</h4>
				<h3 class="page-section-heading m-b-60">Nous veillons sur vos données</h3>
				...
				<div class="col-md-4">
					...
					<h4>Vérifications</h4>
					<p>Tous nos employés font l’objet d’une vérification de leur expertise, de leur expérience et de leurs antécédents.</p>
				</div>
				<div class="col-md-4">
					<div class="icon">
					...
					<h4>Double regard</h4>
					<p>Lors de la manipulation d’informations sensibles, nous appliquons le principe du double regard.</p>
				</div>
				<div class="col-md-4">
					<div class="icon">
					...
					<p>Seuls les employés ayant besoin de travailler avec des données sensibles peuvent y accéder.</p>
				</div>
			</div>
		</div>
	</section>
