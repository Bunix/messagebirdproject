...
<html lang="fr-fr">
    ...
    <meta name="csrf-token" content="6vbxIJ0TTNpjzEHqoXQ1n76tK212QmlQ-kfWxjJVB19nPAd9VbgPM1Qzef1To59RgLzPOndOotsMmCWhjLiemA==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
        	...
        	<link rel="alternate" hreflang="fr-fr" href="privacy-old.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/fr-fr/privacy-old">
                ...
                <div class="col-md-6 not-on-mobile" id="contact-form">
                    <div>
                        <h3 class="page-section-small-heading">Contacter un collaborateur</h3>
                            ...
                            <form class="form-group contact-form" id="contact" method="post" action="/fr-fr/privacy-old#contact-form">
                                <input type="hidden" name="_csrf" value="6vbxIJ0TTNpjzEHqoXQ1n76tK212QmlQ-kfWxjJVB19nPAd9VbgPM1Qzef1To59RgLzPOndOotsMmCWhjLiemA==">                                <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
