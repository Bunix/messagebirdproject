...
<html lang="fr-fr">
    <head>
        ...
        <title>Sécurité accrue avec l'authentification à deux facteurs. - MessageBird</title>
        <meta name="description" content="Protégez-vous de tout accès non-autorisé avec l'authentification à deux facteurs (2FA). Faites un essai gratuit pour renforcer la sécurité.">
    ...
    <meta name="csrf-token" content="rEG48JAg8ILQHk6GKgUvwuB0ldQnAwN3Sm-idgi5E6chi06tWIuza-fhdpHY0oUM3mVxgyYPyPy8sFERtlSKYA==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
                         ...
                         <link rel="canonical" href="authentification-a-deux-facteurs.htm">
        	...
        	<link rel="alternate" hreflang="fr-fr" href="authentification-a-deux-facteurs.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Sécurité accrue avec l'authentification à deux facteurs.">
        <meta property="og:description" content="Protégez-vous de tout accès non-autorisé avec l'authentification à deux facteurs (2FA). Faites un essai gratuit pour renforcer la sécurité.">
        <meta property="og:url" content="https://www.messagebird.com/fr-fr/authentification-a-deux-facteurs">
        ...
        <meta name="twitter:title" content="Sécurité accrue avec l'authentification à deux facteurs.">
        <meta name="twitter:description" content="Protégez-vous de tout accès non-autorisé avec l'authentification à deux facteurs (2FA). Faites un essai gratuit pour renforcer la sécurité.">
                                    ...
                                    <a href="..\es-es\verificacion-en-dos-pasos.htm">
                                        <span>
                                            ...
                                            España                                        </span>
                                                            ...
                                                            <li class="locale-modal-menu-item">
                                    <a href="authentification-a-deux-facteurs.htm">
                                        <span>
				...
				<div class="col-md-12 page-full-restraint">
					<div class="center-vertical">
						...
						<h1 class="page-full-heading">
							Authentification à deux facteurs						</h1>
						<p class="page-full-desc">Prenez la sécurité au sérieux avec l'authentification à deux facteurs (2FA). Envoyez un One Time Password que vos clients devront utiliser pour se connecter à votre système.</p>
						...
						<div class="row">
							<div class="col-md-4 text-left">
								...
								<p class="page-full-paragraph smaller text-center">Vos clients indiquent leur numéro de téléphone lorsqu'ils se connectent à votre système.</p>
							</div>
							<div class="col-md-4">
								<div class="two-factor-step">
								...
								<p class="page-full-paragraph smaller text-center">Un code d'authentification unique a été créé et envoyé par SMS ou message vocal.</p>
							</div>
							<div class="col-md-4">
								<div class="two-factor-step">
									<div class="two-factor-browser">
								...
								<p class="page-full-paragraph smaller text-center">Les clients ont la possibilité de se connecter avec leur code d'authentification supplémentaire.</p>
							</div>
						</div>

						<div class="two-factor-software-box">
							Connectez-vous facilement à votre logiciel préféré :							<img src="https://cdn-gc.messagebird.com/assets/images/illustrations/icons/software/white/securenvoy.png">
						...
						<div class="page-full-button-box">
							...
							<span class="page-full-or">ou</span>
							<a href="contact-sales.htm" class="btn ghost hover">Contacter un collaborateur</a>
						</div>
