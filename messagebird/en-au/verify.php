...
<html lang="en-au">
    <head>
        ...
        <title>Verify - MessageBird</title>
        <meta name="description" content="Protect yourself from unauthorized access with Verify. Try it for free and add an extra layer of security to all of your logins.">
    ...
    <meta name="csrf-token" content="EaVBxFUiYnKfitWn2uxqCSP7LhQuUOyH_4tXge9bGc-cb7eZnYkhm6h17bAoO8DHHerKQy9cJwwJVKTmUbaACA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Protect yourself from unauthorized access with Verify. Try it for free and add an extra layer of security to all of your logins.">
        <meta property="og:url" content="https://www.messagebird.com/en-au/verify">
        ...
        <meta name="twitter:description" content="Protect yourself from unauthorized access with Verify. Try it for free and add an extra layer of security to all of your logins.">
        

        <script type="text/javascript">window.page = 'verify';</script>
...
ga('secondTracker.send', 'pageview');
        ...
        </script><script type="text/javascript">analytics.page("", {route: "app/pages/verify"});</script><script type="text/javascript">
            var _user_id = "";
                                        ...
                                        <li><span class="active">Related</span></li>
            	                    			...
            	                    			<a href="numbers.htm">
            	                    				Numbers &amp; Short codes            	         						</a>
            	                    	            	                    		...
            	                    	            	                    		<li>
            	                    			<a href="sms\pricing.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;verify&quot;});">
            	                    				SMS Pricing            	         						</a>
            	                    		</li>
            	                    	            	                    		<li>
            	                    			<a target="_blank" href="https://developers.messagebird.com" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;verify&quot;});">
                        ...
                        <select onchange="if (this.value) window.location.href=this.value">
                            <option value="" disabled="" selected="">Choose your country
                                                            <optgroup label="Africa">
                                                                                <option value="/en-gh/verify" data-name-locale="English">
                                                Ghana                                            
                                                                                    <option value="/en-ke/verify" data-name-locale="English">
                                                Kenya                                            
                                                                                    <option value="/en-ng/verify" data-name-locale="English">
                                                Nigeria                                            
                                                                                    <option value="/en-ug/verify" data-name-locale="English">
                                                Uganda                                            
                                                                                    <option value="/en-zw/verify" data-name-locale="English">
                                                Zimbabwe                                            
                                                                        </optgroup>
                                                          <optgroup label="Asia">
                                                                                <option value="/en-hk/verify" data-name-locale="English">
                                                Hong Kong                                            
                                                                                    <option value="/en-sg/verify" data-name-locale="English">
                                                Singapore                                            
                                                                        </optgroup>
                                                          <optgroup label="Europe">
                                                                                <option value="/fr-be/verify" data-name-locale="Français">
                                                Belgique                                            
                                                                                    <option value="/nl-be/verify" data-name-locale="Vlaams">
                                                België                                            
                                                                                    <option value="/de-de/verify" data-name-locale="Deutsch">
                                                Deutschland                                            
                                                                                    <option value="/es-es/verify" data-name-locale="Español">
                                                España                                            
                                                                                    <option value="/fr-fr/verify" data-name-locale="Français">
                                                France                                            
                                                                                    <option value="/en-gi/verify" data-name-locale="English">
                                                Gibraltar                                            
                                                                                    <option value="/en-gg/verify" data-name-locale="English">
                                                Guernsey                                            
                                                                                    <option value="/en-ie/verify" data-name-locale="English">
                                                Ireland                                            
                                                                                    <option value="/en-im/verify" data-name-locale="English">
                                                Isle of Man                                            
                                                                                    <option value="/en-je/verify" data-name-locale="English">
                                                Jersey                                            
                                                                                    <option value="/nl/verify" data-name-locale="Nederlands">
                                                Nederland                                            
                                                                                    <option value="/en-gb/verify" data-name-locale="English">
                                                United Kingdom                                            
                                                                        </optgroup>
                                                          <optgroup label="North America">
                                                                                <option value="/en-bs/verify" data-name-locale="English">
                                                Bahamas                                            
                                                                                    <option value="/en-bz/verify" data-name-locale="English">
                                                Belize                                            
                                                                                    <option value="/en-bm/verify" data-name-locale="English">
                                                Bermuda                                            
                                                                                    <option value="/en-vg/verify" data-name-locale="English">
                                                British Virgin Islands                                            
                                                                                    <option value="/en-ca/verify" data-name-locale="English">
                                                Canada                                            
                                                                                    <option value="/en-ky/verify" data-name-locale="English">
                                                Cayman Islands                                            
                                                                                    <option value="/en-gd/verify" data-name-locale="English">
                                                Grenada                                            
                                                                                    <option value="/en-jm/verify" data-name-locale="English">
                                                Jamaica                                            
                                                                                    <option value="/en-pr/verify" data-name-locale="English">
                                                Puerto Rico                                            
                                                                                    <option value="/en-tt/verify" data-name-locale="English">
                                                Trinidad & Tobago                                            
                                                                                    <option value="/en-us/verify" data-name-locale="English">
                                                United States                                            
                                                                        </optgroup>
                                                          <optgroup label="Oceania">
                                                                                <option value="/en-au/verify" data-name-locale="English">
                                                Australia                                            
                                                                                    <option value="/en-gu/verify" data-name-locale="English">
                                                Guam                                            
                                                                                    <option value="/en-nz/verify" data-name-locale="English">
                                                New Zealand                                            
                                                                        </optgroup>
                                                          <optgroup label="South America">
                                                                                <option value="/en-gy/verify" data-name-locale="English">
                                                Guyana                                            
                                                                        </optgroup>
                                                    <optgroup label="Other">
                              <option value="/en/verify" data-name-locale="Rest of world">
                                  Rest of world
...
<div class="verify new">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <h1 class="mb-page-title">Verify</h1>
                <div class="xlp">Implement Two-factor authentication (2FA) and One-time password (OTP) solutions to secure customer data, block fraudulent accounts, and safeguard key transactions.</div>
                ...
                <div class="page-section-btn-container">
                    <form id="index-signup" class="start" novalidate="true" action="https://dashboard.messagebird.com/app/en-au/sign-up/" method="GET">
                        ...
                        <div class="hero-sub-cta sp" style="margin-top: 15px;">Looking for a custom plan? <a href="contact-sales.htm" class="page-section-link" style="margin-left: 5px;">Contact sales ⇢</a></div>
                    </form>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div>
                    <div class="device-container hidden-xs hidden-sm" style="float: right">
                                ...
                                <div class="device-screen">
                                    ...
                                    <div class="device-ui">
                                        <div class="device-ui-status-bar">
                                            12:29                                            <i class="fa fa-signal" aria-hidden="true" style="right: 20px;"></i>
                                            <i class="fa fa-battery-half pull-right"></i>
                                        </div>
                                        <div class="screen">
                                        <div class="slide-down js-slideDown-msg text-left">
                                            <span class="originator">MoneyBank</span> <span class="time">10 sec ago</span>
                                            <p class="password">Your verification code is: 713 905</p>
                                            <div class="handle"></div>
                                        </div>
                                        <div class="js-card card">
                                            <div class="js-picture picture"></div>
                                            <div class="js-content content">
                                                <div class="content-copy">
                                                    <h4 class="title">MoneyBank</h4>
                                                    <p>To continue, please enter the verification code we’ve just sent you.</p>
                                                </div>
                                                <div class="numbers">
                                                    <span class="js-number js-number-1">
                                            ...
                                            <div class="js-content-success content-success" style="display: none;">
                                                <h2>Success!</h2>
    ...
    <div class="skewed-stripe-background" style="transform: skewY(-11deg);
            background: #f6fafd;
            height: 795px;
            width: 100%;
            margin-top: -168px;
    ...
    <div class="container">
        <div class="row">
           <header class="text-center">
                ...
                <h2 class="page-section-heading">Secure your platform</h2>
            </header>

            <div class="pane col-md-4">
                <h4 class="features-label">Number Verification</h4>
                <p class="sp">Prevent bots and spammers from accessing your platform or creating bulk account registrations. Authenticate new users by requiring and verifying their phone numbers.</p>
            </div>

            <div class="pane col-md-4">
                <h4 class="features-label">Account Logins</h4>
                <p class="sp">Protect your users from account takeovers and data theft. Secure accounts by setting up OTP solutions at crucial points within your platform via SMS or Voice messaging.</p>
            </div>

            <div class="pane col-md-4">
                <h4 class="features-label">Transaction Security</h4>
                <p class="sp">Add an extra layer of safety to your user interactions. Implement an OTP trigger to verify accounts before they’re able to proceed with high-value or sensitive transactions.</p>
            </div>
        </div>
    </div>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Authentication, solved</h4>
            <h2 class="page-section-heading">Why use MessageBird Verify</h2>
        </header>
        <div class="row">
            ...
            <p class="lp">Enterprises are increasingly challenged to keep sensitive information from falling into the hands of hackers, scammers, and the like. Last year alone, 85% of organizations reported being the target of a phishing attack. Businesses that rely on cloud-based services are some of the most vulnerable to being compromised, especially when you consider that 75% of online accounts are guarded by duplicate passwords.</p><h4 class="features-label">Reliable Protection</h4><p class="lp">With so much on the line wherever security is involved, what’s the best way to go about adding protective measures to your accounts? According to data security experts, 80% of online security breaches could be prevented by two-factor authentication. 2FA provides a much stronger layer of security than passwords alone as it requires users to provide a second means of identification from a separate user device, typically through a mobile phone.</p><h4 class="features-label">Turn-key Authentications</h4><p class="lp">MessageBird Verify provides you with a turn-key authentication service that can be enabled within a single sprint. It’s simple enough to implement by sending us only a number to process, but it can also be customized to your required security levels and use cases. Additionally, MessageBird uses best-in-class SSL and tokenization technology to confirm identities and secure sensitive information.</p><p class="lp">And while some of our competitors still add surcharges for authentication services, with MessageBird, you only have to pay for the SMS or Voice messages you send during the authentication process. No hidden fees, no subscription costs, no extra charges.</p>
...
<div class="document-download">
	<a href="#" data-toggle="modal" data-target="#verify-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;verify&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Get Verify PDF ⇢</span>
...
<div class="rd17 pdf-modal modal fade" id="verify-whitepaper" tabindex="-1" role="dialog">
			...
			<div class="modal-body lp">
				...
				<div class="row">
					<div class="col-md-7">
						...
						<h1 class="mb-page-title">Get the Verify Overview</h1>
<p class="lp">Find out more about what MessageBird Verify can do for your business. Enter your email below and we’ll send a PDF directly to your inbox.</p>
...
<form id="downloadpdf">
  <div class="form-group">
      <div class="input-group">
          ...
          <input type="hidden" name="type" value="verify-pdf">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp result-verify-whitepaper">

						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="sms.htm#pdf">SMS</a>, <a href="voice.htm#pdf">Voice</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-au/chat#pdf">Chat</a>.</p>
    ...
    <div class="container">
        <div class="row flex">
           <header class="col-md-12 text-center">
                ...
                <h2 class="page-section-heading">Customize your verification process</h2>
            </header>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-verify-flash.svg">
                    
                    Flash or SMS Messages</h4>
	                <p class="benefits-copy sp">Choose to send SMS messages or unstored flash messages that only appear on phone screens, rather than in a conversation thread.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="22" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-verify-voice.svg">
                    
                    Voice Messaging</h4>
	                <p class="benefits-copy sp">Send OTPs via Voice in any of our 20 offered languages. Customers will receive a call and hear their verification code upon answering.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="22" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-verify-otp.svg">
                    
                    OTP Integrations</h4>
	                <p class="benefits-copy sp">Easily integrate Verify straight away with all well-known OTP services, including SecurEnvoy, Dell EMC, and SafeNet.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="22" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-verify-ppm.svg">
                    
                    Pay-per-message</h4>
	                <p class="benefits-copy sp">Use our Verify software and integrations at no added cost. All you’ll pay for is the SMS or Voice messages you send.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="22" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-verify-prompts.svg">
                    
                    Custom Prompts</h4>
	                <p class="benefits-copy sp">Adjust your authentication messages to display verification code instructions however you see fit.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-verify-authentication.svg">
                    
                    Authentication Options</h4>
	                <p class="benefits-copy sp">Set the length of your codes anywhere between 6 to 10 characters and customize code expiration times.</p>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p class="code-example-content lp">Seamlessly integrate our 2FA SMS and Voice messaging solutions within your CRM software, website, or app. Read up on our developer documentation and send your OTPs through our 900+ carrier connections worldwide.</p>
                    ...
                    <li>
                        <a href="https://developers.messagebird.com/docs/introduction" target="_blank">
                            <img src="https://cdn-gc.messagebird.com/assets/images/icons/libraries/ruby.svg">
									...
									<a class="page-section-link" href="https://developers.messagebird.com/docs/verify" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;verify&quot;});">Visit the developer docs ⇢</a>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="article">
                    ...
                    <h3 class="page-section-heading new">SMS and TTS pricing</h3>
                ...
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        ...
                        <div class="js-pricing-outbound-sms number">-</div>
                        <div class="sp description">Per outbound SMS to Philippines</div>
                    </div>
                    <div class="statistic">
                        <div class="js-currency currency number">
                            $
                        </div>
                        <div class="js-pricing-outbound-tts number">-</div>
                        <div class="sp description">Per outbound Voice Message to Philippines</div>
                    </div>
                </div>

                <a href="sms\pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;verify&quot;});">Check out SMS pricing ⇢</a>
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing@2x.png 2x" height="75">
                                            ...
                                            <h3 class="page-section-heading new">Send from a local number</h3>
                ...
                <div class="statistics clearfix">
                    ...
                    <div class="statistic">
                        ...
                        <div class="sp description">Supporting 50+ countries</div>
                                    ...
                                    <a class="page-section-link new" href="numbers.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;verify&quot;});">Learn more about local numbers ⇢</a>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">Verify</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-au/verify#contact-form">
                            <input type="hidden" name="_csrf" value="EaVBxFUiYnKfitWn2uxqCSP7LhQuUOyH_4tXge9bGc-cb7eZnYkhm6h17bAoO8DHHerKQy9cJwwJVKTmUbaACA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
...
<script type="text/javascript">jQuery(document).ready(function () {
	...
	$('.download-pdf').submit(function() {
		var _this = $(this);
		var formResult = $('.result-verify-whitepaper'); // PHP verify-whitepaper
	    $.ajax({
