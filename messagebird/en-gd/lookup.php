...
<html lang="en-gd">
    <head>
        ...
        <meta name="description" content="Find out whether the contact information you have on your clients is still up-to-date. Clean up your database and reduce the amount of undelivered messages.">
    ...
    <meta name="csrf-token" content="ZuNzKG037XIxnHL1GvfqiLqTdIWMhW_ehYPXrbpsglPrKYV1pZyumwZjSuLoIEBGhIKQ0o2JpFVzXCTKBIEblA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Find out whether the contact information you have on your clients is still up-to-date. Clean up your database and reduce the amount of undelivered messages.">
        <meta property="og:url" content="https://www.messagebird.com/en-gd/lookup">
        ...
        <meta name="twitter:description" content="Find out whether the contact information you have on your clients is still up-to-date. Clean up your database and reduce the amount of undelivered messages.">
...
<section class="hero page-section">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
              ...
              <div class="h1-links">
                Retrieve accurate, detailed information on any phone number in the world in real time. Keep your database clean and minimize your messaging costs.            </div>
            <div class="page-section-btn-container">
                <a href="/en-gd/signup" class="btn btn-cta">Try it for free</a>
                <a href="contact-sales.htm" class="btn ghost mb-ripple-in">Contact sales</a>
            </div>
            </div>
        </div>
    </div>
   ...
   <div class="container">
       <div class="row">
        <h6 class="col-xs-12 col-md-6">Enter a phone number</h6>
        <div class="col-xs-12 col-md-6 text-right lookup-demo-examples">
            <span class="label">Format examples</span> <h4 class="pill pill-blue"><a href="#" class="js-lookup-demo-example active" data-type="mobile" data-example="31624718600">Mobile</a></h4> <h4 class="pill pill-blue"><a href="#" class="js-lookup-demo-example" data-type="voip" data-example="31207009850">Fixed line</a></h4> <h4 class="pill pill-blue"><a href="#" class="js-lookup-demo-example" data-type="invalid" data-example="12345678">Invalid</a></h4>
        </div>
        <div class="col-xs-12">
            <input type="text" name="lookup-number" class="lookup-demo-input js-lookup-demo-input" value="+447860039225" disabled="">
        </div>
    </div>
    <div class="row text-left" style="margin-top: 30px;">
        <div class="col-md-6">
            <h6>Lookup response</h6>
...
"status": "active",
"createdDatetime": "2017-09-05T12:44:38+00:00",
"statusDatetime": "2017-09-05T12:44:38+00:00"
}</code></pre>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="steps-wrap">
                <div class="col-md-4">
                    <h4 class="pill pill-purple">step 1</h4>
                    <p class="sp">Supply our API with the phone numbers you’d like to check.</p>
                </div>
                <div class="col-md-4">
                    <h4 class="pill pill-purple">step 2</h4>
                    <p class="sp">Our API performs an HLR Lookup on the mobile network and identifies the number format.</p>
                </div>
                <div class="col-md-4">
                    <h4 class="pill pill-purple">step 3</h4>
                    <p class="sp">We fill in the number data, along with availability and provider.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="page-section features">
    <div class="container">
        <div class="row">
             <header class="col-xs-12 text-center" style="margin-bottom: 60px;">
                ...
                <h2 class="page-section-heading">For a contact database that’s clean, optimized, and secure</h2>
            </header>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <h3 class="page-section-heading">Lookup <span class="pill pill-purple">Free service</span>
                <p class="lp">Our free-to-use Lookup service provides basic number insights to help you keep your contact numbers organized. Validate numbers and formats, eliminate fraudulent contacts, and reduce your undeliverable messages by ridding your recipient lists of inactive numbers.</p>
    ...
    "rfc3966": "tel:+31-6-42657439"
                ...
                <h4 class="features-label">Number info</h4>
                <p class="sp">Classify numbers as mobile, landline or SIP.</p>
        ...
        <div class="row">
            <div class="col-md-6">
                <h3 class="page-section-heading">Lookup + HLR <span class="pill pill-purple">Paid service</span>
                <p class="lp">Through MessageBird’s direct connection to the <abbr title="Signalling System No. 7">SS7</abbr> network, we’re able to send an <abbr title="Send Routing Info">SRI</abbr> request to receive information from the <abbr title="Home Location Register">HLR</abbr> network regarding any currently active number in the world.</p>
            </h3></div>
            <div class="col-md-6">
               ...
               <p class="sp">Identify a number’s country of origin as well as the mobile network to which it’s registered.</p>
               ...
               <h4 class="features-label"> Location <abbr title="International Mobile Subscriber Identity">IMSI</abbr></h4>
               <p class="sp">Discover any given number’s current geolocation.</p>
               ...
               <h4 class="features-label"> Number Validity</h4>
               <p class="sp">Establish whether a number is active, deactivated, or unregistered.</p>
                ...
                <p class="sp">Determine whether a subscriber is roaming, in which country they are roaming, and on which network they are currently registered.</p>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Contacts, solved</h4>
            <h2 class="page-section-heading">Why use MessageBird Lookup</h2>
        </header>
        <div class="row">
        ...
        <p class="lp">Getting better acquainted with the numbers in your contact database carries a host of benefits. In addition to cutting messaging costs, Lookup enables you to organize your CRM by number type, origin countries, and other criteria for a database that’s easy to navigate.</p><h4 class="features-label">Reduce Messaging Costs</h4><p class="lp">Using Lookup can drastically reduce messaging costs for high and low volume senders alike. From highlighting numbers that are incorrectly formatted to identifying landlines to eliminating numbers that are no longer active or reachable, you’ll minimize undeliverable messages by running your contacts through our Lookup API. Validating your CRM content is the simplest way to save unnecessary costs and keep your database clean.</p><h4 class="features-label">Easy-to-use API</h4><p class="lp">Both the free and HLR versions of MessageBird Lookup are extremely easy to access and utilize. A simple call to our user-friendly REST API is all you need to retrieve detailed information on your contact numbers, with instant delivery of results for the free Lookup service and results for HLR lookups delivered within seconds of your command.</p>
	...
	<a href="#" data-toggle="modal" data-target="#lookup-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;lookup&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Get Lookup PDF ⇢</span>
			...
			<div class="modal-body lp">
				...
				<div class="row">
					<div class="col-md-7">
						...
						<h1 class="mb-page-title">Get the Lookup Overview</h1>
<p class="lp">Find out more about what MessageBird Lookup can do for your business. Enter your email below and we’ll send a PDF directly to your inbox.</p>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="sms.htm#pdf">SMS</a>, <a href="voice.htm#pdf">Voice</a>, <a href="verify.htm#pdf">Verify</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-gd/chat#pdf">Chat</a>.</p>
                    ...
                    <li>
                        <a href="https://developers.messagebird.com/docs/introduction" target="_blank">
                            <img src="https://cdn-gc.messagebird.com/assets/images/icons/libraries/ruby.svg">
									...
									<a class="page-section-link" href="https://developers.messagebird.com/docs/lookup" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;lookup&quot;});">Visit the developer docs ⇢</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                    ...
                    <h3 class="page-section-heading new">Lookup and HLR pricing</h3>
                    <p class="lp">Our basic Lookup service is entirely free, and our direct connection to the SS7 network allows us to perform HLR Lookups at the lowest possible cost.</p>
                </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        ...
                        <div class="sp description">Lookup requests are free in Philippines </div>
                    </div>
                    <div class="statistic">
                        ...
                        <div class="js-pricing-hlr number">
                            0.015                        </div>
                        <div class="sp description">Per HLR request in Philippines</div>
                    </div>
                </div>

                <a href="pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;lookup&quot;});">Check out all pricing ⇢</a>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">Lookup</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-gd/lookup#contact-form">
                            <input type="hidden" name="_csrf" value="ZuNzKG037XIxnHL1GvfqiLqTdIWMhW_ehYPXrbpsglPrKYV1pZyumwZjSuLoIEBGhIKQ0o2JpFVzXCTKBIEblA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
