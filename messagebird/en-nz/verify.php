...
<html lang="en-nz">
    ...
    <meta name="csrf-token" content="YhDABix2s5NrmJ5ik3uinfgbwZpIF-G-h_a34Owk3jTv2jZb5N3welxnpnVhrAhTxgolzUkbKjVxKUSHUslH8w==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-nz/verify">
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="sms.htm#pdf">SMS</a>, <a href="voice.htm#pdf">Voice</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-nz/chat#pdf">Chat</a>.</p>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                        ...
                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-nz/verify#contact-form">
                            <input type="hidden" name="_csrf" value="YhDABix2s5NrmJ5ik3uinfgbwZpIF-G-h_a34Owk3jTv2jZb5N3welxnpnVhrAhTxgolzUkbKjVxKUSHUslH8w==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
