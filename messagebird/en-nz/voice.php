...
<html lang="en-nz">
    <head>
        ...
        <meta name="description" content="Integrate our enterprise-grade Voice API to affordably connect your app or website to a highly scalable carrier network in the cloud.">
    ...
    <meta name="csrf-token" content="jayLYjp38dkXiKSfdQ8ZZmxiSviicmaWrqBZqj7InMwAZn0_8tyyMCB3nIiH2LOoUnOur6N-rR1Yf6rNgCUFCw==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Integrate our enterprise-grade Voice API to affordably connect your app or website to a highly scalable carrier network in the cloud.">
        <meta property="og:url" content="https://www.messagebird.com/en-nz/voice">
        ...
        <meta name="twitter:description" content="Integrate our enterprise-grade Voice API to affordably connect your app or website to a highly scalable carrier network in the cloud.">
        ...
        <div class="container" style="z-index: 1;">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="xlp">
                        Programmatically make, receive and track clear sounding, drop-resistant calls around the world with our scalable carrier network in the cloud.                    </div>
                ...
                <div class="col-md-8">
                    <div class="row flex">
                        <header class="col-xs-12 text-center">
                            ...
                            <h2 class="page-section-heading">Create unique voice-based interactions</h2>
                        </header>

                        <div class="pane">
                            <h4 class="features-label">Voice Messaging</h4>
                            <p class="benefits-copy sp">Use our multilingual text-to-speech platform to reach your customers with a call.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">In-app Calling</h4>
                            <p class="benefits-copy sp">Allow customers to call you directly within your app without having to place a regular call.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Automated Forwarding</h4>
                            <p class="benefits-copy sp">Let customers reach you at your chosen destination either by porting an existing number or purchasing one of our local or toll free Numbers.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Call Centers</h4>
                            <p class="benefits-copy sp">Lower the cost of your existing on-premise solution or build your own multi-channel contact center from scratch with our scalable Voice API.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Anonymous Communications</h4>
                            <p class="benefits-copy sp">Protect the privacy of your customers and employees by allowing them to connect without sharing identities or personal contact details.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Alert Broadcasts</h4>
                            <p class="benefits-copy sp">Share urgent information by sending voice messages to your customers using text-to-speech or your own pre-recorded message.</p>
                        </div>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Voice, solved</h4>
            <h2 class="page-section-heading">Why use MessageBird Voice</h2>
        </header>
        <div class="row">
            ...
            <div class="col-md-7 pane">
                ...
                <div class="read-more-container js-read-more-container">
                    ...
                    <p class="lp">MessageBird’s Voice API enables businesses of all sizes to connect with their customers by adding programmable voice capabilities to nearly any app, website, or communication system. We work directly with hundreds of carriers around the world to ensure reliable connectivity on a global basis and have access to local numbers for all major metro markets.</p><h4 class="features-label">Fault-tolerant Network</h4><p class="lp">We’ve built a fault-tolerant network that supports all standard codecs for voice compression as well as industry-standard SIP Protocol for VoIP, so you can always count on our platform to support you with drop-resistant and clear-sounding calls. To further optimize voice traffic, we utilize a global low latency architecture with an adaptive jitter buffer algorithm as well as least-cost routing technology.</p><h4 class="features-label">Easy-to-use API</h4><p class="lp">In addition to our enterprise-grade network, our easy-to-use API comes packed with features that allow developers to build scalable voice applications that are useful to nearly every department in your company. We’re already trusted by some of the biggest tech names in the business, and we’re just getting started.</p>
	...
	<a href="#" data-toggle="modal" data-target="#voice-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;voice&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Get Voice PDF ⇢</span>
    ...
    <div class="container">
        <div class="row flex">
           <header class="col-md-12 text-center">
                ...
                <h2 class="page-section-heading">Optimize your Voice experience</h2>
            </header>
            	...
            	<div class="pane">
                    ...
                    Sip-Compatible Device Calling</h4>
	                <p class="benefits-copy sp">Use your number to place an internet call to any SIP URI, free of charge.</p>
            	...
            	<div class="pane">
                    ...
                    Per Second Billing</h4>
	                <p class="benefits-copy sp">Unlike with our competitors, don’t pay for a second longer than your actual calling time.</p>
            	...
            	<div class="pane">
                    ...
                    Audio Playback</h4>
	                <p class="benefits-copy sp">Upload a sound file of your own that will play when your number is called.</p>
            	...
            	<div class="pane">
                    ...
                    Call Recording</h4>
	                <p class="benefits-copy sp">Use our record feature to allow your callers to leave a message or to record conversations.</p>
            	...
            	<div class="pane">
                    ...
                    Answering Machine Detection</h4>
	                <p class="benefits-copy sp">Detect whether your call has reached an answering machine and either hang up or leave a message.</p>
            	...
            	<div class="pane">
                    ...
                    Text to Speech</h4>
	                <p class="benefits-copy sp">Generate a custom voice message in any of our 20 offered languages. Your message will play automatically once your call is answered.</p>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="article">
                    ...
                    <h3 class="page-section-heading new">Competitive Voice pricing</h3>
                    <p class="lp">We offer enterprise quality calling at unmatched prices, with per-second billing to minimize your calling costs.</p>
                </div>
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        ...
                        <div class="js-pricing-placing-a-call number">
                           0.1327                        </div> <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please note that this price is a country average. Prices may vary depending on which provider(s) are used to connect your call(s)."></i>
                        <div class="sp description">Per minute when placing a call in Philippines</div>
                    </div>
                    <div class="statistic">
                        <div class="js-currency currency number">
                            $
                        ...
                        <div class="js-pricing-receiving-a-call number">
                            0.0031                        </div> <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please note that this price is a country average. Prices may vary depending on which provider(s) are used to connect your call(s)."></i>
                        <div class="sp description">Per minute when receiving a call in Philippines</div>
                    </div>
                </div>

                <a href="voice\pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;voice&quot;});">Check out Voice pricing ⇢</a>
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing@2x.png 2x" height="75">
                                            ...
                                            <h3 class="page-section-heading new">Local voice-enabled numbers</h3>
                ...
                <div class="statistics clearfix">
                    ...
                    <div class="statistic">
                        ...
                        <div class="sp description">Supporting 50+ countries</div>
                                    ...
                                    <a class="page-section-link new" href="numbers.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;voice&quot;});">Learn more about local numbers ⇢</a>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                        ...
                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-nz/voice#contact-form">
                            <input type="hidden" name="_csrf" value="jayLYjp38dkXiKSfdQ8ZZmxiSviicmaWrqBZqj7InMwAZn0_8tyyMCB3nIiH2LOoUnOur6N-rR1Yf6rNgCUFCw==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
