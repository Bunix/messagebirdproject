...
<html lang="en-nz">
    ...
    <meta name="csrf-token" content="dXyYqzuH0GIJFWiXpWmvw9nLkgN6ugSFQrD5VoRfBWP4tm728yyTiz7qUIBXvgUN59p2VHu2zw60bwoxOrKcpA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-nz/chat-api">
                ...
                <div class="col-md-6">
                    ...
                    <div class="page-section-btn-container">
                        ...
                        <form id="index-signup" class="start" novalidate="true" action="https://dashboard.messagebird.com/app/en-nz/sign-up/" method="GET">
                            ...
                            <div class="hero-sub-cta sp">Looking for a custom plan? <a href="contact-sales.htm" class="page-section-link" style="margin-left: 5px;">Contact sales ⇢</a></div>
                        </form>
                    </div>
                </div>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="sms.htm#pdf">SMS</a>, <a href="voice.htm#pdf">Voice</a>, <a href="verify.htm#pdf">Verify</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a> and <a href="numbers.htm#pdf">Short Code</a>.</p>
            ...
            <div class="device-screen">
                ...
                <div class="device-ui">
                    <div class="device-ui-status-bar">
                        12:35                        <i class="fa fa-signal" aria-hidden="true" style="right: 20px;"></i>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="article">
                    ...
                    <p>Can’t find a plan that suits your needs? <a href="contact-sales.htm">Get in touch with our sales team</a> for a custom plan.</p>
                </div>

                <a href="chat\pricing.htm" class="btn btn-cta" style="" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;chat&quot;});">Check out Chat pricing ⇢</a>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                        ...
                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-nz/chat-api#contact-form">
                            <input type="hidden" name="_csrf" value="dXyYqzuH0GIJFWiXpWmvw9nLkgN6ugSFQrD5VoRfBWP4tm728yyTiz7qUIBXvgUN59p2VHu2zw60bwoxOrKcpA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
