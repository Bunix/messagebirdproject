...
<html lang="en-nz">
    <head>
        ...
        <title>SMS - MessageBird</title>
        <meta name="description" content="Send messages through our website or your own software or app. Try our SMS Gateway for free and connect to over 900 operators worldwide.">
    ...
    <meta name="csrf-token" content="q9B7iaBT5WygvaKXYGgabzdISwEo0QYbvmFzdI2_akQmGo3UaPimhZdCmoCSv7ChCVmvVindzZBIvoATM1Lzgw==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Send messages through our website or your own software or app. Try our SMS Gateway for free and connect to over 900 operators worldwide.">
        <meta property="og:url" content="https://www.messagebird.com/en-nz/sms">
        ...
        <meta name="twitter:description" content="Send messages through our website or your own software or app. Try our SMS Gateway for free and connect to over 900 operators worldwide.">
        

        <script type="text/javascript">window.page = 'sms-gateway-new';</script>
...
ga('secondTracker.send', 'pageview');
        ...
        </script><script type="text/javascript">analytics.page("", {route: "app/pages/sms"});</script><script type="text/javascript">
            var _user_id = "";
...
<ul class="animated zoomIn" role="menu" aria-labelledby="aboutMenu">
    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-12">
                <div class="container-lg flex-end">

                    <div class="mask-container js-stick">
                        <div class="sticky-wrapper">

                            <div class="container">
                                <div class="floater flex-end">
                                    <div class="flex-c-v js-stick-toggle" style="display: none;">
                                        <img src="..\assets\images\glyph.svg" width="30" height="25">
            	                    ...
            	                    <ul>
                                        <li><span class="active">Related</span></li>

            	                    	            	                    		<li>
            	                    			<a href="sms\pricing.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;sms&quot;});">
            	                    				SMS Pricing            	         						</a>
            	                    		</li>
            	                    	            	                    		<li>
            	                    			<a href="numbers.htm">
            	                    				Numbers &amp; Short codes            	         						</a>
            	                    		</li>
            	                    	            	                    		<li>
            	                    			<a href="verify.htm">
            	                    				Verify            	         						</a>
            	                    	            	                    		...
            	                    	            	                    		<li>
            	                    			<a target="_blank" href="https://developers.messagebird.com" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;sms&quot;});">
            	                    				Docs<i class="fa fa-external-link" aria-hidden="true"></i>            	         						</a>
            	                    		</li>
            	                    	                                        <li><a href="/en-nz/sign-up" class="btn btn-cta sticky-cta js-stick-toggle" style="display: none;">Get started now</a></li>
            	                    </ul>
                                </div>
                            </div>
                        ...
                        <select onchange="if (this.value) window.location.href=this.value">
                            <option value="" disabled="" selected="">Choose your country
                                                            <optgroup label="Africa">
                                                                                <option value="/en-gh/sms" data-name-locale="English">
                                                Ghana                                            
                                                                                    <option value="/en-ke/sms" data-name-locale="English">
                                                Kenya                                            
                                                                                    <option value="/en-ng/sms" data-name-locale="English">
                                                Nigeria                                            
                                                                                    <option value="/en-ug/sms" data-name-locale="English">
                                                Uganda                                            
                                                                                    <option value="/en-zw/sms" data-name-locale="English">
                                                Zimbabwe                                            
                                                                        </optgroup>
                                                          <optgroup label="Asia">
                                                                                <option value="/en-hk/sms" data-name-locale="English">
                                                Hong Kong                                            
                                                                                    <option value="/en-sg/sms" data-name-locale="English">
                                                Singapore                                            
                                                                        </optgroup>
                                                          <optgroup label="Europe">
                                                                                <option value="/fr-be/sms" data-name-locale="Français">
                                                Belgique                                            
                                                                                    <option value="/nl-be/sms" data-name-locale="Vlaams">
                                                België                                            
                                                                                    <option value="/de-de/sms" data-name-locale="Deutsch">
                                                Deutschland                                            
                                                                                    <option value="/es-es/sms" data-name-locale="Español">
                                                España                                            
                                                                                    <option value="/fr-fr/sms" data-name-locale="Français">
                                                France                                            
                                                                                    <option value="/en-gi/sms" data-name-locale="English">
                                                Gibraltar                                            
                                                                                    <option value="/en-gg/sms" data-name-locale="English">
                                                Guernsey                                            
                                                                                    <option value="/en-ie/sms" data-name-locale="English">
                                                Ireland                                            
                                                                                    <option value="/en-im/sms" data-name-locale="English">
                                                Isle of Man                                            
                                                                                    <option value="/en-je/sms" data-name-locale="English">
                                                Jersey                                            
                                                                                    <option value="/nl/sms" data-name-locale="Nederlands">
                                                Nederland                                            
                                                                                    <option value="/en-gb/sms" data-name-locale="English">
                                                United Kingdom                                            
                                                                        </optgroup>
                                                          <optgroup label="North America">
                                                                                <option value="/en-bs/sms" data-name-locale="English">
                                                Bahamas                                            
                                                                                    <option value="/en-bz/sms" data-name-locale="English">
                                                Belize                                            
                                                                                    <option value="/en-bm/sms" data-name-locale="English">
                                                Bermuda                                            
                                                                                    <option value="/en-vg/sms" data-name-locale="English">
                                                British Virgin Islands                                            
                                                                                    <option value="/en-ca/sms" data-name-locale="English">
                                                Canada                                            
                                                                                    <option value="/en-ky/sms" data-name-locale="English">
                                                Cayman Islands                                            
                                                                                    <option value="/en-gd/sms" data-name-locale="English">
                                                Grenada                                            
                                                                                    <option value="/en-jm/sms" data-name-locale="English">
                                                Jamaica                                            
                                                                                    <option value="/en-pr/sms" data-name-locale="English">
                                                Puerto Rico                                            
                                                                                    <option value="/en-tt/sms" data-name-locale="English">
                                                Trinidad & Tobago                                            
                                                                                    <option value="/en-us/sms" data-name-locale="English">
                                                United States                                            
                                                                        </optgroup>
                                                          <optgroup label="Oceania">
                                                                                <option value="/en-au/sms" data-name-locale="English">
                                                Australia                                            
                                                                                    <option value="/en-gu/sms" data-name-locale="English">
                                                Guam                                            
                                                                                    <option value="/en-nz/sms" data-name-locale="English">
                                                New Zealand                                            
                                                                        </optgroup>
                                                          <optgroup label="South America">
                                                                                <option value="/en-gy/sms" data-name-locale="English">
                                                Guyana                                            
                                                                        </optgroup>
                                                    <optgroup label="Other">
                              <option value="/en/sms" data-name-locale="Rest of world">
                                  Rest of world
...
<div class="sms new">
    <section class="hero page-section">
        <div class="container" style="z-index: 1;">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="mb-page-title">SMS</h1>
                    <div class="xlp">
                        Power your SMS communications with unmatched deliverability and low latency on our globally scalable messaging API.                                            </div>

                    <div class="page-section-btn-container">
                        
                        <form id="index-signup" class="start" novalidate="true" action="https://dashboard.messagebird.com/app/en-nz/sign-up/" method="GET">
                            ...
                            <div class="hero-sub-cta sp" style="margin-top: 15px;">Looking for a custom plan? <a href="contact-sales.htm" class="page-section-link">Contact sales ⇢</a></div>
                        </form>
                    </div>
                </div>
                <div class="col-md-6">

                    <div class="clearfix" style="position: absolute;left: 120px;top: 60px;">
                        <div class="device-container hidden-xs hidden-sm" style="float: none;">
    <div class="device-mockup">

        <div class="device" style="transform: rotate(-11deg);">
            <div class="device-screen">

                <div class="device-ui">
                    <div class="device-ui-status-bar">
                        12:28                        <i class="fa fa-signal" aria-hidden="true" style="right: 20px;"></i>
                        <i class="fa fa-battery-half pull-right"></i>
                    </div>

                    
                        <div class="device-ui-name-bar">
    <span>From:</span> Uber</div>
<div class="device-ui-messages">

    
    	<div class="message left ">
            Your Uber is arriving now. Your driver will wait 2 min before leaving. Enjoy the ride!        </div>
...
<div class="device-ui-input-bar clearfix">
    ...
    <div class="device-ui-input-bar-field">Type a message</div>
                        ...
                        <div class="hidden-xs hidden-sm" style="position: absolute;top: 0;left: 330px;background: #fff;width: 120px;height: 120px;border-radius: 50%;box-shadow: 0px 6px 25px 0px #d9e5f1;">
                            <svg viewbox="0 0 292 61" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="width: 75%;" class="center-center">
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="Group" fill="#344f71">
                        ...
                        <img class="hidden-xs hidden-sm" "="" style="position: absolute;top: 45px;width: 230px;left: 200px;transform: rotate(-22deg);z-index: -1;" src="https://cdn-gc.messagebird.com/assets/images/ryan/wiggly-sms-1.svg">
                    </div>
            ...
            <div class="device-screen">
                ...
                <div class="device-ui">
                    <div class="device-ui-status-bar">
                        ...
                        <div class="device-ui-name-bar">
    <span>From:</span> +16501234567</div>
<div class="device-ui-messages">

    
    	<div class="message left ">
            Hi there! Your food is ready and on its way. Enjoy 🍽        </div>

    
    	<div class="message right ">
            We are on the second floor. Thanks        </div>
...
<div class="device-ui-input-bar clearfix">
    ...
    <div class="device-ui-input-bar-field">Type a message</div>
                        ...
                        <div class="hidden-xs hidden-sm" style="position: absolute;top: 400px;left: -200px;background: #fff;width: 120px;height: 120px;border-radius: 50%;box-shadow: 0px 6px 25px 0px #d9e5f1;padding: 37px 10px 0;">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 121.1 41" style="enable-background:new 0 0 121.1 41;" xml:space="preserve">

                            <path style="fill:#FF1940;" d="M37.6,1.3l1.2,1.2h9.4c8.5,0,9.4,0,9.8,0.1c1.7,0.4,3,1.3,3.9,2.7c0.4,0.6,0.7,1.2,0.9,1.9
                                C62.9,7.7,63,7.9,63,8.8s0,1.1-0.2,1.6c-0.3,1.1-0.8,2-1.6,2.8c-0.8,0.8-1.8,1.4-3,1.7L57.6,15h-3.1h-3.1l1.2,1.2l1.2,1.2h2
                                c2.2,0,2.5-0.1,3.6-0.4c3-1,5.2-3.5,5.9-6.6c0.2-0.7,0.2-2.7,0-3.4c-0.7-3.1-2.8-5.5-5.7-6.6c-0.3-0.1-0.8-0.2-1.1-0.3L57.9,0H47.1
                                H36.4L37.6,1.3z M42.7,6.3l1.2,1.2h8.2h8.3V7.4C60.3,7,60,6.6,59.6,6.2c-0.6-0.6-1-0.8-1.7-1C57.4,5,57.1,5,49.4,5h-8L42.7,6.3z
                                 M47.7,11.3l1.2,1.2h4.2c4.6,0,4.7,0,5.5-0.4c0.7-0.4,1.6-1.3,1.8-1.9v-0.1h-7h-7L47.7,11.3z M64.6,0.8c0.4,0.4,0.9,1,1.1,1.2
                                L66,2.5h1.7c1.6,0,1.8,0,2.3,0.2c1.1,0.3,2,0.8,2.8,1.5c0.6,0.5,1,1,1.3,1.7c1.1,2.1,0.9,4.4-0.4,6.4c-0.3,0.5-1.1,1.3-1.6,1.6
                                c-0.3-0.7,0-1.6,0.8-1.9c1-0.4,2.3-0.2,3,0.4l0.3,0.3l0.8-0.8c0.4-0.4,0.8-0.8,0.8-0.9s-0.5-0.5-0.9-0.7
                                C103.9,27.8,102.4,27.6,101.2,27.8z M110.9,28.1c0,0,0,2.9,0,6.2v6.2h1.1h1.1v-2.8V35h2.9h2.9v2.7v2.7h1.1h1.1v-6.1V28H120h-1.1v2.5
                                V33H116h-2.9v-2.5V28H112C111.2,28,110.9,28,110.9,28.1z"></path>
                            </svg>

                        </div>
                        <img class="hidden-xs hidden-sm" style="position: absolute;top: 300px;width: 230px;left: -175px;transform: rotate(185deg);z-index: -1;" src="https://cdn-gc.messagebird.com/assets/images/ryan/wiggly-sms-1.svg">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-8">
                    <div class="row flex">
                        <header class="col-md-12">
                            ...
                            <h2 class="page-section-heading">Make your communication smarter, better, faster</h2>
                        </header>
                        <div class="pane">
                            <h4 class="features-label">Customer Support</h4>
                            <p class="benefits-copy sp">Increase your accessibility and provide immediate support via two-way messaging.</p>
                            <a href="numbers.htm" class="page-section-link">Explore Numbers ⇢</a>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Security</h4>
                            <p class="benefits-copy sp">Protect your platform and customers by verifying accounts at crucial points with 2FA.</p>
                            <a href="verify.htm" class="page-section-link">Explore Verify ⇢</a>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Marketing Campaigns</h4>
                            <p class="benefits-copy sp">Reach your customers with targeted, localized campaigns and promotions.</p>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Notifications</h4>
                            <p class="benefits-copy sp">Share delivery updates, appointment reminders, transaction confirmations and more.</p>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Internal Operations</h4>
                            <p class="benefits-copy sp">Communicate internal information, receive updates, and keep in contact with employees.</p>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Alerts</h4>
                            <p class="benefits-copy sp">Power your urgent message delivery with the world’s fastest, most reliable SMS platform.</p>
                        </div>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Messaging, solved</h4>
            <h2 class="page-section-heading">Why use MessageBird SMS</h2>
        </header>
        <div class="row">
        ...
        <p class="lp">MessageBird supports SMS traffic at all volumes through reliable, streamlined global messaging routes. As a licensed carrier with over 900 direct or one-hop connections and 15,000 customers sending traffic all over the world daily, we have the infrastructure to power business communications at any scale.</p><h4 class="features-label">The Optimal Messaging Platform</h4><p class="lp">Our SMS API operates atop a fully redundant, highly secure telco stack which we’ve developed in-house. Thanks to our carrier license, our platform achieves higher and faster delivery rates than our non-carrier competitors, supports all country feature capabilities, hosts direct lines of communication with other operators, and enables better support.</p><h4 class="features-label">SmartRouting</h4><p class="lp">Along with our telco stack and APIs, we’ve also built a SmartRouting engine to ensure that each message being sent through our platform travels via the optimum route for speed and deliverability. Equipped with our ever-expanding routing profiles and carrier connections, our SmartRouting algorithms are the key to affordably scaling your SMS communications.</p><h4 class="features-label">Easy-to-use API</h4><p class="lp">Our REST API is built for usability and simple integration. Once you’ve read through our SMS documentation, you’ll have all the knowledge you need to implement messaging capabilities in your database and put our wide range of features to use. And, should any issues arise, our team is here to help every step of the way.</p>
            ...
            <div class="col-md-5">
                <div style="margin: 0 auto; max-width: 300px;">
                    <img class="support-img" src="https://cdn-gc.messagebird.com/assets/images/2017/support.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/support@2x.png 2x" width="300" style="margin-bottom: 30px;">
	...
	<a href="#" data-toggle="modal" data-target="#sms-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;sms&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Get SMS PDF ⇢</span>
...
<path style="fill:#ffffff;" d="M311.2,168.2c-10.5,22.2-30.6,29-30.6,29c-2.9,1.2-5.8,2.1-8.5,2.7c-0.3,0.1-0.6,0.1-0.9,0.2
	...
	c0,0.6,0.1,1.1,0.1,1.7c0,0.6,0,1.2,0,1.7C316.8,157.8,311.2,168.2,311.2,168.2z"></path>
                    ...
                    <div class="clearfix read-more-cta js-read-more-cta" style="width: 100%;">
                        <a href="contact-sales.htm" class="btn btn-cta" style="width: 100%;">Get in touch with Sales ⇢</a>
                    </div>
                </div>
            </div>
...
<section class="page-section no-border customers  compact" style="">
    ...
    <div class="quote">
        <p>&ldquo;With MessageBird we send real-time notifications to conference attendees from all over the world.&rdquo;</p>


        <div class="quote-con clearfix">
            <div class="left-part">
                <span>Wytze de Haan</span><br>
                Director of Events            </div>
            <div class="right-part">
                <img src="..\assets\images\cases\tnwnew.svg" width="90">            </div>
        </div>
    </div>
    ...
    <section class="clearfix logos" style="background: #f6fafd; margin-top: 120px; margin-bottom: 120px;">
    <div class="logo-div sq">
        <img src="..\assets\images\cases\amberalert.svg">
    </div>
    <div class="logo-div sq">
        <img src="..\assets\images\cases\foodora.svg">
    </div>
    <div class="logo-div">
        <img src="..\assets\images\cases\ubernew.svg">
    </div>

    <div class="logo-div">
        <img src="..\assets\images\cases\flixbus.svg">
    </div>
    <div class="logo-div">
        <img src="..\assets\images\cases\abnamro.svg">
    </div>
    <div class="logo-div">
        <img src="..\assets\images\cases\tnwnew.svg">
    </div>
    <div class="logo-div sq">
        <img src="..\assets\images\cases\fokker.svg">
    </div>
    <div class="logo-div wide">
        <img src="..\assets\images\cases\doordash.svg">
    </div>
    <div class="logo-div sq">
        <img src="..\assets\images\cases\adidas.svg">
    </div>
    <div class="logo-div">
        <img src="..\assets\images\cases\telegramnew.svg">
    </div>
    <div class="logo-div sq">
        <img src="..\assets\images\cases\snappcar.svg">
    </div>
    <div class="logo-div">
        <img src="..\assets\images\cases\lufthansa.svg">
    </div>
</section>
    ...
    <div class="container">
        <div class="row flex">
           <header class="col-md-12 text-center">
                ...
                <h2 class="page-section-heading">Tailor your messaging setup to suit your needs</h2>
            </header>

            
            	<div class="pane">
	                <h4 class="features-label">

                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-numbers.svg">
                    
                    Phone Numbers</h4>
	                <p class="benefits-copy sp">Support two-way messaging through localized points of contact around the world.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-rcs.svg">
                    
                    RCS</h4>
	                <p class="benefits-copy sp">Access the next generation of SMS, with rich media and file-sharing capabilities.</p>

	                	                	<a href="/en-nz/rcs" class="page-section-link">Explore RCS ⇢</a>
	                	            </div>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-lookup.svg">
                    
                    Number Lookup</h4>
	                <p class="benefits-copy sp">Gather detailed information on any number for a cleaner database and lower messaging costs.</p>

	                	                	<a href="lookup.htm" class="page-section-link">Explore Lookup ⇢</a>
	                	            </div>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-mms.svg">
                    
                    MMS</h4>
	                <p class="benefits-copy sp">Add image, audio, and video-sharing capacity to your customer conversations.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-sticky.svg">
                    
                    Sticky Sender</h4>
	                <p class="benefits-copy sp">Ensure that your customers always receive your messages from the same recognizable number.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-characters.svg">
                    
                    All Characters</h4>
	                <p class="benefits-copy sp">Take advantage of a platform that supports all character sets, including emoji. 👍</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-concatenation.svg">
                    
                    Auto Concatenation</h4>
	                <p class="benefits-copy sp">Avoid the standard 160-character maximum and deliver up to 9 multi-part messages as one SMS.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-rerouting.svg">
                    
                    Rerouting</h4>
	                <p class="benefits-copy sp">Guarantee timely message delivery regardless of potential route failures with our fast-acting rerouting infrastructure.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-queue.svg">
                    
                    Queueing</h4>
	                <p class="benefits-copy sp">We’ll ensure you stay compliant with country restrictions by halting your messaging output per country once your daily SMS quota is met.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-smpp.svg">
                    
                    SS7</h4>
	                <p class="benefits-copy sp">Send high-volume traffic with full low-level control via our SS7-compatible telco stack.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-twoway.svg">
                    
                    Two-way Messaging</h4>
	                <p class="benefits-copy sp">Allow your customers to reach out or respond through localized international numbers.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-sms-emailtosms.svg">
                    
                    Email to SMS</h4>
	                <p class="benefits-copy sp">Send and receive SMS messages directly within your email account, no extra software needed.</p>
...
<section class="page-section code-example  new">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<h3 class="page-section-heading">Easily integrate our REST API</h3>

				<p class="code-example-content lp">Seamlessly integrate our SMS solutions within your CRM software, website, or app. Read up on our developer documentation and connect your platform to over 900 operators worldwide.</p>
                    ...
                    <li>
                        <a href="https://developers.messagebird.com/docs/introduction" target="_blank">
                            <img src="https://cdn-gc.messagebird.com/assets/images/icons/libraries/ruby.svg">
									...
									<a class="page-section-link" href="https://developers.messagebird.com/docs/messaging" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;sms&quot;});">Visit the developer docs ⇢</a>
            ...
            <div class="col-md-6">
                <div class="tab-content text-right hidden-xs">
					                        <div class="code-example-languages-wrap">
    						<select class="code-example-languages" role="tablist">
    							    		                        <option role="presentation" href="#curl" aria-controls="curl" class=" active">
    		                            cURL    		                        
    		                        		                        <option role="presentation" href="#php" aria-controls="php" class="">
    		                            php    		                        
    		                        		                        <option role="presentation" href="#ruby" aria-controls="ruby" class="">
    		                            ruby    		                        
    		                        		                        <option role="presentation" href="#go" aria-controls="go" class="">
    		                            go    		                        
    		                        		                        <option role="presentation" href="#c♯" aria-controls="c♯" class="">
    		                            C♯    		                        
    		                        		                        <option role="presentation" href="#python" aria-controls="python" class="">
    		                            Python    		                        
    		                        						</select>
                        </div>
					                                            <div role="tabpanel" class="tab-pane text-left  active" id="curl">
							                            <pre class="line-numbers new"><code class="language-bash">$ curl -X POST https://rest.messagebird.com/messages \
-H 'Authorization: AccessKey test_gshuPaZoeEG6ovbc8M79w0QyM' \
-d "recipients=31612345678" \
-d "originator=YourName" \
-d "body=This is a test message"</code></pre>
                        </div>
                                            <div role="tabpanel" class="tab-pane text-left " id="php">
							                            <pre class="line-numbers new"><code class="language-php">$MessageBird = new \MessageBird\Client('ACCESS_KEY');
$Message = new \MessageBird\Objects\Message();
$Message->originator = 'MessageBird';
$Message->recipients = array(31612345678);
$Message->body = 'This is a test message.';
$MessageBird->messages->create($Message);</code></pre>
                        </div>
                                            <div role="tabpanel" class="tab-pane text-left " id="ruby">
							                            <pre class="line-numbers new"><code class="language-ruby">client = MessageBird::Client.new(YOUR_ACCESS_KEY)
client.message_create('FromMe', '31612345678', 'Hello World', :reference => 'Foobar')</code></pre>
                        </div>
                                            <div role="tabpanel" class="tab-pane text-left " id="go">
							                            <pre class="line-numbers new"><code class="language-go">params := &messagebird.MessageParams{Reference: "MyReference"}
...
message, err := client.NewMessage(
  ...
  params)</code></pre>
                                            ...
                                            <div role="tabpanel" class="tab-pane text-left " id="c♯">
							                            <pre class="line-numbers new"><code class="language-c♯">const string YourAccessKey = "YOUR_ACCESS_KEY";
Client client = Client.CreateDefault(YourAccessKey);
const long Msisdn = 31612345678;

MessageBird.Objects.Message message =
client.SendMessage("MessageBird", "Tjirp", new[] { Msisdn });</code></pre>
                        </div>
                                            <div role="tabpanel" class="tab-pane text-left " id="python">
							                            <pre class="line-numbers new"><code class="language-python">client = messagebird.Client(ACCESS_KEY)
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/sms-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/sms-pricing@2x.png 2x" height="75">
                    <h3 class="page-section-heading new">Competitive SMS pricing</h3>
                    <p class="lp">From streamlined routing profiles to volume discounts to free inbound SMS, our pricing is built on affordability.</p>
                </div>
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        <div class="js-currency currency number">
                            $
                        </div>
                        <div class="js-pricing-outbound-sms number">
                           -
                        </div>
                        <div class="sp description">Per outbound message to Philippines</div>
                    </div>
                    <div class="statistic">
                        <div class="js-pricing-inboud-sms number">
                            Free                        </div>
                        <div class="sp description">Inbound messages are free in Philippines</div>
                    </div>
                </div>

                <a href="sms\pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;sms&quot;});">Check out SMS pricing ⇢</a>
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing@2x.png 2x" height="75">

                                            <h3 class="page-section-heading new">Global two-way messaging</h3>
                    
                    <p class="lp">Our partnerships with carriers around the world allow us to offer affordable numbers in 50+ countries.</p>
                </div>
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        <div class="js-currency currency number">
                        ...
                        <div class="js-dedicated-vmn number">
                            -
                        </div>
                        <div class="sp description">Per PH Number per month</div>
                    </div>
                    <div class="statistic">
                        <div class="flags">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/us.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/nl.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/de.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/fr.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/uk.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/mx.png" width="18">

                            <br>

                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/cn.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/jp.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/ca.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/es.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/nz.png" width="18">
                            <img src="https://cdn-gc.messagebird.com/assets/images/flags/new/au.png" width="18">
                        </div>
                        <div class="sp description">Supporting 50+ countries</div>
                    </div>
                </div>

                                    <a class="page-section-link new" href="https://developers.messagebird.com/docs/messaging" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;sms&quot;});">Learn more about two-way messaging ⇢</a>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">SMS</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-nz/sms#contact-form">
                            <input type="hidden" name="_csrf" value="q9B7iaBT5WygvaKXYGgabzdISwEo0QYbvmFzdI2_akQmGo3UaPimhZdCmoCSv7ChCVmvVindzZBIvoATM1Lzgw==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
