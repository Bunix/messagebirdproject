...
<html lang="nl">
    <head>
        ...
        <title>Numbers & Shortcodes - MessageBird</title>
        <meta name="description" content="Schakel tweerichtingscommunicatie in en stuur berichten van jouw Number via onze website of je eigen software.">
    ...
    <meta name="csrf-token" content="NuNcXQ4elr0KS5BCRM1adLRIwfyv0dKFc8Ux6pW6ur67KaoAxrXVVD20qFW2GvC6ilklq67dGQ6FGsKNK1cjeQ==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Schakel tweerichtingscommunicatie in en stuur berichten van jouw Number via onze website of je eigen software.">
        <meta property="og:url" content="https://www.messagebird.com/nl/shortcode">
        ...
        <meta name="twitter:description" content="Schakel tweerichtingscommunicatie in en stuur berichten van jouw Number via onze website of je eigen software.">
        

        <script type="text/javascript">window.page = 'numbers';</script>
                                ...
                                <div class="floater flex-end">
            	                    ...
            	                    <ul>
                                        <li><span class="active">Gerelateerd</span></li>
            	                    	            	                    		...
            	                    	            	                    		<li>
            	                    			<a href="tarieven.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;numbers&quot;});">
            	                    				Numberstarieven            	         						</a>
            	                    		</li>
            	                    	            	                    		<li>
            	                    			<a href="sms.htm">
...
<div class="numbers new">
    ...
    <section class="hero page-section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="mb-page-title">Nummers</h1>
                    <div class="xlp">
                        Bouw je klantcommunicatie rondom programmeerbare en configureerbare nummers die SMS, MMS en Voice-enabled zijn.                    </div>
                    ...
                    <div class="page-section-btn-container">
                        ...
                        <form id="index-signup" class="start" novalidate="true" action="https://dashboard.messagebird.com/app/nl/sign-up/" method="GET">
                            ...
                            <div class="hero-sub-cta sp" style="margin-top: 15px;">Liever een persoonlijke offerte?  <a href="contact-sales.htm" class="page-section-link">Neem contact op ⇢</a></div>
                        </form>
                    </div>
                </div>
                <div class="col-md-6 hidden-xs hidden-sm">

                    <div style="transform: rotate(-11deg) translate(-20px, 60px);">

                        <div class="js-device-sms" style="position: absolute; transform: translate(60px, 0) scale(0.9);">
                        <div class="device-container hidden-xs hidden-sm" style="float: none;">
    <div class="device-mockup">

        <div class="device" style="transform: rotate(0);">
            <div class="device-screen">

                <div class="device-ui">
                    <div class="device-ui-status-bar">
                        12:52                        <i class="fa fa-signal" aria-hidden="true" style="right: 20px;"></i>
                        <i class="fa fa-battery-half pull-right"></i>
                    </div>

                    
                        <div class="device-ui-name-bar">
    <span>From:</span> 415-555-0100</div>
<div class="device-ui-messages">

    
    	<div class="message left ">
            Welkom in San Francisco! Ons hotel verheugt zich op uw komst. U kunt vanaf 15.00 inchecken.        </div>

    
    	<div class="message right ">
            Tot hoe laat is de receptie open?        </div>

    
    	<div class="message left ">
            Er is altijd iemand aanwezig, 24 uur per dag. Check-in wanneer het u uitkomt.        </div>

    
    	<div class="message right ">
            Geweldig! Bedankt.        </div>
...
<div class="device-ui-input-bar clearfix">
    ...
    <div class="device-ui-input-bar-field">Type a message</div>
                        ...
                        <img src="..\assets\images\2017\map.png" style="position: absolute; transform: translate(353px, -12px);">
                        <?xml version="1.0" encoding="utf-8"?>
<!-- Generator: Adobe Illustrator 19.2.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<svg version="1.1" id="cloudsvg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 97.7 65.1" style="enable-background:new 0 0 97.7 65.1;" xml:space="preserve">
<style type="text/css">
	.st0{fill:none;stroke:#48578C;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
	.st1{fill:none;stroke:#48578C;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
	...
	.st5{fill:#2481D7;}
	.st6{fill:#FFFFFF;stroke:#2481D7;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
	.st7{fill:#FFFFFF;}
	.st8{fill:#FFFFFF;stroke:#E5F0FA;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
	.st9{fill:none;stroke:#FFFFFF;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
	.st10{fill:none;}
</style>
<path class="st8" d="M97.2,44.8c0,10.8-8.6,19.6-19.3,19.9H15.9c-8.5,0-15.4-6.9-15.4-15.4c0-8.5,6.9-15.4,15.4-15.4
	c0-18.4,14.9-33.3,33.3-33.3c15.4,0,28.5,10.5,32.2,24.8C90.4,27.2,97.2,35.2,97.2,44.8z"></path>
</svg>
                        <img width="35" src="..\assets\images\glyph.svg" style="position: absolute; transform: translate(431px, 271px); z-index: 4">
                        <span class="hero-phonenumber">+52 55 137 235</span>



                        <img width="20" src="..\assets\images\2017\icon-fold-call.svg" style="position: absolute; transform: translate(565px, 234px); z-index: 2;">
                        <img class="js-line-call" src="..\assets\images\2017\line-call.svg" style="position: absolute; transform: rotate(10deg) translate(467px, 172px); z-index: 2;">

                        <img width="20" src="..\assets\images\2017\icon-fold-sms.svg" style="position: absolute; transform: translate(491px, 189px); z-index: 2;">
                        <img class="js-line-sms" src="..\assets\images\2017\line-sms.svg" style="position: absolute; transform: rotate(10deg) translate(277px, 147px); z-index: 2;">

                        <div class="js-device-call" style="position: absolute; transform: translate(197px, 532px) scale(0.9);">
    ...
    <section class="page-section use-cases">
        ...
        <div class="container">
            <div class="row">
               <header class="pane col-md-12">
                    <h4 class="page-section-tag">Use cases</h4>
                    <h2 class="page-section-heading">Optimaliseer je communicatie</h2>
                </header>
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="pane col-md-6">
                            ...
                            <p class="benefits-copy sp">Wees makkelijk bereikbaar met multichannel-nummers die je klanten directe, uitgebreide support bieden.</p>
                        </div>

                        <div class="pane col-md-6">
                            <h4 class="features-label">Lokaliseer</h4>
                            <p class="benefits-copy sp">Integreer je merk in lokale ecosystemen en ontwijk internationale SMS-kosten door lokale nummers te gebruiken voor je communicatie.</p>
                        </div>

                        <div class="pane col-md-6">
                            <h4 class="features-label">Feedback</h4>
                            <p class="benefits-copy sp">Krijg beter inzicht door feedbackverzoeken te automatiseren. Stuur bijvoorbeeld een bericht na voltooiing van een transactie.</p>
                        </div>

                        <div class="pane col-md-6">
                            <h4 class="features-label">Numberbescherming</h4>
                            <p class="benefits-copy sp">Bescherm de privacy van je klanten en medewerkers. Verbind hen zonder persoonlijke gegevens en identiteiten uit te wisselen.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Bereikbaarheid, opgelost</h4>
            <h2 class="page-section-heading">Waarom MessageBird Numbers Gebruiken?</h2>
        </header>
        <div class="row">
        ...
        <p class="lp">Onze selectie van types telefoonnummers helpt je om je telefonische klantinteracties te optimaliseren. Of je nu je merk per regio of land wilt lokaliseren, je doorvoer in een land wilt maximaliseren, je inkomende gesprekken en berichten wilt centraliseren of gewoonweg in gesprek wilt kunnen gaan via berichten: MessageBird heeft het type telefoonnummer dat je nodig hebt.</p><h4 class="features-label">Branded interacties</h4><p class="lp">Je toegankelijkheid vergroten kan een belangrijke impact hebben op customer experience. Als je bijvoorbeeld de contactpunten per regio lokaliseert, hoeven klanten geen internationale telefoonkosten te betalen en wordt het merkvertrouwen vergroot. Klanten kunnen makkelijker bij je terecht als je nummers gebruikt die zowel gesprekken als SMS-berichten kunnen verwerken. Stel simpelweg de afzender in en je merkbekendheid zal een boost krijgen.</p><h4 class="features-label">Maximale Doorvoer</h4><p class="lp">Elk land heeft zijn eigen wet- en regelgeving over A2P-communicatie. Gelukkig zijn al onze nummers goedgekeurd, waardoor jij in elk land in ons netwerk bereik hebt. We hebben ook wachtrij-protocollen zodat jouw bedrijf niet in de problemen komt met de regelgeving. Met de API van MessageBird Numbers verlopen je telefoon- en SMS-gesprekken zo goed en efficiënt mogelijk.</p>
...
<div class="document-download">
	<a href="#" data-toggle="modal" data-target="#numbers-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;nummers&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Ontvang Nummers PDF ⇢</span>
...
<path style="fill:#ffffff;" d="M311.2,168.2c-10.5,22.2-30.6,29-30.6,29c-2.9,1.2-5.8,2.1-8.5,2.7c-0.3,0.1-0.6,0.1-0.9,0.2
    ...
    <section class="clearfix logos" style="background: #f6fafd; margin-top: 120px; margin-bottom: 150px;">
        <div class="logo-div sq">
            <img src="..\assets\images\cases\germania.svg">
        </div>
        <div class="logo-div">
            <img src="..\assets\images\cases\ubernew.svg">
        </div>
        <div class="logo-div">
            <img src="..\assets\images\cases\rio_tinto.svg">
        </div>
        <div class="logo-div">
            <img src="..\assets\images\cases\huawei.svg">
        </div>
        <div class="logo-div sq">
            <img src="..\assets\images\cases\dominosnew.svg">
        </div>
        <div class="logo-div">
            <img src="..\assets\images\cases\travelbird.svg">
        </div>
    </section>

    <section class="page-section types">

        <div class="container">
            <div class="row">
                <header class="text-center">
                    <h4 class="page-section-tag">Numbertypes</h4>
                    <h2 class="page-section-heading">Voor elk doel een contactpunt</h2>
                </header>

                <div class="container">
                    <div class="row">
                        <div class="pane col-md-4">
                            <h3 class="page-section-heading">Lokale Numbers</h3>
                            <p class="lp">Lokaliseer je merk per regio met onze ruime keuze in land- en netnummers.</p>
                            <a href="tarieven.htm" class="page-section-link" style="">Bekijk onze Numbers tarieven ⇢ ⇢</a>
                        </div>
                        <div class="col-md-8">
                            <div class="row flex">
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-chat-integrations.svg" height="25"> Integreer</h4>
                                    <p class="sp">Implementeer eenvoudig nummers in jouw software, e-mailaccount en dashboard.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-numbers-freeinbound.svg" height="25"> Gratis Inkomende SMS</h4>
                                    <p class="sp">We bieden ongelimiteerd gratis inkomende berichten aan op al onze lokale nummers.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-numbers-quality.svg" height="25"> Geverifieerde Kwaliteit</h4>
                                    <p class="sp">Alle nummers worden uitvoerig gescreend en getest voordat wij ze voor gebruik aanbieden.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-chat-omni.svg" height="25"> Automatiseer</h4>
                                    <p class="sp">Koppel inkomende berichten aan acties via onze API of gebruik “if-this-then-that” functies.</p>
                                </div>
                            </div>
                        </div>
                     </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="pane col-md-4">
                            <h3 class="page-section-heading">Shortcodes</h3>
                            <p class="lp">Maak klantcontact makkelijker met toegewezen of gedeelde shortcodes.</p>
                            <a href="tarieven.htm" class="page-section-link" style="">Bekijk onze Shortcode tarieven ⇢ ⇢</a>
                        </div>
                        <div class="col-md-8">
                            <div class="row flex">
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-numbers-dedicated.svg" height="25"> Dedicated</h4>
                                    <p class="sp">Voor merkinteracties en campagnes met een hoge doorvoer bieden we toegewezen shortcodes.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-numbers-keyword.svg" height="25"> Keywords & Sub-keywords</h4>
                                    <p class="sp">Gebruik aanpasbare keywords en sub-keywords om je shortcodes te automatiseren en organiseren.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-number-shared.svg" height="25"> Shared</h4>
                                    <p class="sp">Wij bieden in bepaalde landen vooraf goedgekeurde shortcodes. Zo versnellen we het goedkeuringsproces en leveren we je campagnes zo snel mogelijk af.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-number-throughput.svg" height="25"> Hoge Doorvoer</h4>
                                    <p class="sp">In sommige landen is de doorvoer van long-codes gelimiteerd. Met short-codes gebruik je het maximaal toegestane dagelijkse quotum.</p>
                                </div>
                            </div>
                        </div>
                    </div>
     ...
     <section class="page-section local">

        <div class="container">
            <div class="row">
               <header class="text-center">
                    <h4 class="page-section-tag">Lokale Numbers</h4>
                    <h2 class="page-section-heading">Meer dan 50 landen en 700 netnummers</h2>
                </header>

                <div class="col-md-12">
                    <div class="row numbers-countries">

                                                    <div class="country col-xs-6 col-sm-4 col-md-3">


                                <span data-country-code="14" data-country="Australië" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/au.png" width="20"></span>
                                ...
                                <span data-country-code="13" data-country="Oostenrijk" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/at.png" width="20"></span>
                                ...
                                <span data-country-code="20" data-country="België" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/be.png" width="20"></span>
                                ...
                                <span data-country-code="36" data-country="Canada" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/ca.png" width="20"></span>
                                ...
                                <span data-country-code="47" data-country="Colombia" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/co.png" width="20"></span>
                                ...
                                <span data-country-code="95" data-country="Kroatië" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/hr.png" width="20"></span>
                                ...
                                <span data-country-code="54" data-country="Tsjechië" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/cz.png" width="20"></span>
                                ...
                                <span data-country-code="57" data-country="Denemarken" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/dk.png" width="20"></span>
                                ...
                                <span data-country-code="62" data-country="Estland" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/ee.png" width="20"></span>
                                ...
                                <span data-country-code="68" data-country="Finland" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/fi.png" width="20"></span>
                                ...
                                <span data-country-code="73" data-country="Frankrijk" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/fr.png" width="20"></span>
                                ...
                                <span data-country-code="55" data-country="Duitsland" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/de.png" width="20"></span>
                                ...
                                <span data-country-code="92" data-country="Hong Kong" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/hk.png" width="20"></span>
                                ...
                                <span data-country-code="97" data-country="Hongarije" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/hu.png" width="20"></span>
                                ...
                                <span data-country-code="98" data-country="Indonesië" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/id.png" width="20"></span>
                                ...
                                <span data-country-code="99" data-country="Ierland" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/ie.png" width="20"></span>
                                ...
                                <span data-country-code="106" data-country="Italië" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/it.png" width="20"></span>
                                ...
                                <span data-country-code="130" data-country="Letland" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/lv.png" width="20"></span>
                                ...
                                <span data-country-code="128" data-country="Litouwen" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/lt.png" width="20"></span>
                                ...
                                <span data-country-code="151" data-country="Maleisië" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/my.png" width="20"></span>
                                ...
                                <span data-country-code="150" data-country="Mexico" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/mx.png" width="20"></span>
                                ...
                                <span data-country-code="159" data-country="Nederland" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/nl.png" width="20"></span>
                                ...
                                <span data-country-code="160" data-country="Noorwegen" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/no.png" width="20"></span>
                                ...
                                <span data-country-code="172" data-country="Polen" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/pl.png" width="20"></span>
                                ...
                                <span data-country-code="177" data-country="Portugal" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/pt.png" width="20"></span>
                                ...
                                <span data-country-code="182" data-country="Roemenië" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/ro.png" width="20"></span>
                                ...
                                <span data-country-code="194" data-country="Slowakije" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/sk.png" width="20"></span>
                                ...
                                <span data-country-code="237" data-country="Zuid-Afrika" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/za.png" width="20"></span>
                                ...
                                <span data-country-code="117" data-country="Korea" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/kr.png" width="20"></span>
                                ...
                                <span data-country-code="66" data-country="Spanje" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/es.png" width="20"></span>
                                ...
                                <span data-country-code="189" data-country="Zweden" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/se.png" width="20"></span>
                                ...
                                <span data-country-code="41" data-country="Zwitserland" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/ch.png" width="20"></span>
                                ...
                                <span data-country-code="218" data-country="Taiwan, provincie van China" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/tw.png" width="20"></span>
                                    <span class="country-name">Taiwan, provincie van China</span>
                                </span>
                            </div>
                                                    <div class="country col-xs-6 col-sm-4 col-md-3">


                                <span data-country-code="215" data-country="Turkije" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/tr.png" width="20"></span>
                                ...
                                <span data-country-code="75" data-country="Groot-Brittannië" class="js-vmn-pricing-change clearfix active">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/uk.png" width="20"></span>
                                    <span class="country-name">Groot-Brittannië</span>
                                </span>
                            </div>
                                                    <div class="country col-xs-6 col-sm-4 col-md-3">


                                <span data-country-code="223" data-country="Verenigde Staten" class="js-vmn-pricing-change clearfix ">
                                    <span class="flag"><img src="https://cdn-gc.messagebird.com/assets/images/flags/new/us.png" width="20"></span>
                    ...
                    <div class="row contact-sales-wrap">
                        <div class="text-center">
                            <a href="contact-sales.htm" class="page-section-link">Staat jouw land hier niet tussen? Neem contact op met sales ⇢ ⇢</a>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/sms-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/sms-pricing@2x.png 2x" width="80">
                    <h3 class="page-section-heading new">Wereldwijd berichten uitwisselen</h3>
                ...
                <div class="statistics clearfix">
                    ...
                    <div class="statistic">
                        <div class="js-pricing-inboud-sms number">
                            Gratis                        </div>
                        <div class="sp description">Inkomende berichten zijn gratis in Philippines</div>
                    </div>
                </div>

                <a href="sms\pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;numbers&quot;});">Bekijk onze tarieven voor SMS ⇢</a>
            ...
            <div class="col-sm-6">
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/voice-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/voice-pricing@2x.png 2x" width="80">
                ...
                <a class="page-section-link new" style="margin-top: 5px;" href="voice.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;numbers&quot;});">Meer over Voice ⇢</a>
            </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Meer weten over <span style="font-weight: 900;">Numbers</span>?<br> Neem contact op met ons salesteam.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/nl/shortcode#contact-form">
                            <input type="hidden" name="_csrf" value="NuNcXQ4elr0KS5BCRM1adLRIwfyv0dKFc8Ux6pW6ur67KaoAxrXVVD20qFW2GvC6ilklq67dGQ6FGsKNK1cjeQ==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
