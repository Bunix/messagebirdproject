...
<html lang="nl">
    <head>
        ...
        <meta name="description" content="Bescherm jezelf tegen ongeautoriseerde toegang met Verify. Probeer het gratis en voeg een extra laag beveiliging toe aan iedere inlog.">
    ...
    <meta name="csrf-token" content="pOTXfEbtwZif6aEClm3XCCbOAdn7OonEsnipLfc7_JopLiEhjkaCcagWmRVkun3GGN_ljvo2Qk9Ep1pKSdZlXQ==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Bescherm jezelf tegen ongeautoriseerde toegang met Verify. Probeer het gratis en voeg een extra laag beveiliging toe aan iedere inlog.">
        <meta property="og:url" content="https://www.messagebird.com/nl/verify">
        ...
        <meta name="twitter:description" content="Bescherm jezelf tegen ongeautoriseerde toegang met Verify. Probeer het gratis en voeg een extra laag beveiliging toe aan iedere inlog.">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="xlp">Beveilig klantdata, belangrijke transacties en blokkeer frauduleuze accounts. Implementeer Two-factor authentication (2FA) en One-time password (OTP) oplossingen. </div>
                                ...
                                <div class="device-screen">
                                    ...
                                    <div class="device-ui">
                                        ...
                                        <div class="slide-down js-slideDown-msg text-left">
                                            <span class="originator">Moneybank</span> <span class="time">10 sec geleden</span>
                                            <p class="password">Je verificatiecode is: 713905</p>
                                        ...
                                        <div class="js-card card">
                                            ...
                                            <div class="js-content content">
                                                <div class="content-copy">
                                                    ...
                                                    <p>Voer de verificatiecode in om door te gaan.</p>
                                                </div>
                                                <div class="numbers">
    ...
    <div class="container">
        <div class="row">
           <header class="text-center">
                ...
                <h2 class="page-section-heading">Beveilig jouw platform</h2>
            </header>

            <div class="pane col-md-4">
                <h4 class="features-label">Nummerverificatie</h4>
                <p class="sp">Houdt je platform vrij van bots, spammers en bulkregistraties. Verifieer nieuwe gebruikers via een verplichte koppeling met hun telefoonnummer.</p>
            </div>

            <div class="pane col-md-4">
                <h4 class="features-label">Beveilig Accounts</h4>
                <p class="sp">Bescherm klanten tegen hackers en datadiefstal. Beveilig accounts door het implementeren van OTP's via SMS of Voice op cruciale punten van het inlogproces. </p>
            </div>

            <div class="pane col-md-4">
                <h4 class="features-label">Beveilig Transacties</h4>
                <p class="sp">Maak de interacties met je klant nog veiliger. Implementeer een OTP trigger om accounts te verifiëren voordat ze toegang krijgen tot gevoelige transacties.</p>
            </div>
        </div>
    </div>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Verificatie, opgelost</h4>
            <h2 class="page-section-heading">Waarom MessageBird Verify Gebruiken?</h2>
        </header>
        <div class="row">
            ...
            <p class="lp">Afgelopen jaar gaf 85% van de bedrijven aan dat ze met phishing te maken hebben gehad. Organisaties die op cloud-services werken zijn het gevoeligst, ook omdat 75% van de accounts met generieke wachtwoorden zijn beveiligd. Alleen al hierom moeten bedrijven zelf steeds beter hun best doen om gevoelige informatie uit de handen van hackers en scammers te houden. </p><h4 class="features-label">Betrouwbare beveiliging</h4><p class="lp">In een tijd waarin zoveel afhangt van goede online veiligheid, is het cruciaal om antwoord te vinden op de vraag: wat is de beste manier om je account te beveiligen? Volgens experts in databeveiliging zou 80% van de online inbraken kunnen worden voorkomen door two-factor authentication te implementeren in het inlogprocess. 2FA biedt een extra laag beveiliging die veel sterker is dan alleen een wachtwoord omdat er een apart apparaat voor nodig is, meestal een telefoon of tablet.</p><h4 class="features-label">Turn-key Verificaties</h4><p class="lp">MessageBird Verify geeft bedrijven een turn-key verificatiemogelijkheid, die in één sprint kan worden ingeschakeld. MessageBird  Verify is net zo eenvoudig als het klinkt, zowel in implementatie als in het gebruik. Stuur een telefoonnummer ter verificatie naar ons, of pas Verify  naar jouw specifieke omgeving en wensen aan. MessageBird gebruikt altijd de beste state-of-the-art SSL- en tokenization-technologie om een identiteiten vast te stellen en informatie te beveiligen.</p><p class="lp">Terwijl sommige van onze concurrenten nog steeds toeslagen voor verficatieservices rekenen, betaal je bij MessageBird alleen voor de SMS- of Voiceberichten die daadwerkelijk als verificatie worden verstuurd. Dus geen verborgen extra kosten of toeslagen.</p>
	...
	<a href="#" data-toggle="modal" data-target="#verify-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;verify&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Ontvang Verify PDF ⇢</span>
			...
			<div class="modal-body lp">
				...
				<div class="row">
					<div class="col-md-7">
						...
						<h1 class="mb-page-title">Bekijk het Verify Overzicht</h1>
<p class="lp">Ontdek wat Verify van MessageBird voor jouw bedrijf kan betekenen. Vul je email in en we sturen direct een PDF naar je toe.</p>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="/nl/pricing#pdf">Tarieven</a>, <a href="sms.htm#pdf">SMS</a>, <a href="voice.htm#pdf">Voice</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="/nl/numbers#pdf">Nummers</a>, <a href="/nl/numbers#pdf">Shortcode</a> and <a href="/nl/chat#pdf">Chat</a>.</p>
    ...
    <div class="container">
        <div class="row flex">
           <header class="col-md-12 text-center">
                ...
                <h2 class="page-section-heading">Een custom verificatieproces</h2>
            </header>
            	...
            	<div class="pane">
                    ...
                    Flash- of SMS-Berichten</h4>
	                <p class="benefits-copy sp">Kies tussen normale SMS-berichten of tijdelijke flashberichten die alleen op het scherm verschijnen, zonder een gesprek te starten.</p>
            	...
            	<div class="pane">
                    ...
                    Voiceberichten</h4>
	                <p class="benefits-copy sp">Stuur OTP's via Voice in een van de 20 beschikbare talen. Klanten worden gebeld en horen bij het opnemen hun verificatiecode.</p>
            	...
            	<div class="pane">
                    ...
                    OTP-Integraties</h4>
	                <p class="benefits-copy sp">Integreer Verify snel en makkelijk met alle bekende OTP-services: SecurEnvoy, Dell EMC, en SafeNet.</p>
            	...
            	<div class="pane">
                    ...
                    Betaal per bericht</h4>
	                <p class="benefits-copy sp">Gebruik onze Verify-software zonder verborgen kosten. Je betaalt alleen voor de SMS- en Voiceberichten die je verstuurt.</p>
            	...
            	<div class="pane">
                    ...
                    Aanpasbare Meldingen</h4>
	                <p class="benefits-copy sp">Pas meldingen aan aan wat past voor jouw merk. Het verificatiebericht verschijnt op het scherm in de toon en vorm die je wilt.</p>
            	...
            	<div class="pane">
                    ...
                    Verificatieopties</h4>
	                <p class="benefits-copy sp">Stel de lengte van de verificatiecodes in tussen 6 en 10 karakters en bepaal de geldigheidsduur van de codes.</p>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p class="code-example-content lp">Integreer onze 2FA SMS and Voice-oplossingen naadloos in jouw CRM-software, website of app. Lees meer in onze developer documentatie en stuur jouw OTP's via ons netwerk van meer dan 900 wereldwijde providers.</p>
                    ...
                    <li>
                        <a href="https://developers.messagebird.com/docs/introduction" target="_blank">
                            <img src="https://cdn-gc.messagebird.com/assets/images/icons/libraries/ruby.svg">
									...
									<a class="page-section-link" href="https://developers.messagebird.com/docs/verify" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;verify&quot;});">Bekijk de developer docs ⇢</a>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="article">
                    ...
                    <h3 class="page-section-heading new">SMS en TTS Prijzen</h3>
                    <p class="lp">Van gestroomlijnde routingprofielen, tot volumekorting en gratis inkomende SMS-berichten: onze tarieven blijven betaalbaar.</p>
                </div>
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        <div class="number">1 credit</div>
                        <div class="sp description">Per gestuurde SMS naar Philippines</div>
                    </div>
                    <div class="statistic">
                        <div class="number">1.3 credits</div>
                        <div class="sp description">Per gestuurd Voice-bericht naar Philippines</div>
                    </div>
                </div>

                <a href="sms\pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;verify&quot;});">Bekijk onze tarieven voor SMS ⇢</a>
            </div>
            <div class="col-md-6">
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing@2x.png 2x" height="75">
                        ...
                        <h3 class="page-section-heading new">Stuur vanaf een lokaal nummer</h3>
                ...
                <a class="page-section-link new" href="nummers.htm">Meer over lokale nummers ⇢</a>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Meer weten over <span style="font-weight: 900;">Verify</span>?<br> Neem contact op met ons salesteam.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/nl/verify#contact-form">
                            <input type="hidden" name="_csrf" value="pOTXfEbtwZif6aEClm3XCCbOAdn7OonEsnipLfc7_JopLiEhjkaCcagWmRVkun3GGN_ljvo2Qk9Ep1pKSdZlXQ==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
