...
<html lang="nl">
    <head>
        ...
        <meta name="description" content="Begin waardevolle conversaties met je klanten op hun favoriete chat platform met onze omni-channel API.">
    ...
    <meta name="csrf-token" content="wvUHm0gO_4S2opIa5Hnb9oqqZyMmJ-z76swDNV-Mk9xPP_HGgKW8bYFdqg0WrnE4tLuDdCcrJ3AcE_BS4WEKGw==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Begin waardevolle conversaties met je klanten op hun favoriete chat platform met onze omni-channel API.">
        <meta property="og:url" content="https://www.messagebird.com/nl/chat-api">
        ...
        <meta name="twitter:description" content="Begin waardevolle conversaties met je klanten op hun favoriete chat platform met onze omni-channel API.">
                                ...
                                <div class="floater flex-end">
            	                    ...
            	                    <ul>
                                        <li><span class="active">Gerelateerd</span></li>
            	                    	            	                    		...
            	                    	            	                    		<li>
            	                    			<a href="chat\pricing.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;chat&quot;});">
            	                    				Chattarieven            	         						</a>
            	                    		</li>
            	                    	            	                    		<li>
            	                    			<a href="sms.htm">
            	                    				SMS            	         						</a>
            	                    	            	                    		...
            	                    	            	                    		<li>
            	                    			<a target="_blank" href="https://developers.messagebird.com" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;chat&quot;});">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="lp">
                        Bereik je klanten op bekende chat platformen met onze omnichannel API.                    </div>
                    ...
                    <div class="lp">
                        Leer je klanten beter kennen en ga waardevolle gesprekken met ze aan door ze van support en informatie te voorzien.                    </div>
                    ...
                    <div class="page-section-btn-container">
                        ...
                        <form id="index-signup" class="start" novalidate="true" action="https://dashboard.messagebird.com/app/nl/sign-up/" method="GET">
                            ...
                            <div class="hero-sub-cta sp">Liever een persoonlijke offerte?  <a href="contact-sales.htm" class="page-section-link" style="margin-left: 5px;">Neem contact op ⇢</a></div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="grid-list">
                        <ul>
                            ...
                            <li style="margin-left: -45px;">
                                <div class="device-ui-messages">
                                    <div class="message left">Zou je het geluid dat je toestel maakt kunnen beschrijven?</div>
                            ...
                            <li style="opacity: .5;">
                                <div class="device-ui-messages">
                                    <div class="message right">Top, bedankt! 👍</div>
                                </div>
                            </li>
                            <li>
                                <div class="device-ui-messages">
                                    <div class="message map left"></div>
                                    <div class="message right">Begrepen! Je chauffeur is er binnen 8 minuten.</div>
                                </div>
                            </li>
                            <li>
                                <div class="device-ui-messages">
                                    <div class="message right">Welk eten zal ik bestellen?</div>
                                    <div class="message image left"></div>
                                </div>
                            </li>
                            <li>
                                <div class="device-ui-messages">
                                    <div class="message left">Morgen is Moederdag! Verras haar met een prachtig boeket. Onze favoriet: roze pioenrozen - €40.00 <a>flowe.rs/buy</a></div>
                                </div>
                            </li>
                            <li style="margin-left: 80px;">
                                <div class="device-ui-messages">
                                    <div class="message left">Bedankt! Hoe bevalt het nieuwe design van de app?</div>
                                    <div class="message right">Natuurlijk! Door minder pop-ups kan ik makkelijker op buttons te klikken 🙌</div>
                                </div>
                            </li>
                            <li>
                                <div class="device-ui-messages">
                                    ...
                                    <div class="message left">Bedankt voor je feedback! 👍</div>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="row">
               <header class="text-center">
                    ...
                    <h2 class="page-section-heading">Groei, automatiseer en schaal met Chat</h2>
                </header>
                ...
                <div class="col-md-8">
                    <div class="row flex">
                        ...
                        <div class="pane">
                            ...
                            <p class="benefits-copy sp">Ga uitgebreid in gesprek met je klanten en los complexe problemen op via hun favoriete medium.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Feedback</h4>
                            <p class="benefits-copy sp">Krijg inzicht in voorkeuren, gedrag en meningen van je klanten door gedetailleerde feedback te vragen.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Notificaties</h4>
                            <p class="benefits-copy sp">Betrek je klanten door rich updates, waarschuwingen en herinneringen te delen.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Marketingcampagnes</h4>
                            <p class="benefits-copy sp">Maak je marketing zo engagerend mogelijk met afbeeldingen, video, audio en buttons. </p>
                        </div>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Multichannel chat, opgelost</h4>
            <h2 class="page-section-heading">Waarom MessageBird Chat Gebruiken?</h2>
        </header>
        <div class="row">
        ...
        <p class="lp">Je klanten leren kennen is de sleutel tot het creëren van een ervaring die mensen enthousiast maakt en ervoor zorgt dat ze betrokken blijven. Toch blijkt het vinden van het beste kanaal om lang met je klanten in gesprek te gaan lastig. Tot nu toe dan. De MessageBird Chat API maakt het mogelijk om je klanten te bereiken op de chat-platforms die ze al met plezier gebruiken en voegt ongekende waarde toe aan het contact met je klant.</p><h4 class="features-label">Rich-Media Ondersteuning</h4><p class="lp">Voeg een hele nieuwe dimensie toe aan je zakelijke communicatie door het gebruiken van video, audio, afbeeldingen en zelfs locaties te delen. Of je nu een nieuwe feature lanceert, of de klantenservice verbetert met foto en video: rich media biedt de uitgelezen kans om de customer experience te verbeteren.</p><h4 class="features-label">Omni-channel API</h4><p class="lp">We hebben het implementeren van Chat in je communicatie-infrastructuur zo makkelijk mogelijk gemaakt. Om je kostbare tijd en stapels werk te besparen, hebben we een omni-channel API ontwikkeld waarmee je tegelijkertijd alle communicatie kanalen kan gebruiken. Na een snelle en pijnloze installatie van nieuwe kanalen kun je onmiddellijk berichten sturen en ontvangen, zonder van interface te hoeven wisselen.</p>
	...
	<a href="#" data-toggle="modal" data-target="#chat-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;chat&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Ontvang Chat PDF ⇢</span>
            ...
            <div class="device-screen">
                ...
                <div class="device-ui">
                    <div class="device-ui-status-bar">
                        12:32                        <i class="fa fa-signal" aria-hidden="true" style="right: 20px;"></i>
...
<div class="device-ui-messages">
    	...
    	<div class="message left ">
            Je pak is op maat gemaakt en klaar om te dragen  👔. Je kunt hem elke dag tussen 09.00 en 20.00 ophalen in onze winkel in Amsterdam.        </div>
                ...
                <div class="col-md-8">
                    <div class="row flex">
                        <header class="col-md-12">
                            ...
                            <h2 class="page-section-heading">Optimaliseer de chatervaring</h2>
                        </header>
                        <div class="pane">
                            <h4 class="features-label"><img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-chat-omni.svg"> Omnichannel API</h4>
                            <p class="benefits-copy sp">Bouw, integreer en stuur berichten via elk kanaal, zonder handelingen te herhalen. </p>
                        </div>
                        <div class="pane">
                            <h4 class="features-label"><img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-chat-platform.svg"> Voorkeursplatform</h4>
                            <p class="benefits-copy sp">Wees zichtbaar op de chatplatforms die je klanten al met plezier gebruiken.</p>
                        </div>
                        <div class="pane">
                            <h4 class="features-label"><img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-chat-data.svg"> Dataverrijking</h4>
                            <p class="benefits-copy sp">Verzamel aanvullende contactpunten met elke klant waarmee je via Chat communiceert.</p>
                        </div>
                        <div class="pane">
                            ...
                            <p class="benefits-copy sp">Gebruik afbeeldingen, audio, video en geolocaties om je gesprekken te verrijken en contextualiseren.</p>
                        </div>
                    </div>
                </div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<h3 class="page-section-heading">Eenvoudige integratie van onze Chat API</h3>

				<p class="code-example-content lp">Integreer onze Chat API naadloos in jouw CRM-software, website of app. Krijg toegang tot alle mogelijke channels na een simpel setup proces. Lees meer in onze developer documentatie en start waardevolle gesprekken met je klanten.</p>
                    ...
                    <li>
                        <a href="https://developers.messagebird.com/docs/introduction" target="_blank">
                            <img src="https://cdn-gc.messagebird.com/assets/images/icons/libraries/ruby.svg">
									...
									<a class="page-section-link" href="https://developers.messagebird.com/docs/chat" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;chat&quot;});">Bekijk de developer docs ⇢</a>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="article">
                    ...
                    <h3 class="page-section-heading new">Schaalbare Chattarieven</h3>
                    <p class="lp">Onze pricing is gebaseerd op Monthly Active Users (MAU) en data-opslag. We houden de MAU per maand bij, opgebouwd uit elke actieve gebruiker met wie je in een maand communiceert. </p>
                    <p>Ontvang je liever een persoonlijke offerte? <a href="contact-sales.htm">Neem contact op met Sales</a> voor een offerte op maat.</p>
                </div>

                <a href="chat\pricing.htm" class="btn btn-cta" style="" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;chat&quot;});">Bekijk onze tarieven voor Chat ⇢</a>
            ...
            <div class="col-sm-6">
                ...
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        <span class="pill pill-chat">Gratis</span>
                        <div class="number">
                            € 0                        </div>
                        <div class="sp description">50 MAG<br>10 GB Opslag</div>
                    </div>
                    <div class="statistic">
                        <span class="pill pill-chat">Startup</span>
                        <div class="number">
                            € 49                        </div>
                        <div class="sp description">5,000 MAG<br>500 GB Opslag</div>
                    </div>
                </div>
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        <span class="pill pill-chat">Zakelijk</span>
                        <div class="number">
                         € 99                        </div>
                        <div class="sp description">10,000 MAG<br>1 TB Opslag</div>
                    </div>
                    <div class="statistic">
                        <span class="pill pill-chat">Enterprise</span>
                        <div class="number">
                            € 599                        </div>
                        <div class="sp description">60,000 MAG<br>5 TB Opslag</div>
                    </div>
                </div>
                ...
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        <div class="sp"><i class="fa fa-check" aria-hidden="true"></i> Ongelimiteerde Berichten</div>
                        <div class="sp"><i class="fa fa-check" aria-hidden="true"></i> Ongelimiteerde Apps</div>
                    </div>
                    <div class="statistic">
                        <div class="sp"><i class="fa fa-check" aria-hidden="true"></i> Ongelimiteerde Kanalen</div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                        ...
                        <form class="form-group contact-form" id="contact-form" method="post" action="/nl/chat-api#contact-form">
                            <input type="hidden" name="_csrf" value="wvUHm0gO_4S2opIa5Hnb9oqqZyMmJ-z76swDNV-Mk9xPP_HGgKW8bYFdqg0WrnE4tLuDdCcrJ3AcE_BS4WEKGw==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
