...
<html lang="en-ca">
    <head>
        ...
        <title>Numbers &amp; Short codes - MessageBird</title>
        <meta name="description" content="Enable two-way communication and send messages from your Number through our website or your own software or app.">
    ...
    <meta name="csrf-token" content="avdTjOWXzTVr88rpP9ij5tA7kOnrQBIYoOQhyDWbfdbnPaXRLTyO3FwM8v7NDwko7ip0vupM2ZNWO9Kvi3bkEQ==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Numbers &amp; Short codes">
        <meta property="og:description" content="Enable two-way communication and send messages from your Number through our website or your own software or app.">
        <meta property="og:url" content="https://www.messagebird.com/en-ca/numbers">
        ...
        <meta name="twitter:title" content="Numbers &amp; Short codes">
        <meta name="twitter:description" content="Enable two-way communication and send messages from your Number through our website or your own software or app.">
                                ...
                                <div class="floater flex-end">
            	                    ...
            	                    <ul>
                                        <li><span class="active">Related</span></li>
            	                    	            	                    		...
            	                    	            	                    		<li>
            	                    			<a href="pricing.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;numbers&quot;});">
            	                    				Numbers Pricing            	         						</a>
            	                    		</li>
            	                    	            	                    		<li>
            	                    			<a href="sms.htm">
...
<div class="numbers new">
    ...
    <section class="hero page-section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="mb-page-title">Numbers</h1>
                    <div class="xlp">
                        Structure your customer communication around programmable, configurable SMS, MMS and Voice-capable numbers.                    </div>
...
<div class="device-ui-messages">
    	...
    	<div class="message left ">
            Welcome to San Francisco! Our hotel looks forward to hosting you this evening. Check-in starts at 3PM.        </div>

    
    	<div class="message right ">
            How late is front desk open?        </div>

    
    	<div class="message left ">
            Someone is there 24 hours. Check in as late as you’d like.        </div>
        ...
        <div class="container">
            <div class="row">
               <header class="pane col-md-12">
                    ...
                    <h2 class="page-section-heading">Optimize your communication</h2>
                </header>
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="pane col-md-6">
                            ...
                            <p class="benefits-copy sp">Increase your accessibility with multi-channel numbers to provide your customers with immediate, comprehensive support.</p>
                        </div>

                        <div class="pane col-md-6">
                            <h4 class="features-label">Localize</h4>
                            <p class="benefits-copy sp">Integrate your brand into local landscapes and avoid international SMS rates with country and region-specific numbers.</p>
                        </div>

                        <div class="pane col-md-6">
                            <h4 class="features-label">Feedback</h4>
                            <p class="benefits-copy sp">Gain insights through automatable feedback requests, for instance, post-transaction or once a support ticket has been closed.</p>
                        </div>

                        <div class="pane col-md-6">
                            <h4 class="features-label">Number Masking</h4>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Accessibility, solved</h4>
            <h2 class="page-section-heading">Why use MessageBird Numbers</h2>
        </header>
        <div class="row">
        ...
        <p class="lp">Our selection of number types is here to help you make the most of your phone-based customer interactions. Whether you’re looking to localize your brand per country or region, maximize your throughput in any given country, centralize your incoming calls and messages via Voice and SMS capable numbers, or simply open up two-way messaging capabilities, MessageBird has the number type to suit your needs.</p><h4 class="features-label">Branded Interactions</h4><p class="lp">Increasing your accessibility can make a meaningful impact on your customer experience. Localizing contact points per region, for instance, spares customers long distance or international calling and messaging rates and establishes a sense of familiarity for your brand. Hosting numbers that are both Voice and SMS capable makes it easier for customers to reach out. Even something as simple as customizing your sender ID will boost brand recognition and help you stay at the forefront of customers’ minds.</p><h4 class="features-label">Maximal Throughput</h4><p class="lp">Each country has its own set of rules and regulations regarding A2P communication. Fortunately, we’ve got the right numbers to get you connected in each country we cover, as well as a queuing protocol and guided approval processes in place to make sure you don’t get into trouble for breaking the rules. With the MessageBird Numbers API, your calls and messages will get where they’re going as efficiently as possible.</p>
	...
	<a href="#" data-toggle="modal" data-target="#numbers-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;numbers&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Get Numbers PDF ⇢</span>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="sms.htm#pdf">SMS</a>, <a href="voice.htm#pdf">Voice</a>, <a href="verify.htm#pdf">Verify</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-ca/chat#pdf">Chat</a>.</p>
    ...
    <section class="page-section types">
        ...
        <div class="container">
            <div class="row">
                <header class="text-center">
                    <h4 class="page-section-tag">Number types</h4>
                    <h2 class="page-section-heading">Contact points for every purpose</h2>
                </header>

                <div class="container">
                    <div class="row">
                        <div class="pane col-md-4">
                            <h3 class="page-section-heading">Local Numbers</h3>
                            <p class="lp">Localize your brand per region with our wide range of country prefixes and area codes.</p>
                            <a href="pricing.htm" class="page-section-link" style="">Check out Numbers pricing ⇢</a>
                        </div>
                        <div class="col-md-8">
                            <div class="row flex">
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-chat-integrations.svg" height="25"> Integrate</h4>
                                    <p class="sp">Easily implement your numbers within your software, email account, or dashboard.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-numbers-freeinbound.svg" height="25"> Free Inbound SMS</h4>
                                    <p class="sp">We offer unlimited free incoming messages for all of our local numbers.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-numbers-quality.svg" height="25"> Quality Verification</h4>
                                    <p class="sp">All numbers are subjected to comprehensive screenings and testing before we provision them for use.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-chat-omni.svg" height="25"> Automate</h4>
                                    <p class="sp">Bind incoming messages to actions through our API, or us our “if-this-then-that” function to create rules within your dashboard.</p>
                                </div>
                            </div>
                        </div>
                     </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="pane col-md-4">
                            <h3 class="page-section-heading">Short Codes</h3>
                            <p class="lp">Simplify customer contact with dedicated or shared short codes.</p>
                            <a href="pricing.htm" class="page-section-link" style="">Check out Short code pricing ⇢</a>
                        </div>
                        <div class="col-md-8">
                            <div class="row flex">
                                <div class="pane">
                                    ...
                                    <p class="sp">For branded interactions and campaigns that require higher throughput, we provision dedicated short codes.</p>
                                </div>
                                <div class="pane">
                                    ...
                                    <p class="sp">Use configurable keywords and sub-keywords to automate and organize your short code setup.</p>
                                </div>
                                <div class="pane">
                                    ...
                                    <p class="sp">We offer pre-approved shared short codes in select countries to expedite the carrier approval process and get your campaigns delivered as quickly as possible.</p>
                                </div>
                                <div class="pane">
                                    <h4 class="features-label"><img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-number-throughput.svg" height="25"> High Throughput</h4>
                                    <p class="sp">In some countries, throughput for long-codes is limited or blocked altogether. With short codes, you’ll typically be able to send the maximum daily traffic allowed in a given country.</p>
                                </div>
                            </div>
                        </div>
                    </div>
     ...
     <section class="page-section local">
        ...
        <div class="container">
            <div class="row">
               <header class="text-center">
                    <h4 class="page-section-tag">Local Numbers</h4>
                    <h2 class="page-section-heading">Over 50 countries and 700 prefixes and area codes</h2>
                </header>
                ...
                <div class="col-md-12">
                    <div class="row numbers-countries">
                                ...
                                <span data-country-code="14" data-country="Australia" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="13" data-country="Austria" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="20" data-country="Belgium" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="95" data-country="Croatia" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="54" data-country="Czech Republic" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="57" data-country="Denmark" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="62" data-country="Estonia" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="73" data-country="France" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="55" data-country="Germany" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="97" data-country="Hungary" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="98" data-country="Indonesia" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="99" data-country="Ireland" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="106" data-country="Italy" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="130" data-country="Latvia" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="128" data-country="Lithuania" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="151" data-country="Malaysia" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="159" data-country="Netherlands" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="160" data-country="Norway" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="172" data-country="Poland" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="182" data-country="Romania" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="194" data-country="Slovakia" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="237" data-country="South Africa" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="117" data-country="Korea, Republic of" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="66" data-country="Spain" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="189" data-country="Sweden" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="41" data-country="Switzerland" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="218" data-country="Taiwan, Province of China" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="215" data-country="Turkey" class="js-vmn-pricing-change clearfix ">
                                ...
                                <span data-country-code="75" data-country="United Kingdom" class="js-vmn-pricing-change clearfix active">
                                ...
                                <span data-country-code="223" data-country="United States of America" class="js-vmn-pricing-change clearfix ">
                    ...
                    <div class="row contact-sales-wrap">
                        <div class="text-center">
                            <a href="contact-sales.htm" class="page-section-link">Don’t see your country? Contact sales ⇢</a>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <a href="sms\pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;numbers&quot;});">Check out SMS pricing ⇢</a>
            ...
            <div class="col-sm-6">
                ...
                <a class="page-section-link new" style="margin-top: 5px;" href="voice.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;numbers&quot;});">Learn more about Voice ⇢</a>
            </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">Numbers</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-ca/numbers#contact-form">
                            <input type="hidden" name="_csrf" value="avdTjOWXzTVr88rpP9ij5tA7kOnrQBIYoOQhyDWbfdbnPaXRLTyO3FwM8v7NDwko7ip0vupM2ZNWO9Kvi3bkEQ==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
