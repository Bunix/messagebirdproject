...
<html lang="en-ca">
    ...
    <meta name="csrf-token" content="vz03ZWU_V1CKzPMkLljEA25lyVJYHe7c6ygiu0Rq-w8y98E4rZQUub0zyzPcj27NUHQtBVkRJVcd99Hc-odiyA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-ca/google-rcs">
...
<div class="mb-rcs rcs new">
        ...
        <div class="container" style="z-index: 1;">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="xlp">
                        We have partnered with Google to launch Rich Communication Services and modernize the standard for global text messaging.                    </div>

                    <div>
                        <a href="#" class="btn btn-cta js-access">Request Access</a>
                    </div>
                </div>
	...
	<div class="messages">
		<div class="first-message">
			<div class="message">Jake, your upcoming flight to New York is 12 hours away!</div>
		</div>
		<div class="second-message">
			<div class="avatar">
				<i class="fa fa-plane" aria-hidden="true"></i>
			</div>
			<div class="message">Here is your boarding pass:</div>
		</div>
	...
	<div class="annotation one"><span class="number">1</span> Verified Sender</div>
	<div class="annotation two"><span class="number">2</span> Customised Branding</div>
	<div class="annotation three"><span class="number">3</span> Rich Media</div>
	<div class="annotation four"><span class="number">4</span> Suggested Replies and Actions</div>
    ...
    <div class="container">
        <div class="row flex">
           <header class="col-md-12 text-center">
                ...
                <h2 class="page-section-heading">Modernize your messaging experience</h2>
            </header>
            	...
            	<div class="pane">
                    ...
                    Custom Branding</h4>
	                <p class="benefits-copy sp">Create advanced interactive elements that strengthen and extend your branding. Add information about your business, share branded imagery, and more.</p>
            	...
            	<div class="pane">
	                ...
	                <p class="benefits-copy sp">Allow customers to easily add events to their calendar, save tickets to their wallet app, and more with clickable action buttons at the bottom of your conversation thread.</p>
            	...
            	<div class="pane">
	                ...
	                <p class="benefits-copy sp">Facilitate quick responses and interations with clickable suggested replies for anything from yes or no answers to appointment time slots, and much more.</p>
            	...
            	<div class="pane">
                    ...
                    Rich Media</h4>
	                <p class="benefits-copy sp">Enhance and enliven your conversations with images, videos, maps, and buttons. </p>
            	...
            	<div class="pane">
                    ...
                    Better Insights</h4>
	                <p class="benefits-copy sp">Track when recipients have read or interacted with your messages.</p>
            	...
            	<div class="pane">
                    ...
                    File Sharing</h4>
	                <p class="benefits-copy sp">Easily share high-resolution images, documents, and large files.</p>
    ...
    <section class="clearfix logos" style="background: #f6fafd; margin-top: 120px; margin-bottom: 150px; position: relative;">
        ...
        <header class="col-xs-12 text-center">
            <h4 class="page-section-tag"><span>As written about in these publications</span></h4>
        </header>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <header class="text-center">
                            ...
                            <h2 class="page-section-heading">Optimize your customer communication</h2>
                        </header>

                        <div class="pane col-md-4">
                            <h4 class="features-label">Customer Service</h4>
                            <p class="benefits-copy sp">Share proximate store locations with a map, allow customers to directly download tickets within their wallet applications, receive and respond to support questions with photos, videos, and so much more.</p>
                        </div>

                        <div class="pane col-md-4">
                            <h4 class="features-label">Logistics</h4>
                            <p class="benefits-copy sp">Keep your customers up to date on deliveries with location-sharing, add visual elements to boost the resonance of notifications, and use buttons to facilitate rescheduling, confirmations, and cancellations.</p>
                        </div>

                        <div class="pane col-md-4">
                            <h4 class="features-label">Marketing Campaigns</h4>
                            <p class="benefits-copy sp">Exchange photos, videos, audio files, locations, and documents, integrate branding elements into your messaging environment, and encourage engagement with buttons, suggested actions, and more.</p>
                        </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">RCS</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-ca/google-rcs#contact-form">
                            <input type="hidden" name="_csrf" value="vz03ZWU_V1CKzPMkLljEA25lyVJYHe7c6ygiu0Rq-w8y98E4rZQUub0zyzPcj27NUHQtBVkRJVcd99Hc-odiyA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
