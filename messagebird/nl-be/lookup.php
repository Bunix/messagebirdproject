...
<html lang="nl-be">
    <head>
        ...
        <title>Lookup - MessageBird</title>
        <meta name="description" content="Zoek uit of de contactinformatie die je van je klanten hebt nog up-to-date is. Schoon je database op en verminder het aantal niet afgeleverde berichten.">
    ...
    <meta name="csrf-token" content="Ud-YCj7MNE_xkIFh2G9hBH7qZHAaXkFRGueNveqJ0E_cFW5X9md3psZvuXYquMvKQPuAJxtSitrsOH7aVGRJiA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Lookup">
        <meta property="og:description" content="Zoek uit of de contactinformatie die je van je klanten hebt nog up-to-date is. Schoon je database op en verminder het aantal niet afgeleverde berichten.">
        <meta property="og:url" content="https://www.messagebird.com/nl-be/lookup">
        ...
        <meta name="twitter:title" content="Lookup">
        <meta name="twitter:description" content="Zoek uit of de contactinformatie die je van je klanten hebt nog up-to-date is. Schoon je database op en verminder het aantal niet afgeleverde berichten.">
        

        <script type="text/javascript">window.page = 'lookup';</script>
...
ga('send', 'pageview');
        ...
        </script><script type="text/javascript">analytics.page("", {route: "app/pages/lookup"});</script><script type="text/javascript">
            var _user_id = "";
                        ...
                        <select onchange="if (this.value) window.location.href=this.value">
                            <option value="" disabled="" selected="">Kies jouw land
                                                            <optgroup label="Africa">
                                                                                <option value="/en-gh/lookup" data-name-locale="English">
                                                Ghana                                            
                                                                                    <option value="/en-ke/lookup" data-name-locale="English">
                                                Kenya                                            
                                                                                    <option value="/en-ng/lookup" data-name-locale="English">
                                                Nigeria                                            
                                                                                    <option value="/en-ug/lookup" data-name-locale="English">
                                                Uganda                                            
                                                                                    <option value="/en-zw/lookup" data-name-locale="English">
                                                Zimbabwe                                            
                                                                        </optgroup>
                                                          <optgroup label="Asia">
                                                                                <option value="/en-hk/lookup" data-name-locale="English">
                                                Hong Kong                                            
                                                                                    <option value="/en-sg/lookup" data-name-locale="English">
                                                Singapore                                            
                                                                        </optgroup>
                                                          <optgroup label="Europe">
                                                                                <option value="/fr-be/lookup" data-name-locale="Français">
                                                Belgique                                            
                                                                                    <option value="/nl-be/lookup" data-name-locale="Vlaams">
                                                België                                            
                                                                                    <option value="/de-de/lookup" data-name-locale="Deutsch">
                                                Deutschland                                            
                                                                                    <option value="/es-es/lookup" data-name-locale="Español">
                                                España                                            
                                                                                    <option value="/fr-fr/lookup" data-name-locale="Français">
                                                France                                            
                                                                                    <option value="/en-gi/lookup" data-name-locale="English">
                                                Gibraltar                                            
                                                                                    <option value="/en-gg/lookup" data-name-locale="English">
                                                Guernsey                                            
                                                                                    <option value="/en-ie/lookup" data-name-locale="English">
                                                Ireland                                            
                                                                                    <option value="/en-im/lookup" data-name-locale="English">
                                                Isle of Man                                            
                                                                                    <option value="/en-je/lookup" data-name-locale="English">
                                                Jersey                                            
                                                                                    <option value="/nl/lookup" data-name-locale="Nederlands">
                                                Nederland                                            
                                                                                    <option value="/en-gb/lookup" data-name-locale="English">
                                                United Kingdom                                            
                                                                        </optgroup>
                                                          <optgroup label="North America">
                                                                                <option value="/en-bs/lookup" data-name-locale="English">
                                                Bahamas                                            
                                                                                    <option value="/en-bz/lookup" data-name-locale="English">
                                                Belize                                            
                                                                                    <option value="/en-bm/lookup" data-name-locale="English">
                                                Bermuda                                            
                                                                                    <option value="/en-vg/lookup" data-name-locale="English">
                                                British Virgin Islands                                            
                                                                                    <option value="/en-ca/lookup" data-name-locale="English">
                                                Canada                                            
                                                                                    <option value="/en-ky/lookup" data-name-locale="English">
                                                Cayman Islands                                            
                                                                                    <option value="/en-gd/lookup" data-name-locale="English">
                                                Grenada                                            
                                                                                    <option value="/en-jm/lookup" data-name-locale="English">
                                                Jamaica                                            
                                                                                    <option value="/en-pr/lookup" data-name-locale="English">
                                                Puerto Rico                                            
                                                                                    <option value="/en-tt/lookup" data-name-locale="English">
                                                Trinidad & Tobago                                            
                                                                                    <option value="/en-us/lookup" data-name-locale="English">
                                                United States                                            
                                                                        </optgroup>
                                                          <optgroup label="Oceania">
                                                                                <option value="/en-au/lookup" data-name-locale="English">
                                                Australia                                            
                                                                                    <option value="/en-gu/lookup" data-name-locale="English">
                                                Guam                                            
                                                                                    <option value="/en-nz/lookup" data-name-locale="English">
                                                New Zealand                                            
                                                                        </optgroup>
                                                          <optgroup label="South America">
                                                                                <option value="/en-gy/lookup" data-name-locale="English">
                                                Guyana                                            
                                                                        </optgroup>
                                                    <optgroup label="Other">
                              <option value="/en/lookup" data-name-locale="Rest of world">
                                  Rest of world
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
              ...
              <h1 class="mb-page-title">Lookup</h1>
              <div class="h1-links">
                Ontdek gedetailleerde informatie over elk telefoonnummer ter wereld, in real-time. Houd je database schoon en minimaliseer de kosten van verstuurde berichten.            </div>
            <div class="page-section-btn-container">
                <a href="/nl-be/signup" class="btn btn-cta">Probeer het gratis</a>
                <a href="contact-sales.htm" class="btn ghost mb-ripple-in">Neem contact op</a>
            </div>
            </div>
        </div>
    </div>
</section>
    <section class="page-section lookup-demo">

    <div class="skewed-stripe-background"></div>

   <div class="container">
       <div class="row">
        <h6 class="col-xs-12 col-md-6">Voer een telefoonnummer in</h6>
        <div class="col-xs-12 col-md-6 text-right lookup-demo-examples">
            <span class="label">Test het met je eigen nummer</span> <h4 class="pill pill-blue"><a href="#" class="js-lookup-demo-example active" data-type="mobile" data-example="31624718600">Mobiel</a></h4> <h4 class="pill pill-blue"><a href="#" class="js-lookup-demo-example" data-type="voip" data-example="31207009850">Vaste lijn</a></h4> <h4 class="pill pill-blue"><a href="#" class="js-lookup-demo-example" data-type="invalid" data-example="12345678">Ongeldig</a></h4>
        </div>
        <div class="col-xs-12">
            <input type="text" name="lookup-number" class="lookup-demo-input js-lookup-demo-input" value="+31635778012" disabled="">
        </div>
    </div>
    <div class="row text-left" style="margin-top: 30px;">
        <div class="col-md-6">
            <h6>Lookup respons</h6>
            <div class="lookup-output">
                <img class="lookup-demo-loader js-lookup-demo-loader" src="https://cdn-gc.messagebird.com/assets/images/loaders/rolling.svg">
                <pre class="lookup-output-pre line-numbers language-bash"><code class="js-lookup-demo-output">{
...
"formats": {
    ...
    "rfc3966": "tel:+31-6-42657439"
        ...
        <div class="col-md-6">
            <h6>HLR respons</h6>
            <div class="lookup-output">
                <img class="lookup-hlr-demo-loader js-lookup-hlr-demo-loader" src="https://cdn-gc.messagebird.com/assets/images/loaders/rolling.svg">
                <pre class="lookup-output-pre line-numbers language-bash"><code class="js-lookup-hlr-demo-output">{
...
"status": "active",
"createdDatetime": "2017-09-05T12:29:53+00:00",
"statusDatetime": "2017-09-05T12:29:53+00:00"
}</code></pre>
            </div>
        </div>
    </div>
...
<section class="page-section how text-center">
    <div class="container">
        <div class="row">
            ...
            <img class="hidden-xs hidden-sm" width="840" src="https://cdn-gc.messagebird.com/assets/images/2017/lookuphiw.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/lookuphiw@2x.png 2x">

            <div class="steps-wrap">
                <div class="col-md-4">
                    <h4 class="pill pill-purple">stap 1</h4>
                    <p class="sp">Stuur de telefoonnummers die je wilt checken naar onze API.</p>
                </div>
                <div class="col-md-4">
                    <h4 class="pill pill-purple">stap 2</h4>
                    <p class="sp">Onze API voert een HLR Lookup uit op het mobiele netwerk en identificeert het nummer.</p>
                </div>
                <div class="col-md-4">
                    <h4 class="pill pill-purple">stap 3</h4>
                    <p class="sp">Wij vullen de nummerinformatie in, met de beschikbaarheid en de provider.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="page-section features">
    <div class="container">
        <div class="row">
             <header class="col-xs-12 text-center" style="margin-bottom: 60px;">
                <h4 class="page-section-tag">Features</h4>
                <h2 class="page-section-heading">Voor een schone, geoptimaliseerde en veilige database van klantgegevens</h2>
            </header>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <h3 class="page-section-heading">Lookup <span class="pill pill-purple">Gratis dienst</span>
                <p class="lp">Onze gratis Lookup service geeft basisinzichten in nummerinformatie en helpt je jouw adresboek up-to-date te houden. Valideer nummers en formats, elimineer frauduleuze contacten en reduceer het aantal niet-afleverbare berichten door inactieve nummers te verwijderen.</p>

            </h3></div>
            <div class="col-md-6">
                <img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-icon-lookup-format.svg" width="20">
                <h4 class="features-label">Nummernotatie</h4>
                <p class="sp">VKijk na of nummers goed zijn genoteerd. Pas ze aan om ervoor te zorgen dat al je berichten aankomen. Filter op te lange, te korte en onjuiste nummers. Wij ondersteunen gangbare standaarden zoals nationale notaties en E.164 om je contactenlijst werkbaar en up-to-date te houden.</p>

                <pre class="small-code-example line-numbers"><code class="language-bash">"formats": {
    "e164": "+31642657439",
    "international": "+31 6 42657439",
    "national": "06 42657439",
    "rfc3966": "tel:+31-6-42657439"
}</code></pre>
                <img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-icon-lookup-numberinfo.svg" width="20">
                <h4 class="features-label">Nummerinformatie</h4>
                <p class="sp">Deel je nummers in als mobiel, vaste lijn of SIP.</p>

                <pre class="small-code-example line-numbers"><code class="language-bash">"type": "mobile"</code></pre>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <h3 class="page-section-heading">Lookup + HLR <span class="pill pill-purple">Betaalde dienst</span>
                <p class="lp">MessageBird heeft een eigen, directe verbinding met het <abbr title="Signalling System No. 7">SS7</abbr>-netwerk. Zo kunnen we een <abbr title="Send Routing Info">SRI</abbr>-verzoek van elk nummer in de wereld indienen bij het <abbr title="Home Location Register">HLR</abbr>.</p>
            </h3></div>
            <div class="col-md-6">
                <img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-icon-lookup-mcc.svg" width="20">
               <h4 class="features-label"> <abbr title="Mobile Country Code">MCC</abbr> &amp; <abbr title="Mobile Network Code">MNC</abbr></h4>
               <p class="sp">Identificeer uit welk land een nummer komt en bij welk netwerk het geregistreerd is.</p>
                <img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-icon-lookup-imsi.svg" width="20">
               <h4 class="features-label"> Locatie <abbr title="International Mobile Subscriber Identity">IMSI</abbr></h4>
               <p class="sp">Ontdek op welke locatie een nummer actief is.</p>
                <img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-icon-lookup-validity.svg" width="20">
               <h4 class="features-label"> Nummer validatie</h4>
               <p class="sp">Ontdek of een nummer actief, gedeactiveerd of ongeregistreerd is.</p>

                <pre class="small-code-example line-numbers"><code class="language-bash">"status": "active"</code></pre>
                <img class="features-icon" src="https://cdn-gc.messagebird.com/assets/assets-images/icons/500/20pt24box/mb-icon-lookup-msc.svg" width="20">
                <h4 class="features-label"> <abbr title="Mobile Switching Center">MSC</abbr></h4>
                <p class="sp">Kom erachter of een nummer aan het roamen is, in welk land het zich bevindt en op welk netwerk het op dat moment aangesloten is.</p>

                <pre class="small-code-example line-numbers"><code class="language-bash">"location_msc": "316530"</code></pre>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Contacten, opgelost</h4>
            <h2 class="page-section-heading">Waarom MessagBird Lookup Gebruiken?</h2>
        </header>
        <div class="row">
        ...
        <p class="lp">Er zitten veel voordelen aan het beter leren kennen van de nummers in je adresboek. Naast kosten te verminderen door alleen actieve nummers berichten te sturen, geeft Lookup je ook de mogelijkheid om je CRM-systeem efficiënt in te delen. Zo krijg je een overzichtelijke contactenlijst, gesorteerd op bijvoorbeeld nummertype en landcode.</p><h4 class="features-label">Bespaar kosten voor berichten </h4><p class="lp">Lookup kan je helpen om de kosten van berichten drastisch  te verlagen,  of je nu veel of weinig SMS'jes verstuurt. Door nummers die verkeerd zijn genoteerd te identificeren en nummers die niet meer in gebruik zijn te verwijderen, stuur je veel minder onbezorgde berichten. Het valideren van de inhoud van je CRM-systeem met de Lookup API van MessageBird is de makkelijkste manier om je contactenlijst relevant en geordend te houden.</p><h4 class="features-label">Easy-to-use API</h4><p class="lp">Elke versie van MessageBird Lookup is ontzettend makkelijk te gebruiken en te installeren, of je nu de gratis of de HLR-versie gebruikt. Eén simpel belletje naar onze vriendelijke REST API en je haalt zo gedetailleerde informatie van je contacten op. De resultaten van de gratis Lookup-service ontvang je meteen. De HLR-variant ontvang je binnen enkele seconden.</p>
                    <div class="read-more-button-container js-read-more-button-container">
                        <a href="#" class="btn btn-cta js-read-more">Lees meer</a>
                    </div>
                </div>
...
<div class="document-download">
	<a href="#" data-toggle="modal" data-target="#lookup-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;lookup&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Ontvang Lookup PDF ⇢</span>
				<p class="sp">En deel het met je team</p>
			</div>
		</div>
	</a>
</div>

<div class="rd17 pdf-modal modal fade" id="lookup-whitepaper" tabindex="-1" role="dialog">
			...
			<div class="modal-body lp">
				...
				<div class="row">
					<div class="col-md-7">
						...
						<h1 class="mb-page-title">Bekijk het Lookup Overzicht</h1>
<p class="lp">Ontdek wat Lookup van MessageBird voor jouw bedrijf kan betekenen. Vul je email in en we sturen direct een PDF naar je toe.</p>
...
<form class="download-pdf">
  <div class="form-group">
      <div class="input-group">
          ...
          <input type="hidden" name="type" value="lookup-pdf">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp result-lookup-whitepaper">

						<p class="sp">We also have resources available for <a href="/nl-be/pricing#pdf">Tarieven</a>, <a href="sms.htm#pdf">SMS</a>, <a href="voice.htm#pdf">Voice</a>, <a href="verify.htm#pdf">Verify</a>, <a href="/nl-be/numbers#pdf">Nummers</a>, <a href="/nl-be/numbers#pdf">Shortcode</a> and <a href="/nl-be/chat#pdf">Chat</a>.</p>
...
<path style="fill:#ffffff;" d="M311.2,168.2c-10.5,22.2-30.6,29-30.6,29c-2.9,1.2-5.8,2.1-8.5,2.7c-0.3,0.1-0.6,0.1-0.9,0.2
	...
	c0,0.6,0.1,1.1,0.1,1.7c0,0.6,0,1.2,0,1.7C316.8,157.8,311.2,168.2,311.2,168.2z"></path>
                    ...
                    <div class="clearfix read-more-cta js-read-more-cta" style="width: 100%;">
                        <a href="contact-sales.htm" class="btn btn-cta" style="width: 100%;">Neem contact op met Sales ⇢</a>
                    </div>
                </div>
            </div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<h3 class="page-section-heading">Integreer eenvoudig onze REST API</h3>

				<p class="code-example-content lp">Easily access our Lookup API. Read up on our developer documentation and connect your CRM software, website or app to Lookup in no time.</p>
                    ...
                    <li>
                        <a href="https://developers.messagebird.com/docs/introduction" target="_blank">
                            <img src="https://cdn-gc.messagebird.com/assets/images/icons/libraries/ruby.svg">
									...
									<a class="page-section-link" href="https://developers.messagebird.com/docs/lookup" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;lookup&quot;});">Bekijk de developer docs ⇢</a>
            ...
            <div class="col-md-6">
                <div class="tab-content text-right hidden-xs">
    						...
    						<select class="code-example-languages" role="tablist">
    		                            ...
    		                            Python    		                        
    		                        		                        <option role="presentation" href="#javascript" aria-controls="javascript" class="">
    		                            Javascript    		                        
    		                        		                        <option role="presentation" href="#java" aria-controls="java" class="">
    		                            Java    		                        
    		                        						</select>
                        </div>
					                                            <div role="tabpanel" class="tab-pane text-left  active" id="curl">
							                            <pre class="line-numbers new"><code class="language-bash"># Lookup example
$ curl -X GET https://rest.messagebird.com/lookup/31612345678 \
-H 'Authorization: AccessKey test_gshuPaZoeEG6ovbc8M79w0QyM'</code></pre>
                        </div>
                                            <div role="tabpanel" class="tab-pane text-left " id="php">
							                            <pre class="line-numbers new"><code class="language-php">$MessageBird = new \MessageBird\Client('YOUR_ACCESS_KEY');
$Lookup = $MessageBird->lookup->read(31612345678);</code></pre>
                        </div>
...
lookup = client.lookup(31612345678)</code></pre>
                        </div>
                                            <div role="tabpanel" class="tab-pane text-left " id="go">
							                            <pre class="line-numbers new"><code class="language-go">params := &messagebird.LookupParams{CountryCode: "US"}
lookup, err := client.Lookup('31612345678',params)</code></pre>
                        </div>
...
MessageBird.Objects.Lookup lookup = client.DoLookup(PhoneNumber);</code></pre>
                        </div>
                                            <div role="tabpanel" class="tab-pane text-left " id="python">
							                            <pre class="line-numbers new"><code class="language-python">client = messagebird.Client(YOUR_ACCESS_KEY)
lookup = client.lookup(31612345678)</code></pre>
                        </div>
                                            <div role="tabpanel" class="tab-pane text-left " id="javascript">
							                            <pre class="line-numbers new"><code class="language-javascript">var messagebird = require('messagebird')('YOUR_ACCESS_KEY');
messagebird.lookup.read('31612345678', function (err, response) {
  ...
  console.log(response);
                                            ...
                                            <div role="tabpanel" class="tab-pane text-left " id="java">
							                            <pre class="line-numbers new"><code class="language-java">final MessageBirdService wsr = new MessageBirdServiceImpl("YOUR_ACCESS_KEY");
final MessageBirdClient messageBirdClient = new MessageBirdClient(wsr);

final BigInteger phonenumber = 31612345678;

final Lookup lookup = messageBirdClient.viewLookup(phonenumber);</code></pre>
                        </div>
                                    </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                    ...
                    <h3 class="page-section-heading new">Tarieven Lookup en HLR</h3>
                    <p class="lp">De basisservice van Lookup is gratis. Onze directe verbinding met het SS7-netwerk stelt ons in staat om HLR Lookups tegen de laagst mogelijke prijs te doen. </p>
                </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        <div class="number">Gratis</div>
                        <div class="sp description">Lookup verzoeken zijn gratis in Philippines </div>
                    </div>
                    <div class="statistic">
                        <div class="js-currency currency number">
                            $
                        </div>
                        <div class="js-pricing-hlr number">
                            0.015                        </div>
                        <div class="sp description">Per HLR verzoek in Philippines</div>
                    </div>
                </div>

                <a href="tarieven.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;lookup&quot;});">Bekijk al onze tarieven ⇢</a>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Meer weten over <span style="font-weight: 900;">Lookup</span>?<br> Neem contact op met ons salesteam.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/nl-be/lookup#contact-form">
                            <input type="hidden" name="_csrf" value="Ud-YCj7MNE_xkIFh2G9hBH7qZHAaXkFRGueNveqJ0E_cFW5X9md3psZvuXYquMvKQPuAJxtSitrsOH7aVGRJiA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
...
<script type="text/javascript">jQuery(document).ready(function () {
	...
	$('.download-pdf').submit(function() {
		var _this = $(this);
		var formResult = $('.result-lookup-whitepaper'); // PHP lookup-whitepaper
	    $.ajax({
