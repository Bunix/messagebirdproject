...
<html lang="nl-be">
    <head>
        ...
        <meta name="description" content="Verstuur berichten via onze website of je eigen software of app. Probeer onze SMS Gateway gratis en maak verbinding met meer dan 900 operators wereldwijd.">
    ...
    <meta name="csrf-token" content="_Dk5qP226PmetuuKLOBgZmAiClCEbLBXQ_8XyxC6vOtx88_1NR2rEKlJ053eN8qoXjPuB4Vge9y1IOSsrlclLA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Verstuur berichten via onze website of je eigen software of app. Probeer onze SMS Gateway gratis en maak verbinding met meer dan 900 operators wereldwijd.">
        <meta property="og:url" content="https://www.messagebird.com/nl-be/sms">
        ...
        <meta name="twitter:description" content="Verstuur berichten via onze website of je eigen software of app. Probeer onze SMS Gateway gratis en maak verbinding met meer dan 900 operators wereldwijd.">
        ...
        <div class="container" style="z-index: 1;">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="xlp">
                        Stuur al jouw SMS-communicatie met ongeëvenaarde betrouwbaarheid en een low latency met onze wereldwijd schaalbare messaging API.                                            </div>
...
<div class="device-ui-messages">
    	...
    	<div class="message left ">
            Je Uber komt nu aan. Je chauffeur wacht 2 minuten tot vertrek. Fijne rit!        </div>
...
<div class="device-ui-messages">
    	...
    	<div class="message left ">
            Hi! Je eten is klaar en onderweg. Smakelijk 🍽        </div>

    
    	<div class="message right ">
            Wij zitten op de tweede etage. Dankjewel        </div>
                ...
                <div class="col-md-8">
                    <div class="row flex">
                        <header class="col-md-12">
                            ...
                            <h2 class="page-section-heading">Maak je communicatie beter, slimmer, sneller</h2>
                        </header>
                        <div class="pane">
                            <h4 class="features-label">Customer Support</h4>
                            <p class="benefits-copy sp">Wees beter benaderbaar en lever rechtstreeks support met tweerichtingsverkeer in berichten.</p>
                            <a href="nummers.htm" class="page-section-link">Ontdek Numbers ⇢</a>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Beveiliging</h4>
                            <p class="benefits-copy sp">Bescherm je platform en klanten door profielen op punten te beveiligen met 2FA.</p>
                            <a href="verify.htm" class="page-section-link">Ontdek Verify ⇢</a>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Marketingcampagnes</h4>
                            <p class="benefits-copy sp">Bereik je klanten met gerichte en gelokaliseerde campagnes en acties.</p>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Notificaties</h4>
                            <p class="benefits-copy sp">Deel updates over leveringen, reminders, bevestigingen van transacties en meer.</p>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Interne Communicatie</h4>
                            <p class="benefits-copy sp">Communiceer interne informatie, ontvang updates en houd contact met werknemers.</p>
                        </div>
                        <div class="pane">
                            <h4 class="features-label">Meldingen</h4>
                            <p class="benefits-copy sp">Stuur tijdig urgente meldingen met 's werelds snelste, meest betrouwbare SMS-platform.</p>
                        </div>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Berichten, opgelost</h4>
            <h2 class="page-section-heading">Waarom Messagebird SMS Gebruiken?</h2>
        </header>
        <div class="row">
        ...
        <p class="lp">MessageBird ondersteunt SMS-verkeer van alle volumes langs betrouwbare en gestroomlijnde messaging-routes over de hele wereld. We zijn een gelicenseerde provider met meer dan 900 directe of one-hop connecties. Onze 15.000 klanten sturen dagelijks SMS-verkeer de hele wereld over onze infrastructuur. Hiermee zijn we de drijvende kracht achter zakelijke communicatie op elke schaal.</p><h4 class="features-label">Het Optimale Messaging-Platform</h4><p class="lp">Onze SMS API opereert op een volledig redundant, sterk beveiligde Telco Stack die we in-house ontwikkeld hebben. Dankzij onze licentie als provider kan ons platform sneller meer berichten afleveren dan onze concurrenten zonder deze licentie. Wij ondersteunen alle landelijke features, hosten directe verbindingen met ander providers en zorgen ervoor dat jouw customer support nog beter wordt.</p><h4 class="features-label">SmartRouting</h4><p class="lp">Naast onze Telco Stack en API's, hebben we ook een SmartRouting-machine ontwikkeld. SmartRouting zorgt ervoor dat elk bericht dat via ons platform reist, de optimale route voor snelheid en betrouwbaarheid volgt. Onze SmartRouting algoritmes zijn uitgerust met onze groeiende routing profielen en connecties. En precies dat is wat SMS-communicatie via MessageBird schaalbaar én betaalbaar maakt.</p><h4 class="features-label">Gebruiksvriendelijke API</h4><p class="lp">Onze REST API is gebouwd voor makkelijk gebruik en integratie. Zodra je onze SMS-documentatie hebt doorgelezen, heb je genoeg kennis om zowel messaging als ons brede aanbod aan features in je database te integreren. Loop je tegen een probleem aan? Ons team staat voor je klaar om je bij elke stap te ondersteunen.</p>
	...
	<a href="#" data-toggle="modal" data-target="#sms-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;sms&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Ontvang SMS PDF ⇢</span>
...
<section class="page-section no-border customers  compact" style="">
    ...
    <div class="quote">
        <p>&ldquo;Met MessageBird sturen we notificaties naar congresdeelnemers over de hele wereld in real-time.&rdquo;</p>


        <div class="quote-con clearfix">
            <div class="left-part">
                <span>Wytze de Haan</span><br>
                Directeur Events            </div>
    ...
    <div class="container">
        <div class="row flex">
           <header class="col-md-12 text-center">
                ...
                <h2 class="page-section-heading">Een messaging-setup op maat</h2>
            </header>
            	...
            	<div class="pane">
                    ...
                    Telefoonnummers</h4>
	                <p class="benefits-copy sp">Ondersteun tweerichtingsverkeer in berichten met lokale contactpunten over de hele wereld.</p>
            	...
            	<div class="pane">
                    ...
                    RCS</h4>
	                <p class="benefits-copy sp">Gebruik de nieuwe generatie SMS. Stuur rich-media en hele bestanden.</p>

	                	                	<a href="/nl-be/rcs" class="page-section-link">Ontdek RCS ⇢</a>
	                	            </div>
            	...
            	<div class="pane">
                    ...
                    Nummer Lookup</h4>
	                <p class="benefits-copy sp">Verzamel gedetailleerde nummerinformatie en organiseer jouw adresboek. </p>

	                	                	<a href="lookup.htm" class="page-section-link">Ontdek Lookup ⇢</a>
	                	            </div>
            	...
            	<div class="pane">
                    ...
                    MMS</h4>
	                <p class="benefits-copy sp">Voeg beeldmateriaal, audiobestanden en video's toe aan klantgesprekken.</p>
            	...
            	<div class="pane">
                    ...
                    Sticky Sender</h4>
	                <p class="benefits-copy sp">Stuur altijd berichten naar klanten van hetzelfde, herkenbare telefoonnummer.</p>
            	...
            	<div class="pane">
                    ...
                    Alle Karaktersets</h4>
	                <p class="benefits-copy sp">Doe je voordeel met een platform dat alle karaktersets ondersteunt, inclusief emoji. 👍</p>
            	...
            	<div class="pane">
                    ...
                    Auto-Concatenatie</h4>
	                <p class="benefits-copy sp">Beperk je niet tot het maximum van 160 karakters en lever tot 9 opgeknipte berichten af als één SMS.</p>
            	...
            	<div class="pane">
                    ...
                    Rerouting</h4>
	                <p class="benefits-copy sp">Garandeer dat je berichten op tijd worden geleverd door onze rerouting-infrastructuur, die snel reageert op storingen. </p>
            	...
            	<div class="pane">
                    ...
                    Wachtrij</h4>
	                <p class="benefits-copy sp">Wij pauzeren de berichten-output automatisch als je het SMS-quotum bereikt, zodat je nooit de landelijke restricties overschrijdt.</p>
            	...
            	<div class="pane">
                    ...
                    SS7</h4>
	                <p class="benefits-copy sp">Stuur grote volumes traffic met complete controle met onze SS7-compatible Telco Stack.</p>
            	...
            	<div class="pane">
                    ...
                    Tweerichtingsverkeerberichten</h4>
	                <p class="benefits-copy sp">Laat klanten reageren of contact op te nemen via gelokaliseerde nummers.</p>
            	...
            	<div class="pane">
                    ...
                    Email naar SMS</h4>
	                <p class="benefits-copy sp">Stuur en ontvang directe SMS-berichten via je e-mailaccount, zonder aanvullende software.</p>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<p class="code-example-content lp">Integreer onze SMS-oplossingen naadloos in jouw CRM-software, website of app. Lees hier meer over in onze developer documentatie en verbindt jouw platform met meer dan 900 operators wereldwijd.</p>
                    ...
                    <li>
                        <a href="https://developers.messagebird.com/docs/introduction" target="_blank">
                            <img src="https://cdn-gc.messagebird.com/assets/images/icons/libraries/ruby.svg">
									...
									<a class="page-section-link" href="https://developers.messagebird.com/docs/messaging" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;sms&quot;});">Bekijk de developer docs ⇢</a>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="article">
                    ...
                    <h3 class="page-section-heading new">Competitieve SMS-tarieven</h3>
                    <p class="lp">Van gestroomlijnde routingprofielen, tot volumekorting, tot gratis inkomende SMS-berichten; onze tarieven blijven betaalbaar.</p>
                </div>
                ...
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        ...
                        <div class="sp description">Per gestuurd bericht naar Philippines</div>
                    </div>
                    <div class="statistic">
                ...
                <a href="sms\pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;sms&quot;});">Bekijk onze tarieven voor SMS ⇢</a>

        </div>

        <div class="col-md-6">

                <div class="credits-tier-container">
                    <h3 class="page-section-heading">Staffelprijzen per credit</h3>
                    <p class="lp">Via credits ontvang je een hogere korting naarmate je meer inkoopt. Wil je meer dan 100.000 credits inkopen dan kun je contact opnemen met ons <a href="contact-sales.htm">Salesteam</a>.</p>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Meer weten over <span style="font-weight: 900;">SMS</span>?<br> Neem contact op met ons salesteam.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/nl-be/sms#contact-form">
                            <input type="hidden" name="_csrf" value="_Dk5qP226PmetuuKLOBgZmAiClCEbLBXQ_8XyxC6vOtx88_1NR2rEKlJ053eN8qoXjPuB4Vge9y1IOSsrlclLA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
