...
<html lang="nl-be">
    <head>
        ...
        <title>Voice - MessageBird</title>
        <meta name="description" content="Integreer onze Voice API van enterprise-niveau om je app of website aan te sluiten aan het meest betaalbare en schaalbare communicatie platform in de cloud.">
    ...
    <meta name="csrf-token" content="6Wgy2ZXwlGR5WrQJbL1-j5sKbQE1PRDSHIonejqcPa1kosSEXVvXjU6ljB6eatRBpRuJVjQx21nqVdQdhHGkag==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="Integreer onze Voice API van enterprise-niveau om je app of website aan te sluiten aan het meest betaalbare en schaalbare communicatie platform in de cloud.">
        <meta property="og:url" content="https://www.messagebird.com/nl-be/voice">
        ...
        <meta name="twitter:description" content="Integreer onze Voice API van enterprise-niveau om je app of website aan te sluiten aan het meest betaalbare en schaalbare communicatie platform in de cloud.">
        

        <script type="text/javascript">window.page = 'voice-calling';</script>
...
ga('send', 'pageview');
        ...
        </script><script type="text/javascript">analytics.page("", {route: "app/pages/voice"});</script><script type="text/javascript">
            var _user_id = "";
                                ...
                                <div class="floater flex-end">
                                    <div class="flex-c-v js-stick-toggle" style="display: none;">
                                        ...
                                        <h3 style="display: inline-block;
                                            ...
                                            margin-left: 15px;
                                            font-size: 18px;
                                            color: #24374e;">Voice</h3>
                                    </div>

            	                    <ul>
                                        <li><span class="active">Gerelateerd</span></li>

            	                    	            	                    		<li>
            	                    			<a href="nummers.htm">
            	                    				Numbers & Shortcodes            	         						</a>
            	                    		</li>
            	                    	            	                    		<li>
            	                    			<a href="voice\pricing.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;voice&quot;});">
            	                    				Voicetarieven            	         						</a>
            	                    		</li>
            	                    	            	                    		<li>
            	                    			<a target="_blank" href="https://developers.messagebird.com" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;voice&quot;});">
                        ...
                        <select onchange="if (this.value) window.location.href=this.value">
                            <option value="" disabled="" selected="">Kies jouw land
                                                            <optgroup label="Africa">
                                                                                <option value="/en-gh/voice" data-name-locale="English">
                                                Ghana                                            
                                                                                    <option value="/en-ke/voice" data-name-locale="English">
                                                Kenya                                            
                                                                                    <option value="/en-ng/voice" data-name-locale="English">
                                                Nigeria                                            
                                                                                    <option value="/en-ug/voice" data-name-locale="English">
                                                Uganda                                            
                                                                                    <option value="/en-zw/voice" data-name-locale="English">
                                                Zimbabwe                                            
                                                                        </optgroup>
                                                          <optgroup label="Asia">
                                                                                <option value="/en-hk/voice" data-name-locale="English">
                                                Hong Kong                                            
                                                                                    <option value="/en-sg/voice" data-name-locale="English">
                                                Singapore                                            
                                                                        </optgroup>
                                                          <optgroup label="Europe">
                                                                                <option value="/fr-be/voice" data-name-locale="Français">
                                                Belgique                                            
                                                                                    <option value="/nl-be/voice" data-name-locale="Vlaams">
                                                België                                            
                                                                                    <option value="/de-de/voice" data-name-locale="Deutsch">
                                                Deutschland                                            
                                                                                    <option value="/es-es/voice" data-name-locale="Español">
                                                España                                            
                                                                                    <option value="/fr-fr/voice" data-name-locale="Français">
                                                France                                            
                                                                                    <option value="/en-gi/voice" data-name-locale="English">
                                                Gibraltar                                            
                                                                                    <option value="/en-gg/voice" data-name-locale="English">
                                                Guernsey                                            
                                                                                    <option value="/en-ie/voice" data-name-locale="English">
                                                Ireland                                            
                                                                                    <option value="/en-im/voice" data-name-locale="English">
                                                Isle of Man                                            
                                                                                    <option value="/en-je/voice" data-name-locale="English">
                                                Jersey                                            
                                                                                    <option value="/nl/voice" data-name-locale="Nederlands">
                                                Nederland                                            
                                                                                    <option value="/en-gb/voice" data-name-locale="English">
                                                United Kingdom                                            
                                                                        </optgroup>
                                                          <optgroup label="North America">
                                                                                <option value="/en-bs/voice" data-name-locale="English">
                                                Bahamas                                            
                                                                                    <option value="/en-bz/voice" data-name-locale="English">
                                                Belize                                            
                                                                                    <option value="/en-bm/voice" data-name-locale="English">
                                                Bermuda                                            
                                                                                    <option value="/en-vg/voice" data-name-locale="English">
                                                British Virgin Islands                                            
                                                                                    <option value="/en-ca/voice" data-name-locale="English">
                                                Canada                                            
                                                                                    <option value="/en-ky/voice" data-name-locale="English">
                                                Cayman Islands                                            
                                                                                    <option value="/en-gd/voice" data-name-locale="English">
                                                Grenada                                            
                                                                                    <option value="/en-jm/voice" data-name-locale="English">
                                                Jamaica                                            
                                                                                    <option value="/en-pr/voice" data-name-locale="English">
                                                Puerto Rico                                            
                                                                                    <option value="/en-tt/voice" data-name-locale="English">
                                                Trinidad & Tobago                                            
                                                                                    <option value="/en-us/voice" data-name-locale="English">
                                                United States                                            
                                                                        </optgroup>
                                                          <optgroup label="Oceania">
                                                                                <option value="/en-au/voice" data-name-locale="English">
                                                Australia                                            
                                                                                    <option value="/en-gu/voice" data-name-locale="English">
                                                Guam                                            
                                                                                    <option value="/en-nz/voice" data-name-locale="English">
                                                New Zealand                                            
                                                                        </optgroup>
                                                          <optgroup label="South America">
                                                                                <option value="/en-gy/voice" data-name-locale="English">
                                                Guyana                                            
                                                                        </optgroup>
                                                    <optgroup label="Other">
                              <option value="/en/voice" data-name-locale="Rest of world">
                                  Rest of world
...
<div class="mb-voice voice new">
    <section class="hero page-section">
        <div class="container" style="z-index: 1;">
            <div class="row">
                <div class="col-md-6">

                    <h1 class="mb-page-title">Voice</h1>
                    <div class="xlp">
                        Programmeer een flow van stabiele digitale telefoongesprekken. Heb wereldwijd altijd heldere gesprekken met ons schaalbare mobiele netwerk in de cloud.                    </div>

                    <div class="page-section-btn-container">
                        <form id="index-signup" class="start" novalidate="true" action="https://dashboard.messagebird.com/app/nl-be/sign-up/" method="GET">
                            <span class="cta-form-input"><input name="email" class="js-fp-email-signup" type="email" required="true" placeholder="Vul je werk e-mail in" required=""></span>
                            <span class="cta-form-btn"><button class="btn btn-cta" type="submit">Aan de slag</button></span>

                            <div class="hero-sub-cta sp" style="margin-top: 15px;">Liever een persoonlijke offerte?  <a href="contact-sales.htm" class="page-section-link" style="margin-left: 5px;">Neem contact op ⇢</a></div>
                        </form>
                    </div>
                </div>

                <div class="col-md-6" style="perspective: 2000px;">

                    <div class="device-laptop hidden-xs hidden-sm">
                        <div class="device-laptop-screen">

                            <div class="device-laptop-mockup voice-example clearfix">

                                <div class="mockup-header">
                                    <div class="mockup-header-search center-center">www.your-website.com</div>
                                    <div class="mockup-header-menu"></div>
                                </div>
                                ...
                                <div class="mockup-body">
                                    <div class="mockup-laptop">
                                        ...
                                        <div class="mockup-number">+1 (123) 456 7890</div>
                                        <ul class="mockup-buttons clearfix">
                                            <li><i class="fa fa-microphone-slash" aria-hidden="true"></i></li>
                                            <li><span>REC</span></li>
                                            <li class="hang-up"><i class="fa fa-phone" aria-hidden="true"></i></li>
                                            <li><i class="fa fa-th" aria-hidden="true"></i></li>
                                        </ul>

                                        <div class="mockup-bottom-nav">
                                            <i class="fa fa-comments" aria-hidden="true"></i> View conversation
                                        </div>
                                        <div class="mockup-signal">
                    ...
                    <img class="hidden-xs hidden-sm" width="970" style="position: absolute;top: 365px;right: 0;" src="https://cdn-gc.messagebird.com/assets/images/2017/wiggly-voice.svg">
                </div>
            </div>
        </div>
            ...
            <div class="device-screen">
                ...
                <div class="device-ui">
                    <div class="device-ui-status-bar">
                        ...
                        <div class="device-phone-mockup voice-example">
	<div class="mockup-body center-center">
	    <div class="mockup-avatar"></div>
	    <div class="mockup-number">+1 (123) 456 7890</div>
	    <ul class="mockup-buttons clearfix">
	        <li><i class="fa fa-microphone-slash" aria-hidden="true"></i></li>
                ...
                <div class="col-md-8">
                    <div class="row flex">
                        <header class="col-xs-12 text-center">
                            ...
                            <h2 class="page-section-heading">Creëer unieke interacties met Voice</h2>
                        </header>

                        <div class="pane">
                            <h4 class="features-label">Voiceberichten</h4>
                            <p class="benefits-copy sp">Bereik al je klanten per telefoon met ons meertalige text-to-speech platform.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">In-app Bellen</h4>
                            <p class="benefits-copy sp">Klanten kunnen direct de klantenservice bellen, gewoon vanuit jouw app.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Automatisch Doorverbinden</h4>
                            <p class="benefits-copy sp">Laat klanten je bereiken op een door jou gekozen bestemming door je nummer te porteren. Of gebruik een van onze lokale of tolvrije nummers.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Callcenters</h4>
                            <p class="benefits-copy sp">Verlaag de kosten van je bestaande locatiegebonden oplossing of bouw je eigen multi-channel callcenter met onze schaalbare Voice API.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Anonieme Communicatie</h4>
                            <p class="benefits-copy sp">Bescherm de privacy van je klanten en medewerkers. Verbind hen zonder persoonlijke gegevens en identiteiten uit te wissellen.</p>
                        </div>

                        <div class="pane">
                            <h4 class="features-label">Deel Meldingen</h4>
                            <p class="benefits-copy sp">Deel belangrijke informatie via voiceberichten. Maak het persoonlijk met text-to-speech of een vooraf opgenomen bericht. </p>
                        </div>
...
<section class="page-section" id="pdf">
    <div class="container">
        <header class="pane col-md-12 text-center">
            <h4 class="page-section-tag">Voice, opgelost</h4>
            <h2 class="page-section-heading">Waarom MessageBird Voice Gebruiken?</h2>
        </header>
        <div class="row">
            ...
            <div class="col-md-7 pane">
                ...
                <div class="read-more-container js-read-more-container">
                    ...
                    <p class="lp">De Voice API van MessageBird stelt bedrijven in staat om schaalbare voice-functionaliteiten toe te voegen aan vrijwel elke app, elke website of elk communicatiesysteem. Wij werken nauw samen met honderden mobiele providers over de hele wereld. Hierdoor kan ons netwerk stabiele, globale verbindingen faciliteren en hebben we toegang tot lokale nummers in alle relevante markten.</p><h4 class="features-label">Stabiel Netwerk</h4><p class="lp">Ons platform zorgt altijd voor stabiele, helder klinkende telefoongesprekken. Wij hebben een flexibel netwerk gebouwd dat alle standaard compressie-codecs ondersteunt. Ook industriestandaarden zoals het SIP Protocol voor VoIP worden volledig ondersteund. Verder gebruiken we een low latency-architectuur met een adaptief jitter-buffer algoritme en least-cost routing technologie.</p><h4 class="features-label">Gebruiksvriendelijke API</h4><p class="lp">Als aanvulling op ons netwerk van enterprise-niveau, zit onze gebruiksvriendelijke API boordevol extra functionaliteiten. Deze functionaliteiten geven developers de mogelijkheid om schaalbare voice-toepassingen te bouwen die jouw bedrijf verder helpen. We worden al vertrouwd door een aantal van de grootste namen in de tech-industrie. En we zijn pas net begonnen.</p>
            ...
            <div class="col-md-5">
                <div style="margin: 0 auto; max-width: 300px;">
                    <img class="support-img" src="https://cdn-gc.messagebird.com/assets/images/2017/voice_why.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/voice_why@2x.png 2x" width="300" style="margin-bottom: 30px;">
	...
	<a href="#" data-toggle="modal" data-target="#voice-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;voice&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Ontvang Voice PDF ⇢</span>
    ...
    <div class="container">
        <div class="row flex">
           <header class="col-md-12 text-center">
                ...
                <h2 class="page-section-heading">Optimaliseer je Voice-ervaring</h2>
            </header>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-voice-sip.svg">
                    
                    Gesprekken met SIP-protocol</h4>
	                <p class="benefits-copy sp">Gebruik jouw eigen nummer om een gratis gesprek naar elke SIP URI te beginnen via het internet.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-voice-billing.svg">
                    
                    Per Seconde Afrekenen</h4>
	                <p class="benefits-copy sp">Betaal bij ons geen seconde langer dan de daadwerkelijke duur van het gesprek. </p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-voice-playback-2.svg">
                    
                    Audio Playback</h4>
	                <p class="benefits-copy sp">Upload audiobestanden die automatisch afspelen zodra je door een klant wordt gebeld.</p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-voice-recording.svg">
                    
                    Gesprekken Opnemen</h4>
	                <p class="benefits-copy sp">Laat inkomende bellers een bericht achterlaten of neem de gesprekken op. </p>
            	...
            	<div class="pane">
	                <h4 class="features-label">
                                            ...
                                            <img width="20" class="label-icon" src="..\assets\assets-images\icons\500\20pt24box\mb-icon-voice-answermachine.svg">
                    
                    Antwoordapparaatherkenning</h4>
	                <p class="benefits-copy sp">Herken antwoordapparaten automatisch. Kies om op te hangen of een bericht achter te laten.</p>
            	...
            	<div class="pane">
                    ...
                    Text to Speech</h4>
	                <p class="benefits-copy sp">Maak custom voice-berichten in elk van de 20 beschikbare talen die automatisch afspelen.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/voice-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/voice-pricing@2x.png 2x" height="75">
                    <h3 class="page-section-heading new">Concurrerende prijzen voor Voice</h3>
                    <p class="lp">Wij bieden stabiele telefoonverbindingen tegen concurrerende prijzen. We factureren per seconde om je belkosten zo voordelig mogelijk te houden.</p>
                </div>
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        ...
                        <div class="js-pricing-placing-a-call number">
                           0.1327                        </div> <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Houd er er rekening mee dat deze prijs een landelijk gemiddelde is. Prijzen kunnen per provider variëren. "></i>
                        <div class="sp description">Per minuut als je belt in Philippines</div>
                    </div>
                    <div class="statistic">
                        <div class="js-currency currency number">
                            $
                        </div>
                        <div class="js-pricing-receiving-a-call number">
                            0.0031                        </div> <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Houd er er rekening mee dat deze prijs een landelijk gemiddelde is. Prijzen kunnen per provider variëren. "></i>
                        <div class="sp description">Per minuut als je belt in Philippines</div>
                    </div>
                </div>

                <a href="voice\pricing.htm" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;voice&quot;});">Bekijk Voicetarieven ⇢</a>
                ...
                <div class="article">
                    <img src="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing.png" srcset="https://cdn-gc.messagebird.com/assets/images/2017/numbers-pricing@2x.png 2x" height="75">
                                            ...
                                            <h3 class="page-section-heading new">Lokale Voice-Inschakeling </h3>
                    
                    <p class="lp">Dankzij onze samenwerking met providers over de hele wereld, kun jij gebruik maken van betaalbare lokale nummers in 50+ landen.</p>
                </div>
                <div class="statistics clearfix">
                    <div class="statistic separate">
                        <div class="js-currency currency number">
                        ...
                        <div class="sp description">Per PH Number per maand</div>
                    </div>
                    <div class="statistic">
                        <div class="flags">
                        ...
                        <div class="sp description">50+ landen ondersteund</div>
                    </div>
                </div>

                                    <a class="page-section-link new" href="nummers.htm" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;voice&quot;});">Meer over lokale nummers ⇢</a>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Meer weten over <span style="font-weight: 900;">Voice</span>?<br> Neem contact op met ons salesteam.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/nl-be/voice#contact-form">
                            <input type="hidden" name="_csrf" value="6Wgy2ZXwlGR5WrQJbL1-j5sKbQE1PRDSHIonejqcPa1kosSEXVvXjU6ljB6eatRBpRuJVjQx21nqVdQdhHGkag==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
