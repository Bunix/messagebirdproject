...
<html lang="de-de">
    <head>
        ...
        <title>Zwei-Faktor-Authentifizierung: Verstärkte Sicherheit. - MessageBird</title>
        <meta name="description" content="Schützen Sie sich vor unerwünschtem Zugriff mit Zwei-Faktor-Authentifizierung (2FA). Gratis testen - Sie verstärken die Sicherheit.">
    ...
    <meta name="csrf-token" content="l-Ml5k-zoRBg5MTRUnMNcCrruznqP4eisA8iHAe2l3QaKdO7hxji-Vcb_MagpKe-FPpfbuszTClG0NF7uVsOsw==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
                         ...
                         <link rel="canonical" href="zwei-factor-authentifizierung.htm">
        	...
        	<link rel="alternate" hreflang="de-de" href="zwei-factor-authentifizierung.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Zwei-Faktor-Authentifizierung: Verstärkte Sicherheit.">
        <meta property="og:description" content="Schützen Sie sich vor unerwünschtem Zugriff mit Zwei-Faktor-Authentifizierung (2FA). Gratis testen - Sie verstärken die Sicherheit.">
        <meta property="og:url" content="https://www.messagebird.com/de-de/zwei-factor-authentifizierung">
        ...
        <meta name="twitter:title" content="Zwei-Faktor-Authentifizierung: Verstärkte Sicherheit.">
        <meta name="twitter:description" content="Schützen Sie sich vor unerwünschtem Zugriff mit Zwei-Faktor-Authentifizierung (2FA). Gratis testen - Sie verstärken die Sicherheit.">
                                    ...
                                    <a href="..\en-us\two-factor-authentication.htm">
                                        <span>
                                            ...
                                            United States                                        </span>
                                                            ...
                                                            <li class="locale-modal-menu-item">
                                    <a href="zwei-factor-authentifizierung.htm">
                                        <span>
				...
				<div class="col-md-12 page-full-restraint">
					<div class="center-vertical">
						...
						<h1 class="page-full-heading">
							Zwei-Faktor-Authentifizierung						</h1>
						<p class="page-full-desc">Nehmen Sie Sicherheit ernst und nutzen Sie die Zwei-Faktor-Authentifizierung (2FA). Schicken Sie Ihren Kunden Einmalpasswörter, die diese bei der Anmeldung an Ihr System angeben müssen.</p>
						...
						<div class="row">
							<div class="col-md-4 text-left">
								...
								<p class="page-full-paragraph smaller text-center">Ihre Kunden geben beim Login ihre Telefonnummer ein.</p>
							</div>
							<div class="col-md-4">
								<div class="two-factor-step">
								...
								<p class="page-full-paragraph smaller text-center">Ein individueller Identifikationscode wird generiert und als SMS oder Sprachnachricht versandt.</p>
							</div>
							<div class="col-md-4">
								<div class="two-factor-step">
									<div class="two-factor-browser">
								...
								<p class="page-full-paragraph smaller text-center">Kunden können sich mit ihren speziellen Zugangsdaten einloggen.</p>
							</div>
						</div>

						<div class="two-factor-software-box">
							Verbinden Sie sich leicht mit der Software Ihrer Wahl:							<img src="https://cdn-gc.messagebird.com/assets/images/illustrations/icons/software/white/securenvoy.png">
						...
						<div class="page-full-button-box">
							...
							<span class="page-full-or">oder</span>
							<a href="contact-sales.htm" class="btn ghost hover">Den Vertrieb kontaktieren</a>
						</div>
