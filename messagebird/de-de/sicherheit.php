...
<html lang="de-de">
    <head>
        ...
        <title>Sicherheit: Schützen Sie Ihre Daten - MessageBird</title>
        <meta name="description" content="Wir liefern Ihre Nachrichten sehr verlässlich und stets gemäß lokal gültigen Regeln und Bestimmungen. Lesen Sie, wieso Ihre Daten bei uns sicher sind.">
    ...
    <meta name="csrf-token" content="xm2bpZdm0-G7REfJoOSUGo68YZ81tDX_CM8sUuK7-M1Lp234X82QCIy7f95SMz7UsK2FyDS4_nT-EN81XFZhCg==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
                         ...
                         <link rel="canonical" href="sicherheit.htm">
        	...
        	<link rel="alternate" hreflang="de-de" href="sicherheit.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Sicherheit: Schützen Sie Ihre Daten">
        <meta property="og:description" content="Wir liefern Ihre Nachrichten sehr verlässlich und stets gemäß lokal gültigen Regeln und Bestimmungen. Lesen Sie, wieso Ihre Daten bei uns sicher sind.">
        <meta property="og:url" content="https://www.messagebird.com/de-de/sicherheit">
        ...
        <meta name="twitter:title" content="Sicherheit: Schützen Sie Ihre Daten">
        <meta name="twitter:description" content="Wir liefern Ihre Nachrichten sehr verlässlich und stets gemäß lokal gültigen Regeln und Bestimmungen. Lesen Sie, wieso Ihre Daten bei uns sicher sind.">
...
<div class="security new">
	<section class="page-section hero text-center">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h4 class="page-section-tag">Sicherheit</h4>
					<h3 class="page-section-heading">Schützen Sie Ihre Daten</h3>
					<p class="lp hero-copy">Wir dürfen Krankenhäuser, Banken und sogar Regierungen zu unseren Kunden zählen. Denn die Themen Sicherheit und Datenschutz nehmen wir bei MessageBird sehr ernst. Ob es um die Beachtung lokaler Richtlinien, die Auswahl unserer Mitarbeiter oder die Datenverschlüsselung geht, um nur ein paar Bereiche zu nennen, die Sicherheit Ihrer Daten ist für uns das A und O. </p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="box hosting">
						<h4>Hosting</h4>
						<p>Ihre Nachrichten gelangen über eine sichere SSL-Verbindung zu unserer Plattform. Diese ist in zwei Tier-3-Rechenzentren bei kompletter Redundanz gehostet. Sobald eins offline geht, übernimmt das andere den gesamten Datenverkehr. Tägliche Backups aller Daten werden in einem dritten Rechenzentrum gespeichert.</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="box smartrouting">
						<h4>SmartRouting</h4>
						<p>Unser einmaliger SmartRouting-Algorithmus macht den Datenverkehr höchst effizient. Sobald sich bei unserem SMS Gateway ein Engpass bildet oder die Verbindungsqualität nachlässt, leitet SmartRouting den Verkehr automatisch um. So können Sie sich immer auf Top-Leistung verlassen. </p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="box monitoring">
						<h4>Monitoring</h4>
						<p>Wir überwachen die Leistung unseres Systems weltweit jeden Tag rund um die Uhr. Unser Service-Versprechen garantiert Ihnen eine 99,95%-ige Verfügbarkeit. Falls es doch einmal ein Serverproblem oder ähnliches gibt, erhalten wir sofort eine Warnung und fangen gleich an, das Problem zu beheben.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="page-section policies">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<h3 class="page-section-tag">Richtlinien</h3>
					<h2 class="page-section-heading">Ein sicheres Rechts- und Regelwerk</h2>
				</div>
				<div class="col-md-8 col-md-push-1">
					<div class="row">
						<div class="col-md-6">
							<img width="20" class="inline-block" src="https://cdn-gc.messagebird.com/assets/images/pages/security/icon_acm.svg">
							<h4 class="inline-block">Registriert bei der ACM</h4>
							<p>Wir sind bei der niederländischen Behörde für Konsumenten- und Marktschutz (ACM) registriert. Damit sind wir unseren Kunden gegenüber zu völliger Transparenz verpflichtet.</p>
						</div><div class="col-md-6">
							<img width="20" class="inline-block" src="https://cdn-gc.messagebird.com/assets/images/pages/security/icon_gsma.svg">
							<h4 class="inline-block">Mitglied der GSMA</h4>
							<p>Wir sind Mitglied der Groupe Speciale Mobile Association (GSMA), die weltweit die Interessen von Mobilfunkbetreibern vertritt.</p>
						</div><div class="col-md-6">
							<img width="30" class="inline-block" src="https://cdn-gc.messagebird.com/assets/images/pages/security/icon_data.svg">
							<h4 class="inline-block">Datenschutz</h4>
							<p>Alle Daten, die dazu dienen können lebende Personen zu identifizieren, sind durch das niederländische Datenschutzgesetz (Wbp) geschützt.</p>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="page-section employees text-center">
		<div class="container">
			<div class="row">
				<h4 class="page-section-tag">Vorsichtsmaßnahmen</h4>
				<h3 class="page-section-heading m-b-60">Bei uns sind Ihre Daten sicher</h3>
				...
				<div class="col-md-4">
					...
					<h4>Mitarbeiterauswahl</h4>
					<p>Bei der Einstellung neuer Mitarbeiter legen wir größtes Augenmerk auf Fachkenntnisse, Erfahrung und Integrität.</p>
				</div>
				<div class="col-md-4">
					<div class="icon">
						<img src="https://cdn-gc.messagebird.com/assets/images/pages/security/icon_eyes.svg" width="45">
					</div>
					<h4>Doppelte Kontrolle</h4>
					<p>Wann immer es um sensible Informationen oder wichtige Entscheidungen geht, wenden wir das Vier-Augen-Prinzip an.</p>
				</div>
				<div class="col-md-4">
					<div class="icon">
						<img src="https://cdn-gc.messagebird.com/assets/images/pages/security/icon_know.svg" width="45">
					</div>
					<h4>Need-to-Know-Prinzip</h4>
					<p>Sensible Daten handhaben wir bei MessageBird mit großer Sorgfalt. Wir greifen nur dann darauf zu, wenn es für unsere Arbeit nötig ist.</p>
				</div>
			</div>
		</div>
	</section>
