...
<html lang="de-de">
    <head>
        ...
        <title>Kontakt: Was können wir für Sie tun? - MessageBird</title>
        <meta name="description" content="Wir helfen Ihnen gerne! Nutzen Sie das Kontaktformular, rufen Sie an oder schicken Sie eine E-Mail. Wir haben Büros in London, Amsterdam, Hamburg und USA.">
    ...
    <meta name="csrf-token" content="qTjl4n9RcXhWhDIGJe1-nAfmrUqtRP-bezm0orwnYisk8hO_t_oykWF7ChHXOtRSOfdJHaxINBCN5kfFAsr77A==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
                         ...
                         <link rel="canonical" href="kontaktseite.htm">
        	...
        	<link rel="alternate" hreflang="de-de" href="kontaktseite.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Kontakt: Was können wir für Sie tun?">
        <meta property="og:description" content="Wir helfen Ihnen gerne! Nutzen Sie das Kontaktformular, rufen Sie an oder schicken Sie eine E-Mail. Wir haben Büros in London, Amsterdam, Hamburg und USA.">
        <meta property="og:url" content="https://www.messagebird.com/de-de/kontaktseite">
        ...
        <meta name="twitter:title" content="Kontakt: Was können wir für Sie tun?">
        <meta name="twitter:description" content="Wir helfen Ihnen gerne! Nutzen Sie das Kontaktformular, rufen Sie an oder schicken Sie eine E-Mail. Wir haben Büros in London, Amsterdam, Hamburg und USA.">
...
<div class="contact-support new">
    <section class="page-section hero">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-section-tag">Immer für Sie da</h4>
                    <h3 class="page-section-heading">Was können wir für Sie tun? </h3>
                </div>
                <div class="col-md-6">
                    <p class="hero-copy">Die am häufigsten gestellten Fragen beantworten wir Ihnen im <a href="http://support.messagebird.com/hc/de/" target="_blank">Kundencenter</a>. Sollte Ihre Frage nicht dabei sein, können Sie sich jederzeit direkt an uns wenden. Wir helfen gern!                    </p>
                </div><div class="col-md-6">
                <div class="row">
                                            <div class="col-md-5 col-md-push-1">
                            <h4>Telefonnummer</h4>
                            <h4 class="phonenum">+49 (0)40 8740 8847</h4>
                        </div>
                                                            <div class="col-md-5 col-md-push-1">
            ...
            <form class="form-group" id="contact" method="post" action="/de-de/kontaktseite">
            <div class="col-md-5">
                    <input type="hidden" name="_csrf" value="qTjl4n9RcXhWhDIGJe1-nAfmrUqtRP-bezm0orwnYisk8hO_t_oykWF7ChHXOtRSOfdJHaxINBCN5kfFAsr77A==">                    <div class="">
                      <label for="ContactForm[name]">Ihr Name</label>
                      <input type="text" value="" name="ContactForm[name]" class="form-control form-group" placeholder="Nachname, Vorname" required="">
                  </div>
                  <div class="">
                      <label for="ContactForm[email]">Ihre E-Mail-Adresse</label>
                      <input type="email" value="" name="ContactForm[email]" class="form-control form-group" placeholder="beispiel@mail.de" required="">
                  </div>
                  <div class="">
                      <label for="ContactForm[subject]">Ihr Anliegen</label>
                      <input type="text" value="" name="ContactForm[subject]" class="form-control form-group" placeholder="Worum geht es?" required="">
                  </div>
              ...
              <div class="col-md-7">
                <div class="">
                    <div class="message-wrap">
                        ...
                        <button type="submit" class="btn btn-cta hover pull-right">Absenden</button>
                    </div>
                </div>
            </form>
        </div>
        <div class="col-md-12 text-center">
            Sie haben eine Frage an den Vertrieb? <a class="talk-to" href="contact-sales.htm">Den Vertrieb kontaktieren</a>
        </div>
    </div>
</div>
</section>
...
<section id="offices" class="page-section contact-offices">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h3 class="page-section-tag">Niederlassungen</h3>
                <h2 class="page-section-heading">Hier finden Sie uns</h2>
                <p class="about-section-paragraph">Außer unserer Zentrale in Amsterdam sind wir auch in London, Hamburg, Miami und Sydney vertreten.  Und das ist erst der Anfang.</p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-centered">
                    <h2 class="page-section-heading">Sie trauen uns noch mehr zu?</h2>
                    <p>Sagen Sie es uns! Schreiben Sie unserem CEO direkt über seine virtuelle Handynummer.</p>
                    <div class="info">
                        <h4>SMS an Robert VIS, unseren CEO</h4>
                        <span class="phone-number">+49 177 178 38 80</span>
                    </div>
                </div>
            </div>
        </div>
