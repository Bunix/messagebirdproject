...
<html lang="de-de">
    <head>
        ...
        <title>Echte Erfahrungsberichte, direkt von unseren Kunden. - MessageBird</title>
        <meta name="description" content="Fiat, Levi's, Securitas and TomTom verbesserten ihre Kommunikation mit unseren Diensten. Lesen Sie unsere Kundenberichte und testen Sie uns selbst, gratis.">
    ...
    <meta name="csrf-token" content="sxH0yOY7N8KMWTdPpf8X6erHTCmXsrVhQBJn-C5mMvc-2wKVLpB0K7umD1hXKL0n1Naofpa-fuq2zZSfkIurMA==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
                         ...
                         <link rel="canonical" href="kunden.htm">
        	...
        	<link rel="alternate" hreflang="de-de" href="kunden.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Echte Erfahrungsberichte, direkt von unseren Kunden.">
        <meta property="og:description" content="Fiat, Levi's, Securitas and TomTom verbesserten ihre Kommunikation mit unseren Diensten. Lesen Sie unsere Kundenberichte und testen Sie uns selbst, gratis.">
        <meta property="og:url" content="https://www.messagebird.com/de-de/kunden">
        ...
        <meta name="twitter:title" content="Echte Erfahrungsberichte, direkt von unseren Kunden.">
        <meta name="twitter:description" content="Fiat, Levi's, Securitas and TomTom verbesserten ihre Kommunikation mit unseren Diensten. Lesen Sie unsere Kundenberichte und testen Sie uns selbst, gratis.">
    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-md-8 text-center">
                ...
                <h3 class="page-section-small-heading">Wir arbeiten mit über 15 000 Unternehmen </h3>
                <p class="cases-paragraph">Mehr als 15.000 Unternehmen verlassen sich gelegentlich oder täglich auf unser SMS Gateway. Ob Sie ein kleiner Laden aus der Nachbarschaft oder ein Marktführer in Ihrem Bereich sind - wir haben genau die richtige Lösung für Sie.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <section class="page-section no-border contact">
        <div class="container">
            <div class="row">
    			<div class="col-md-2">&nbsp;</div>
    			<div class="col-md-8 text-center">
                    <h4 class="page-section-tag">Beispiele aus der Praxis</h4>
                    <h3 class="page-section-small-heading">Echte Erfahrungsberichte, direkt von unseren Kunden.</h3>
                    <p class="cases-paragraph">Benachrichtigung, Interaktion, Authentifizierung - unsere Kunden nutzen unsere Lösungen für alle Kommunikationsbedürfnisse. Lesen Sie einige ihrer inspirierenden Geschichten und entdecken Sie, was SMS und Voice für Sie tun können.</p>
                </div>
            </div>
        </div>
    </section>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<p class="showcase-content">Auf der Fiat Webseite kann man sich anmelden zu einer Testfahrt. Bei dieser Anfrage gibt man ein bevorzugtes Automodell an, sowie Datum und Händler. Fiat's CRM Software schickt daraufhin sofort eine SMS Nachricht via unseren SMS Gateway zu dem Händler, der am ehesten die drei Kriterien erfüllt, so dass dieser entsprechend aktiv werden kann. </p>

									<a class="feature-link" href="/de-de/sms-gateway">Erfahren Sie mehr über unser SMS Gateway ⇢</a>
...
<div class="sms-conversation-bubble text-bubble client">
    <p>Anfrage Testfahrt: Fiat 500. Kontakt: John Smith, +44 7123 456 789. Gewünschtes Datum: 23-09</p>
...
<div class="sms-conversation-bubble text-bubble client">
    <p>Gratuliere! Du hast das Levi’s Outfit gewonnen, das Du gerade trägst. Zeig einem unserer Mitarbeiter diese SMS und Deinen Coupon und nimm es gleich mit.</p>
    <span class="sms-date">5 Sep</span>
</div>
																		</div>
			...
			<div class="col-sm-6">
				...
				<p class="showcase-content">Bei einer Aktion konnten Levi's Kunden das Outfit gewinnen, das sie gerade anprobierten. Dazu mussten sie das Keyword LEVIS zusammen mit einem individuellen Gutschein-Code an eine Kurzwahlnummer senden. Durch eine automatisierte Antwort-SMS erfuhren sie dann, ob sie gewonnen hatten. </p>

									<a class="feature-link" href="kurzwahlnummer.htm">Lesen Sie mehr zu Kurzwahl ⇢</a>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<p class="showcase-content">Kunden von TomTom können Ihre Produkte online registrieren, für Aktualisierungen und Support. Geht eine solche Anfrage ein, wird ein Identifizierungscode an die Telefonnummer, die bei der Registrierung angegeben wurde, gesendet. So kann TomTom prüfen, ob das betreffende Gerät auch tatsächlich dem jeweiligen Kunden gehört.  </p>

									<a class="feature-link" href="verify.htm">Lesen Sie mehr zu Verify ⇢</a>
...
<div class="sms-conversation-bubble text-bubble client">
    <p>Ihr Registriercode ist: 933019</p>
    <span class="sms-date">5 Sep</span>
</div>
																		</div>
