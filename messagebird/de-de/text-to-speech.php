...
<html lang="de-de">
    <head>
        ...
        <title>Text to Speech: Lassen Sie von sich hören. - MessageBird</title>
        <meta name="description" content="Schicken Sie Sprachnachrichten über unsere Webseite oder mit Ihrer eigenen Software bzw. App. Gratis testen, erreichen Sie das Festnetz ohne Probleme!">
    ...
    <meta name="csrf-token" content="rWp8Yy553mXaZIKWrqKIwn1e5mBoZ0f_Eku36CGor_AgoIo-5tKdjO2buoFcdSIMQ08CN2lrjHTklESPn0U2Nw==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
        	...
        	<link rel="alternate" hreflang="de-de" href="text-to-speech.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Text to Speech: Lassen Sie von sich hören.">
        <meta property="og:description" content="Schicken Sie Sprachnachrichten über unsere Webseite oder mit Ihrer eigenen Software bzw. App. Gratis testen, erreichen Sie das Festnetz ohne Probleme!">
        <meta property="og:url" content="https://www.messagebird.com/de-de/text-to-speech">
        ...
        <meta name="twitter:title" content="Text to Speech: Lassen Sie von sich hören.">
        <meta name="twitter:description" content="Schicken Sie Sprachnachrichten über unsere Webseite oder mit Ihrer eigenen Software bzw. App. Gratis testen, erreichen Sie das Festnetz ohne Probleme!">
...
<div class="text-to-speech new">
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-6 hero-copy">
                 ...
                 <h2 class="hero-sub-title">Über unseren Web-Dienst und unsere API können Sie bequem Sprachmitteilungen versenden. Sie geben Ihren Text ein, wir wandeln ihn in Sprache um und leiten ihn als Anruf an den Kunden weiter. Wenn er abnimmt, hört er ihre Nachricht automatisch ab.</h2>
              </div>
              <div class="col-md-6">
                  <div class="pricing-box">

                                        <div class="text-center" style="height:0;">
                      <h4 class="pill pill-blue">1 Sprachnachricht kostet 1,3 Credits. </h4>
                    </div>
                      ...
                      <div class="row">
                              ...
                              <div class="col-md-6">
                                  <div class="pricing-box-sending">
                                      <h3 class="pricing-box-tag">Nachrichtenversand</h3>
                                      <h2 class=""><span class="price-cent js-price">-</span>€</h2><span class="spaced"> / Nachricht</span>
                                  </div>
                              </div>
                              <div class="col-md-6">
                                  <div class="pricing-box-receiving">
                                      <h3 class="pricing-box-tag">Nachrichtenempfang <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Der Empfang von Nachrichten an Ihre virtuelle Handy- oder Kurzwahlnummer ist kostenlos. Beim Absender fallen für den Versand jedoch unter Umständen Kosten durch seinen eigenen Anbieter an. "></i></h3>
                                      <h2>Kostenlos</h2>
                                  </div>
                              </div>

                              <div class="col-md-12 text-center pick-country">
                                  <span class="spaced">Ich möchte </span>
                                  ...
                                  <span class="spaced suffix">Nachrichten versenden</span>
                              </div>

                                                </div>
                  </div>

                  <form id="voice-signup" class="start" novalidate="true" action="https://dashboard.messagebird.com/app/de-de/sign-up/" method="GET">
                  ...
                  <p class="spaced text-center">Keine Einrichtungsgebühr. Keine monatlichen Grundkosten.</p>
              </div>
          </div>
      </div>
  </section>
  ...
  <section class="page-section potential demo text-center">
        <div class="container">
            ...
            <h2 class="page-section-heading">Hören Sie selbst</h2>
            <div class="row">
                <div class="tabs text-center">
                    <div class="col-md-2  col-xs-4">
                        <button class="tab" data-item="authenticate" data-toggle="pill" href="#authenticate">Authentifizieren </button>
                    </div><div class="col-md-2  col-xs-4">
                        <button class="tab active" data-item="notify" data-toggle="pill" href="#notify">Benachrichtigen</button>
                    </div><div class="col-md-2  col-xs-4">
                        <button class="tab" data-item="promote" data-toggle="pill" href="#promote">Werben</button>
                    </div>
                </div>
                <div class="tab-content col-md-6 col-md-push-3">
                    <p id="authenticate" class="tab-pane">Für alles, was privat bleiben soll, gibt es die Zwei-Faktor-Authentifizierung per Sprachnachricht. Sie macht die Kommunikation für Sie und Ihre Kunde besonders sicher.</p>
                    <p id="notify" class="tab-pane active">Ein kurzer Anruf und Ihre Kunden sind auf dem Laufenden. Erinnern Sie sie an Termine oder teilen Sie Ihnen wichtige Neuigkeiten mit. </p>
                    <p id="promote" class="tab-pane">Sie möchten den nächsten Schlussverkauf, ein neues Produkt oder Event bewerben? Mit einer Sprachnachricht machen Sie Ihre Zielgruppe neugierig und erreichen so viele Kunden auf einmal, wie sie wollen.</p>
                </div>
            </div>
        </div>
                ...
                <div id="authenticate" class="device phone black off">
                    ...
                    <div class="screen">
                        <div class="top-bar text-center">
                            <div class="system">
                                12:33                                <i class="fa fa-battery-half pull-right"></i>
                            </div>
                        </div>
                        <div class="voice-demo">
                          <div class="voice-demo-card">
                            ...
                            <h3 class="voice-demo-company">MetropolBank</h3>
                            <h4 class="voice-demo-state js-state" style="opacity: 0;"> ruft an </h4>

                                                                <audio id="js-demo1" class="demo" type="audio/mpeg" src="https://cdn-gc.messagebird.com/assets/media/de-de1.mp3"></audio>
                               
                            <button type="button" class="btn btn-blue js-voice-demo js-voice-demo-1">Abspielen</button>
                          </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="screen">
                        ...
                        <div class="voice-demo">
                          <div class="voice-demo-card">
                            ...
                            <h3 class="voice-demo-company">Praxis Dr. Sattler</h3>
                            <h4 class="voice-demo-state js-state" style="opacity: 0;"> ruft an </h4>

                                                                <audio id="js-demo2" class="demo" type="audio/mpeg" src="https://cdn-gc.messagebird.com/assets/media/de-de2.mp3"></audio>
                               
                            <button type="button" class="btn btn-blue js-voice-demo js-voice-demo-2">Abspielen</button>
                            <div class="js-stop" style="display: none;">Anhalten</div>
                          </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="screen">
                        ...
                        <div class="voice-demo">
                          <div class="voice-demo-card">
                            ...
                            <h3 class="voice-demo-company">Optik Blickfang</h3>
                            <h4 class="voice-demo-state js-state" style="opacity: 0;"> ruft an </h4>

                                                                <audio id="js-demo3" class="demo" type="audio/mpeg" src="https://cdn-gc.messagebird.com/assets/media/de-de3.mp3"></audio>
                               
                            <button type="button" class="btn btn-blue js-voice-demo js-voice-demo-3">Abspielen</button>
                          </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <h3 class="page-section-tag">Ihre Vorteile</h3>
                <h2 class="page-section-heading">Umfangreiche Funktionen</h2>
                <div class="col-md-9">
                        ...
                        <ul>
                          <li class="active">
                              <a data-toggle="tab" href="#callerid">
                                  ...
                                  <p class="dashboard-showcase-note-text">In den meisten Ländern wird die individuelle Anruferkennung unterstützt. Personalisieren Sie die Kennung, damit Ihre Kunden gleich sehen, wer anruft. Näheres zu den einzelnen Ländern finden Sie unter <span class="link js-link" href="http://support.messagebird.com/hc/en-us/sections/202017565-Country-Info-Restrictions" target="_blank">Länderinformationen & Beschränkungen</span>.</p>
                              </a>
                          </li>
                          <li>
                              <a data-toggle="tab" href="#languages">
                                  <h3 class="dashboard-showcase-note-title">Sprachen</h3>
                                  <p class="dashboard-showcase-note-text">Neben Deutsch können Sie aus 18 weiteren Sprachen wählen - alle jeweils mit weiblicher und männlicher Stimme.</p>
                              </a>
                          </li>
                        </ul>
                    </div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<h3 class="page-section-heading">REST-API integrieren leicht gemacht</h3>

				<p class="code-example-content lp">Unsere Lösungen für SMS, Chat und Voice lassen sich problemlos in Ihr CRM-System, Ihre Website oder App integrieren. Für Entwickler haben wir alle wichtigen Informationen zusammengestellt. Erfahren Sie hier, wie Sie sich mit über 900 Betreibern weltweit vernetzen können.</p>

                
									<a class="page-section-link" href="https://developers.messagebird.com/docs/voice" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;tts&quot;});">Zu den Entwickler-Dokumentationen ⇢</a>
                ...
                <div class="col-md-6 not-on-mobile" id="contact-form">
                    <div>
                        <h3 class="page-section-small-heading">Den Vertrieb kontaktieren</h3>
                            ...
                            <form class="form-group contact-form" id="contact" method="post" action="/de-de/text-to-speech#contact-form">
                                <input type="hidden" name="_csrf" value="rWp8Yy553mXaZIKWrqKIwn1e5mBoZ0f_Eku36CGor_AgoIo-5tKdjO2buoFcdSIMQ08CN2lrjHTklESPn0U2Nw==">                                <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
