...
<html lang="en-bm">
    ...
    <meta name="csrf-token" content="0u2p31TK3fagIuEFKiH9wTHuD52Cj111yACEbihwz71fJ1-CnGGeH5fd2RLY9lcPD__ryoODlv4-33cJlp1Weg==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-bm/pricing">
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="sms.htm#pdf">SMS</a>, <a href="verify.htm#pdf">Verify</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-bm/chat#pdf">Chat</a>.</p>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="voice.htm#pdf">Voice</a>, <a href="verify.htm#pdf">Verify</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-bm/chat#pdf">Chat</a>.</p>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                        ...
                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-bm/pricing#contact-form">
                            <input type="hidden" name="_csrf" value="0u2p31TK3fagIuEFKiH9wTHuD52Cj111yACEbihwz71fJ1-CnGGeH5fd2RLY9lcPD__ryoODlv4-33cJlp1Weg==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
