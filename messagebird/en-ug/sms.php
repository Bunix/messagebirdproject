...
<html lang="en-ug">
    ...
    <meta name="csrf-token" content="g8ynoN1K5CK6YnHEXd2NJrw7b57AqKH4rKX1q58uJ1MOBlH9FeGny42dSdOvCifogiqLycGkanNaegbMIcO-lA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-ug/sms">
                                        ...
                                        <li><span class="active">Related</span></li>
            	                    			...
            	                    			<a target="_blank" href="https://developers.messagebird.com" onclick="analytics.track('web:productDocsPressed', {&quot;page&quot;:&quot;sms&quot;});">
            	                    				Docs<i class="fa fa-external-link" aria-hidden="true"></i>            	         						</a>
            	                    	                                        ...
            	                    	                                        <li><a href="/en-ug/sign-up" class="btn btn-cta sticky-cta js-stick-toggle" style="display: none;">Get started now</a></li>
            	                    </ul>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="page-section-btn-container">
                        ...
                        <form id="index-signup" class="start" novalidate="true" action="https://dashboard.messagebird.com/app/en-ug/sign-up/" method="GET">
           ...
           <header class="col-md-12 text-center">
            	...
            	<div class="pane">
	                ...
	                <p class="benefits-copy sp">Access the next generation of SMS, with rich media and file-sharing capabilities.</p>
	                	                	...
	                	                	<a href="/en-ug/rcs" class="page-section-link">Explore RCS ⇢</a>
	                	            </div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                        ...
                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-ug/sms#contact-form">
                            <input type="hidden" name="_csrf" value="g8ynoN1K5CK6YnHEXd2NJrw7b57AqKH4rKX1q58uJ1MOBlH9FeGny42dSdOvCifogiqLycGkanNaegbMIcO-lA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
