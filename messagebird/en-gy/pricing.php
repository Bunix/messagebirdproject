...
<html lang="en-gy">
    ...
    <meta name="csrf-token" content="6hPI24DuHTjCq2SYhtyg12jpdMTmVN8yWjSEJiAoBX9n2T6GSEVe0fVUXI90CwoZVviQk-dYFLms63dBnsWcuA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-gy/pricing">
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="sms.htm#pdf">SMS</a>, <a href="verify.htm#pdf">Verify</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-gy/chat#pdf">Chat</a>.</p>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="voice.htm#pdf">Voice</a>, <a href="verify.htm#pdf">Verify</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-gy/chat#pdf">Chat</a>.</p>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                        ...
                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-gy/pricing#contact-form">
                            <input type="hidden" name="_csrf" value="6hPI24DuHTjCq2SYhtyg12jpdMTmVN8yWjSEJiAoBX9n2T6GSEVe0fVUXI90CwoZVviQk-dYFLms63dBnsWcuA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
