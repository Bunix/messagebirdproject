...
<html lang="es-es">
    <head>
        ...
        <title>Historias reales, directamente de nuestros clientes - MessageBird</title>
        <meta name="description" content="Fiat, Levi's, Securitas y TomTom mejoraron su comunicación gracias a nuestros servicios. Lee las experiencias de nuestros clientes y pruébalos gratis.">
    ...
    <meta name="csrf-token" content="lRVUaRxtyWeJXuj8iAhgMRCZQONDTUPKvQO7B624XzEY36I01MaKjr6h0Ot638r_LoiktEJBiEFL3EhgE1XG9g==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Historias reales, directamente de nuestros clientes">
        <meta property="og:description" content="Fiat, Levi's, Securitas y TomTom mejoraron su comunicación gracias a nuestros servicios. Lee las experiencias de nuestros clientes y pruébalos gratis.">
        <meta property="og:url" content="https://www.messagebird.com/es-es/clientes">
        ...
        <meta name="twitter:title" content="Historias reales, directamente de nuestros clientes">
        <meta name="twitter:description" content="Fiat, Levi's, Securitas y TomTom mejoraron su comunicación gracias a nuestros servicios. Lee las experiencias de nuestros clientes y pruébalos gratis.">
    ...
    <div class="container">
        <div class="row">
			...
			<div class="col-md-8 text-center">
                <h4 class="page-section-tag">Clientes</h4>
                <h3 class="page-section-small-heading">Trabajamos con más de 15000 empresas </h3>
                <p class="cases-paragraph">Más de 15000 empresas hacen uso de nuestra SMS Gateway, de forma ocasional o a diario. Tanto si tienes una tienda pequeña como una empresa líder en tu mercado, tenemos la solución que necesitas.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <section class="page-section no-border contact">
        <div class="container">
            <div class="row">
    			<div class="col-md-2">&nbsp;</div>
    			<div class="col-md-8 text-center">
                    <h4 class="page-section-tag">Casos</h4>
                    <h3 class="page-section-small-heading">Historias reales, directamente de nuestros clientes</h3>
                    <p class="cases-paragraph">Notificación, interacción, autenticación: nuestros clientes usan nuestras soluciones para todo tipo de comunicaciones. Inspírate leyendo sus historias y descubre lo que los mensajes SMS y de voz pueden significar para tu empresa.</p>
                </div>
            </div>
        </div>
    </section>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<p class="showcase-content">En el sitio web de Fiat puedes solicitar una prueba en carretera. Debes especificar el modelo, la fecha y el concesionario preferidos. El software CRM de Fiat envía directamente un mensaje SMS a través de nuestra SMS Gateway al concesionario que mejor se adapte a las preferencias del cliente.</p>

									<a class="feature-link" href="/es-es/sms-gateway">Lee más sobre nuestra SMS Gateway ⇢</a>
...
<div class="sms-conversation-bubble text-bubble client">
    <p>Petición para prueba de carretera: Fiat 500. Cliente: Juan Rodriguez, +34 123 456 789. Fecha preferida: 23-09.</p>
...
<div class="sms-conversation-bubble text-bubble client">
    <p>¡Enhorabuena! El conjunto Levi's que llevas puesto te acaba de salir gratis. Enseña tu vale y este SMS al personal de la tienda para demostrar que eres el ganador.</p>
    <span class="sms-date">5 Sep</span>
</div>
																		</div>
			...
			<div class="col-sm-6">
				...
				<p class="showcase-content">Levi’s ofreció a quienes visitaban sus tiendas la posibilidad de participar en un sorteo para que les saliera gratis el conjunto que se estaban probando si enviaban la palabra clave LEVIS y un código de bono único a un número corto compartido. Mediante una respuesta automática se les informaba si habían sido los ganadores.</p>

									<a class="feature-link" href="numero-corto.htm">Lee más sobre Número Corto ⇢</a>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<p class="showcase-content">Los clientes de TomTom pueden registrar sus productos online para actualizarlos y recibir soporte. Tras enviar una petición, se envía un código de autenticación al número de teléfono indicado al inscribirse. Así, TomTom puede comprobar si el dispositivo realmente pertenece a un cliente.</p>

									<a class="feature-link" href="verify.htm">Lee más sobre Verify ⇢</a>
...
<div class="sms-conversation-bubble text-bubble client">
    <p>Tu código de registro es: 933019</p>
    <span class="sms-date">5 Sep</span>
</div>
																		</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                                			...
                                			<p><span>Sin cuotas de inicio. Sin cuotas mensuales.</span><br>
