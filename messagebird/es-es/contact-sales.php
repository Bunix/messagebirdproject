...
<html lang="es-es">
    <head>
        ...
        <title>Habla directamente con el equipo de ventas. - MessageBird</title>
    ...
    <meta name="csrf-token" content="6R5rcDMGtuPLhf0QoXOeUUzZnEI5r3sVm0L9cxrFl-xk1J0t-631Cvx6xQdTpDSfcsh4FTijsJ5tnQ4UpCgOKw==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
        	...
        	<link rel="alternate" hreflang="es-es" href="contact-sales.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Habla directamente con el equipo de ventas.">
        <meta property="og:description" content="">
        <meta property="og:url" content="https://www.messagebird.com/es-es/contact-sales">
        ...
        <meta name="twitter:title" content="Habla directamente con el equipo de ventas.">
...
<section class="page-section hero">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-section-tag">Contacta con nosotros</h4>
                <h3 class="page-section-heading">¿En qué podemos ayudarte?</h3>
            </div>
            <div class="col-md-6">
                <p class="hero-copy">En nuestro <a href="http://support.messagebird.com/hc/es-es/" target="_blank">Centro de Ayuda</a> tenemos una lista de Preguntas Frecuentes en la que tal vez veas la respuesta a tus dudas. De todas maneras, si no encuentras lo que estás buscando, puedes escribirnos. ¡Estamos aquí para ayudarte!                </p>
            </div><div class="col-md-6">
                <div class="row">
                                    <div class="col-md-5 col-md-push-1">
                        <h4>Número de teléfono</h4>
                        <h4 class="phonenum">+34 931 816 015</h4>
                    </div>
                                                    <div class="col-md-5 col-md-push-1">
            ...
            <form class="form-group" id="contact" method="post" action="/es-es/contact-sales">
            <div class="col-md-5">
                    <input type="hidden" name="_csrf" value="6R5rcDMGtuPLhf0QoXOeUUzZnEI5r3sVm0L9cxrFl-xk1J0t-631Cvx6xQdTpDSfcsh4FTijsJ5tnQ4UpCgOKw==">                    <div class="">
                        <label for="ContactForm[name]">Tu nombre</label>
                        <input type="text" value="" name="ContactForm[name]" class="form-control form-group" placeholder="Juan López" required="">
                    </div>
                    <div class="">
                        <label for="ContactForm[email]">Tu correo electrónico</label>
                        <input type="email" value="" name="ContactForm[email]" class="form-control form-group" placeholder="juan@gmail.com" required="">
                    </div>
                    <div class="">
                        <label for="ContactForm[phonenumber]">Tu número de teléfono</label>
                        <input type="text" value="" name="ContactForm[phonenumber]" class="form-control form-group" placeholder="+34 12 345 67 89" required="">
                    </div>
                    <div class="">
                        <label for="ContactForm[company]">Empresa</label>
                        <input type="text" value="" name="ContactForm[company]" class="form-control form-group" placeholder="Tuempresa SA" required="">
                    </div>
            ...
            <div class="col-md-7">
                <div class="">
                        <div class="message-wrap">
                            ...
                            <button type="submit" class="btn btn-cta hover pull-right">Enviar</button>
                        </div>
                    </div>
            </div>
            </form>
            <div class="col-md-12 text-center">
                ¿Tienes cualquier pregunta? <a class="talk-to" href="pagina-de-contacto.htm">Habla con nuestro servicio técnico</a>
            </div>
        </div>
    </div>
</section>
...
<section class="page-section contact-team text-center">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="page-section-tag">Equipo de ventas</h3>
                <h2 class="page-section-heading">Conoce a nuestro equipo</h2>
                <p class="about-section-paragraph">Uno de nuestros compañeros de ventas responderá a tu consulta. Como todos recibirán tu mensaje, te responderá la persona más adecuada para tu caso. Si quieres, también puedes contactarles directamente a través de su perfil en LinkedIn.</p>
...
<section class="page-section contact-offices">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h3 class="page-section-tag">Nuestras oficinas</h3>
                <h2 class="page-section-heading">¿Dónde estamos?</h2>
                <p class="about-section-paragraph">Además de nuestra sede central en Ámsterdam, también tenemos oficinas en Hamburgo, Londres, Sydney y Miami. ¡Y esto es sólo el comienzo!</p>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-centered">
                <h2 class="page-section-heading">¿Crees que podemos mejorar en algo?</h2>
                <p>Nuestro CEO espera tus sugerencias. ¡Escríbele a su propio número!</p>
                <div class="info">
                    <h4>Escríbele a Robert, nuestro CEO</h4>
                    <span class="phone-number">+34911067161</span>
                </div>
            </div>
        </div>
    </div>
