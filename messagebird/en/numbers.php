...
<html lang="en">
    ...
    <meta name="csrf-token" content="DHGVEe0_lWZHa4KqFAELGpCH7KKDaoDQce52mkdjLv-Bu2NMJZTWj3CUur3m1qHUrpYI9YJmS1uHMYX9-Y63OA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en/numbers">
            ...
            <div class="device-screen">
                ...
                <div class="device-ui">
                    <div class="device-ui-status-bar">
                        10:36                        <i class="fa fa-signal" aria-hidden="true" style="right: 20px;"></i>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.php#pdf">Pricing</a>, <a href="sms.php#pdf">SMS</a>, <a href="voice.php#pdf">Voice</a>, <a href="verify.php#pdf">Verify</a>, <a href="lookup.php#pdf">Lookup</a>, <a href="numbers.php#pdf">Short Code</a> and <a href="/en/chat#pdf">Chat</a>.</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="pane col-md-4">
                            ...
                            <a href="pricing.php" class="page-section-link" style="">Check out Numbers pricing ⇢</a>
                        </div>
                        <div class="col-md-8">
                            <div class="row flex">
                                <div class="pane">
                ...
                <div class="container">
                    <div class="row">
                        <div class="pane col-md-4">
                            ...
                            <a href="pricing.php" class="page-section-link" style="">Check out Short code pricing ⇢</a>
                        </div>
                        <div class="col-md-8">
                            <div class="row flex">
                                <div class="pane">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row contact-sales-wrap">
                        <div class="text-center">
                            <a href="contact-sales.php" class="page-section-link">Don’t see your country? Contact sales ⇢</a>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <a href="sms\pricing.php" class="btn btn-cta" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;numbers&quot;});">Check out SMS pricing ⇢</a>
            ...
            <div class="col-sm-6">
                ...
                <a class="page-section-link new" style="margin-top: 5px;" href="voice.php" onclick="analytics.track('web:productPricingPressed', {&quot;page&quot;:&quot;numbers&quot;});">Learn more about Voice ⇢</a>
            </div>
