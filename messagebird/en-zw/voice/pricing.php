...
<html lang="en-zw">
    <head>
        ...
        <title>Voice Pricing - MessageBird</title>
    ...
    <meta name="csrf-token" content="oHc6SXnFx9wE7nTwPFJjKS_PHqI0sMnQEsjDbH9sziMtvcwUsW6ENTMRTOfOhcnnEd769TW8AlvkFzALwYFX5A==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Voice Pricing">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-zw/pricing-voice">
        ...
        <meta name="twitter:title" content="Voice Pricing">
...
<div class="dropdown-footer">
    <ul>
        ...
        <li role="presentation">
            <a role="menuitem" tabindex="-1" href="..\numbers.htm" onclick="analytics.track('web:navProductPressed', {&quot;page&quot;:&quot;numbers&quot;});">
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Place and receive programmable calls on our fault-tolerant VoIP platform. Billed per second with free calls to SIP URIs.        </p>
    ...
    <div class="col-md-8">
    		...
    		<div class="col-md-4">
	            <h3 class="pricing-table-sub-heading">Numbers</h3>
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <h3 class="pricing-table-heading">
        	Voice Messaging        </h3>
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Share your campaigns, notifications and alerts via voice message in any of our 20 offered languages.        </p>
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <h3 class="pricing-table-heading">
        	Answering Machine Detection        </h3>
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Automatically detect whether phones are mobile or landline and optionally leave a message.        </p>
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <h3 class="pricing-table-heading">
        	Lookup and HLR        </h3>
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Immediately retrieve accurate, detailed information on roaming, validity and more about any number in the world.        </p>
    ...
    <div class="container">
        <div class="row">
            <header class="text-center">
                ...
                <h2 class="page-section-heading">Download our Voice and Numbers overviews</h2>
            </header>
        </div>
        <div class="row">
            <div class="col-md-6">
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="..\pricing.htm#pdf">Pricing</a>, <a href="..\sms.htm#pdf">SMS</a>, <a href="..\verify.htm#pdf">Verify</a>, <a href="..\lookup.htm#pdf">Lookup</a>, <a href="..\numbers.htm#pdf">Numbers</a>, <a href="..\numbers.htm#pdf">Short Code</a> and <a href="/en-zw/chat#pdf">Chat</a>.</p>
...
<div class="document-download">
	<a href="#" data-toggle="modal" data-target="#numbers-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;numbers&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-icon third"></div>
			<div class="document-download-desc">
				<span class="page-section-link">Download Numbers overview ⇢</span>
				<p class="sp">Share our Numbers Overview with your team</p>
			</div>
		</div>
	</a>
</div>
			...
			<div class="modal-body lp">
				...
				<div class="row">
					<div class="col-md-7">
						...
						<h1 class="mb-page-title">Get the Numbers Overview</h1>
<p class="lp">Find out more about what MessageBird Numbers can do for your business. Enter your email below and we’ll send a PDF directly to your inbox.</p>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="..\pricing.htm#pdf">Pricing</a>, <a href="..\sms.htm#pdf">SMS</a>, <a href="..\voice.htm#pdf">Voice</a>, <a href="..\verify.htm#pdf">Verify</a>, <a href="..\lookup.htm#pdf">Lookup</a>, <a href="..\numbers.htm#pdf">Short Code</a> and <a href="/en-zw/chat#pdf">Chat</a>.</p>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">Voice Pricing</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-zw/voice/pricing#contact-form">
                            <input type="hidden" name="_csrf" value="oHc6SXnFx9wE7nTwPFJjKS_PHqI0sMnQEsjDbH9sziMtvcwUsW6ENTMRTOfOhcnnEd769TW8AlvkFzALwYFX5A==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
