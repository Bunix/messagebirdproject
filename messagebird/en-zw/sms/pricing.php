...
<html lang="en-zw">
    <head>
        ...
        <title>SMS Pricing - MessageBird</title>
    ...
    <meta name="csrf-token" content="CWIsZni32ctRg7jfZ90jG0C8uTM8gTgz18nmSig33WeEqNo7sByaImZ8gMiVConVfq1dZD2N87ghFhUtltpEoA==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="SMS Pricing">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-zw/pricing-sms">
        ...
        <meta name="twitter:title" content="SMS Pricing">
    ...
    <div class="col-md-8">
        ...
        <div class="row pricing-table-row">
            <div class="col-md-4">
                ...
                <h3 class="pricing-table-heading">High-volume SMS</h3>
                <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">Access baseline bulk rates and ensure delivery of every last message via our fully redundant platform.</p>
            </div>
            <div class="col-md-8">

                <p class="high-vol-sms-perks"><img src="..\..\assets\assets-images\icons\500\20pt24box\mb-icon-checkmark.svg" width="20"> Guaranteed Service Level Agreements</p>
                <p class="high-vol-sms-perks"><img src="..\..\assets\assets-images\icons\500\20pt24box\mb-icon-checkmark.svg" width="20"> Dedicated Account Manager</p>
                <p class="high-vol-sms-perks"><img src="..\..\assets\assets-images\icons\500\20pt24box\mb-icon-checkmark.svg" width="20"> Custom routing configuration</p>
                <p class="high-vol-sms-perks"><img src="..\..\assets\assets-images\icons\500\20pt24box\mb-icon-checkmark.svg" width="20"> Bespoke solutions</p>

                <p class="sales-team">
                    Are you sending high volumes or have a custom enquiry?                    <br>
                    Get in touch with our <a href="..\contact-sales.htm">sales team</a>.                </p>
    ...
    <div class="container">
        <div class="row">
            <header class="text-center">
                ...
                <h2 class="page-section-heading">Download our SMS and Numbers overviews</h2>
            </header>
        </div>
        <div class="row">
            <div class="col-md-6">
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="..\pricing.htm#pdf">Pricing</a>, <a href="..\voice.htm#pdf">Voice</a>, <a href="..\verify.htm#pdf">Verify</a>, <a href="..\lookup.htm#pdf">Lookup</a>, <a href="..\numbers.htm#pdf">Numbers</a>, <a href="..\numbers.htm#pdf">Short Code</a> and <a href="/en-zw/chat#pdf">Chat</a>.</p>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">SMS Pricing</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-zw/sms/pricing#contact-form">
                            <input type="hidden" name="_csrf" value="CWIsZni32ctRg7jfZ90jG0C8uTM8gTgz18nmSig33WeEqNo7sByaImZ8gMiVConVfq1dZD2N87ghFhUtltpEoA==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
