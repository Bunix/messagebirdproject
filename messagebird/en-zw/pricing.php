...
<html lang="en-zw">
    <head>
        ...
        <title>Pricing - MessageBird</title>
        <meta name="description" content="No setup fees. No monthly fees. Easy worldwide payment by credit card, bank transfer, PayPal and more. Sign up and join 15.000+ companies.">
    ...
    <meta name="csrf-token" content="WmiCVpPgyGGM26UNHJ7x0V9JmDV11d-YEXHTtD7L08TXonQLW0uLiLsknRruSVsfYVh8YnTZFBPnriDTgCZKAw==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:description" content="No setup fees. No monthly fees. Easy worldwide payment by credit card, bank transfer, PayPal and more. Sign up and join 15.000+ companies.">
        <meta property="og:url" content="https://www.messagebird.com/en-zw/pricing">
        ...
        <meta name="twitter:description" content="No setup fees. No monthly fees. Easy worldwide payment by credit card, bank transfer, PayPal and more. Sign up and join 15.000+ companies.">
    ...
    <div class="container">
        <div class="row">
            <div class="flex-space">
                <h1 class="mb-page-title">Pricing</h1>
                <form id="country_picker">
                    <div class="form-item">
...
<section class="page-section pricing-tabs-section">
	<div class="container">
		<div class="pricing-tabs-tab active clearfix">
    		<a href="pricing.htm" onclick="analytics.track('web:pricingTabSelected', {&quot;tab&quot;:&quot;general&quot;});">
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Fast, reliable message delivery through our globally connected API.        </p>

                		<a class="page-section-link new" href="sms.htm">Learn more about SMS ⇢</a>
    ...
    <div class="col-md-8">
    		...
    		<div class="col-md-6">
	            <h3 class="pricing-table-sub-heading">Outbound</h3>

	            <div class="pricing-package-info">
	                <div class="pricing-package-box">

	                    <div class="pricing-package-price">
	                    			                    	<span class="pricing-package-currency js-currency">$</span><span class="price-cent js-pricing-outbound-sms">-</span>
		                    	                    </div>
    		...
    		<div class="col-md-6">
	            <h3 class="pricing-table-sub-heading">Inbound</h3>

	            <div class="pricing-package-info">
	                <div class="pricing-package-box">

	                    <div class="pricing-package-price">
	                    		                    		<span class="price-cent">Free</span>
	                    		                    </div>
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <h3 class="pricing-table-heading">
        	Voice Calling <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please note that this price is a country average. Prices may vary depending on which provider(s) are used to connect your call(s)."></i>        </h3>
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Programmable enterprise-grade VoIP calling billed per second.        </p>

                		<a class="page-section-link new" href="voice.htm">Learn more about Voice ⇢</a>
    ...
    <div class="col-md-8">
    		...
    		<div class="col-md-6">
	            <h3 class="pricing-table-sub-heading">Placing a call</h3>
    		...
    		<div class="col-md-6">
	            <h3 class="pricing-table-sub-heading">Receiving a call</h3>
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <h3 class="pricing-table-heading">
        	Voice Messaging        </h3>
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Text to speech sent anywhere worldwide in 20 different languages.        </p>
    		...
    		<div class="col-md-12">
	            ...
	            <div class="pricing-package-info">
	                <div class="pricing-package-box">
	                    ...
	                    <div class="pricing-package-price">
	                    			                    	<span class="pricing-package-currency js-currency">$</span><span class="price-cent js-pricing-outbound-tts">-</span>
		                    	                    </div>
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <h3 class="pricing-table-heading">
        	Local Numbers        </h3>
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Two-way communication and localized brand interactions in 50+ countries.        </p>

                		<a class="page-section-link new" href="numbers.htm">Learn more about Local Numbers ⇢</a>
...
<div class="row pricing-table-row" id="shortcode-pricing">
    <div class="col-md-4">
        ...
        <h3 class="pricing-table-heading">
        	Short code        </h3>
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Maximal throughput and country compliance via dedicated or shared short codes.        </p>
	            ...
	            <div class="pricing-package-info">
	                <div class="pricing-package-box">
	                    ...
	                    <div class="pricing-package-price">
	                    		                    ...
	                    		                    <div class="pricing-package-type">
		                    	per month, with a one time setup fee of <b><span class="js-currency currency number">$</span><span class="js-shortcode-dedicated-setup-fee">-</span></b>		                    </div>
...
<div class="row pricing-table-row" id="">
    <div class="col-md-4">
        ...
        <h3 class="pricing-table-heading">
        	Lookup and HLR        </h3>
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Accurate, detailed information on any phone number in the world.        </p>
    ...
    <div class="col-md-8">
    		...
    		<div class="col-md-6">
	            <h3 class="pricing-table-sub-heading">Lookup and HLR</h3>
    ...
    <div class="container">
        <div class="row">
            <header class="text-center">
                <h4 class="page-section-tag">Resources</h4>
                <h2 class="page-section-heading">Download our Voice and SMS overviews</h2>
            </header>
        </div>
        <div class="row">
            <div class="col-md-6">
	...
	<a href="#" data-toggle="modal" data-target="#voice-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;voice&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Download Voice overview ⇢</span>
				<p class="sp">Share our Voice Overview with your team</p>
			</div>
		</div>
	</a>
</div>
			...
			<div class="modal-body lp">
				...
				<div class="row">
					<div class="col-md-7">
						...
						<h1 class="mb-page-title">Get the Voice Overview</h1>
<p class="lp">Find out more about what MessageBird Voice can do for your business. Enter your email below and we’ll send a PDF directly to your inbox.</p>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="sms.htm#pdf">SMS</a>, <a href="verify.htm#pdf">Verify</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-zw/chat#pdf">Chat</a>.</p>
...
<div class="document-download">
	<a href="#" data-toggle="modal" data-target="#sms-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;sms&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-icon third"></div>
			<div class="document-download-desc">
				<span class="page-section-link">Download SMS Overview ⇢</span>
				<p class="sp">Share our SMS Overview with your team</p>
			</div>
		</div>
	</a>
</div>
			...
			<div class="modal-body lp">
				...
				<div class="row">
					<div class="col-md-7">
						...
						<h1 class="mb-page-title">Get the SMS Overview</h1>
<p class="lp">Find out more about what MessageBird SMS can do for your business. Enter your email below and we’ll send a PDF directly to your inbox.</p>
      ...
      <div class="input-group">
          ...
          <div class="input-group-addon" style="padding: 0;border: 0;">
              <input type="submit" id="SendButton" name="submit" value="Submit" class="button btn btn-cta" style="margin: 0;">
						...
						<p class="sp">We also have resources available for <a href="pricing.htm#pdf">Pricing</a>, <a href="voice.htm#pdf">Voice</a>, <a href="verify.htm#pdf">Verify</a>, <a href="lookup.htm#pdf">Lookup</a>, <a href="numbers.htm#pdf">Numbers</a>, <a href="numbers.htm#pdf">Short Code</a> and <a href="/en-zw/chat#pdf">Chat</a>.</p>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">our pricing</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-zw/pricing#contact-form">
                            <input type="hidden" name="_csrf" value="WmiCVpPgyGGM26UNHJ7x0V9JmDV11d-YEXHTtD7L08TXonQLW0uLiLsknRruSVsfYVh8YnTZFBPnriDTgCZKAw==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
