...
<html lang="en-zw">
    <head>
        ...
        <title>Chat Pricing - MessageBird</title>
    ...
    <meta name="csrf-token" content="1gkQ7aboBEwHEkyJqd0zO_BoNPKtJynjiL8TMez59TFbw-awbkNHpTDtdJ5bCpn1znnQpawr4mh-YOBWUhRs9g==">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:title" content="Chat Pricing">
        ...
        <meta property="og:url" content="https://www.messagebird.com/en-zw/pricing-chat">
        ...
        <meta name="twitter:title" content="Chat Pricing">
...
<section class="page-section pricing-list">
    ...
    <div class="pricing-tier-labels hidden-xs">
        ...
        <div class="pricing-tier free">
            ...
            <img class="pricing-tier-icon" alt="Free" src="..\..\assets\images\2017\free.png">

            <div class="pricing-tier-name">Free</div>
            <div class="pricing-tier-price">€0<div class="pricing-tier-term">/ month</div></div>

            <ul class="pricing-tier-features">
                <li class="odd"><b>Unlimited</b></li>
                <li><b>Unlimited</b></li>
                <li class="odd"><b>50</b></li>
                <li><b>10 GiB</b></li>
            </ul>

                            <a href="https://dashboard.messagebird.com/app/en-zw/sign-up?redirect=chat-api/get-started" class="btn btn-cta">Try it out</a>
                                    </div>
        ...
        <div class="pricing-tier">
            ...
            <div class="pricing-tier-price">€49<div class="pricing-tier-term">/ month</div></div>
            ...
            <ul class="pricing-tier-features">
                ...
                <li><b>500 GiB</b></li>
                            ...
                            <a href="https://dashboard.messagebird.com/app/en-zw/sign-up?redirect=chat-api/get-started" class="btn btn-cta">Select plan</a>
                    </div>
        ...
        <div class="pricing-tier popular">
            ...
            <img class="pricing-tier-icon" alt="Business" src="..\..\assets\images\2017\business.png">

            <div class="pricing-tier-name">Business</div>
            <div class="pricing-tier-price">€99<div class="pricing-tier-term">/ month</div></div>
        ...
        <div class="pricing-tier">
            ...
            <div class="pricing-tier-price">€599<div class="pricing-tier-term">/ month</div></div>
	            ...
	            <div class="pricing-package-info">
	                <div class="pricing-package-box">
	                    ...
	                    <div class="pricing-package-price">
	                    			                    	<span class="pricing-package-currency js-currency">$</span><span class="price-cent js-pricing-outbound-sms">0.061</span>
		                    	                    </div>
    ...
    <div class="col-md-4">
        ...
        <p class="pricing-table-paragraph sp" style="margin-bottom: 15px;">
        	Make two-way messages and Voice calling possible through a virtual Number.        </p>
                		...
                		<a class="page-section-link new" href="..\numbers.htm">Learn more about Numbers ⇢</a>
    ...
    <div class="container">
        <div class="row">
            <header class="text-center">
                ...
                <h2 class="page-section-heading">Download our Chat and Numbers overviews</h2>
            </header>
        </div>
        <div class="row">
            <div class="col-md-6">
	...
	<a href="#" data-toggle="modal" data-target="#chat-whitepaper" onclick="analytics.track('web:productWhitepaperPressed', {&quot;page&quot;:&quot;chat&quot;,&quot;tab&quot;:&quot;&quot;});">
		<div class="document-download-con">
			...
			<div class="document-download-desc">
				<span class="page-section-link">Download Chat overview ⇢</span>
				<p class="sp">Share our Chat Overview with your team</p>
			</div>
		</div>
	</a>
</div>
            ...
            <div class="col-md-12 text-center">
                ...
                <div class="sales-form-container">
                    ...
                    <div>
                                                    ...
                                                    <h3 class="sales-form-heading">Want to learn more about <span style="font-weight: 900;">Chat Pricing</span>?<br> Reach out to our sales team.</h3>
                        
                                                    
                        
                        <div id="#form-messages"></div>

                        <form class="form-group contact-form" id="contact-form" method="post" action="/en-zw/chat/pricing#contact-form">
                            <input type="hidden" name="_csrf" value="1gkQ7aboBEwHEkyJqd0zO_BoNPKtJynjiL8TMez59TFbw-awbkNHpTDtdJ5bCpn1znnQpawr4mh-YOBWUhRs9g==">                            <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
