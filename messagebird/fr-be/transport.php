...
<html lang="fr-be">
    ...
    <meta name="csrf-token" content="HuQUex059Xm9NJP26-5vMmjdcfjhSPo-Au80m6BspZaTLuIm1ZK2kIrLq-EZOcX8VsyVr-BEMbX0MMf8HoE8UQ==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
        	...
        	<link rel="alternate" hreflang="fr-be" href="transport.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/fr-be/transport">
    ...
    <section class="page-section no-border feature-big blue-2">
        <div class="container">
                ...
                <header class="col-md-12 text-center">
                        ...
                        <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                    <p class="possibilities-top-block">Dialoguez avec toutes les parties concernées. Faites-en sorte qu'elles puissent facilement vous contacter et répondre à vos messages via un <a href="/fr-be/virtual-mobile-number">Numéro</a> ou un <a href="numero-court.htm">numéro court</a>.</p>
                </div>
            </div>
