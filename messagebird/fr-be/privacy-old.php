...
<html lang="fr-be">
    ...
    <meta name="csrf-token" content="sphfxdnpCzMBfWYoQGt-If_sED9p9XoYO1RnsToEMPE_UqmYEUJI2jaCXj-yvNTvwf30aGj5sZPNi5TWhOmpNg==">
        ...
        <meta name="msapplication-TileImage" content="mstile-144x144.png">
        	...
        	<link rel="alternate" hreflang="fr-be" href="privacy-old.htm">
...
<link href="https://cdn-gc.messagebird.com/assets/css/core-5d9e5b7a2660977d0292193c7847b101.css" rel="stylesheet">
        ...
        <meta property="og:url" content="https://www.messagebird.com/fr-be/privacy-old">
                ...
                <div class="col-md-6 not-on-mobile" id="contact-form">
                    <div>
                        <h3 class="page-section-small-heading">Contacter un collaborateur</h3>
                            ...
                            <form class="form-group contact-form" id="contact" method="post" action="/fr-be/privacy-old#contact-form">
                                <input type="hidden" name="_csrf" value="sphfxdnpCzMBfWYoQGt-If_sED9p9XoYO1RnsToEMPE_UqmYEUJI2jaCXj-yvNTvwf30aGj5sZPNi5TWhOmpNg==">                                <input type="hidden" name="ContactForm[subject]" value="Sales Inquiry">
